 ...
 * Initializes a new instance of the CodePushDeploymentMetrics class.
 * @constructor
 *
 * @param {MobileCenterClient} client Reference to the service client.
 */
function CodePushDeploymentMetrics(client) {
  this.client = client;
}
 ...
 */
CodePushDeploymentMetrics.prototype.get = function (deploymentName, ownerName, appName, options, callback) {
