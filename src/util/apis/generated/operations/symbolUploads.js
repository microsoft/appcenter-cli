 ...
 */
SymbolUploads.prototype.getLocation = function (symbolUploadId, ownerName, appName, options, callback) {
  ...
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'v0.1/apps/{owner_name}/{app_name}/symbol_uploads/{symbol_upload_id}/location';
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          var resultMapper = new client.models['SymbolUploadLocation']().mapper();
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
SymbolUploads.prototype.deleteMethod = function (symbolUploadId, ownerName, appName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
...
SymbolUploads.prototype.create = function (ownerName, appName, options, callback) {
  ...
  var fileName = (options && options.fileName !== undefined) ? options.fileName : undefined;
  // Validate
  try {
    if (ownerName === null || ownerName === undefined || typeof ownerName.valueOf() !== 'string') {
      throw new Error('ownerName cannot be null or undefined and it must be of type string.');
  ...
  try {
    if ((clientCallback !== null && clientCallback !== undefined) || (fileName !== null && fileName !== undefined))
    {
