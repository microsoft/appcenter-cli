...
class ReleaseUploads {
   ...
   */
  completeWithHttpOperationResponse(uploadId, ownerName, appName, status, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._complete(uploadId, ownerName, appName, status, options, (err, result, request, response) => {
  ...
  complete(uploadId, ownerName, appName, status, options, optionalCallback) {
    ...
    if (!optionalCallback) {
      ...
      return self._complete(uploadId, ownerName, appName, status, options, optionalCallback);
    }
  }
  ...
  createWithHttpOperationResponse(ownerName, appName, options) {
    ...
    let self = this;
    return new Promise((resolve, reject) => {
      self._create(ownerName, appName, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
