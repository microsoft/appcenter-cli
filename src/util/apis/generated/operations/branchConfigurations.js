 ...
 */
function BranchConfigurations(client) {
  this.client = client;
}
 ...
 */
BranchConfigurations.prototype.get = function (branch, ownerName, appName, options, callback) {
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
BranchConfigurations.prototype.create = function (branch, ownerName, appName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
BranchConfigurations.prototype.update = function (branch, ownerName, appName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
BranchConfigurations.prototype.deleteMethod = function (branch, ownerName, appName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
