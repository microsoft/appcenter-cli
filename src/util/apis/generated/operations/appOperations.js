 ...
 * Initializes a new instance of the AppOperations class.
 * @constructor
 *
 * @param {AppCenterClient} client Reference to the service client.
 */
function AppOperations(client) {
  this.client = client;
}
 ...
 */
AppOperations.prototype.postFileAsset = function (ownerName, appName, options, callback) {
  ...
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'v0.1/apps/{owner_name}/{app_name}/file_asset';
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          var resultMapper = new client.models['FileAsset']().mapper();
