 ...
 * Initializes a new instance of the DeploymentMetrics class.
 * @constructor
 *
 * @param {MobileCenterClient} client Reference to the service client.
 */
function DeploymentMetrics(client) {
  this.client = client;
}
 ...
 */
DeploymentMetrics.prototype.get = function (deploymentName, ownerName, appName, options, callback) {
