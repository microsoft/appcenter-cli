...
class CodePushDeploymentRelease {
   ...
   */
  rollbackWithHttpOperationResponse(deploymentName, ownerName, appName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._rollback(deploymentName, ownerName, appName, options, (err, result, request, response) => {
  ...
  rollback(deploymentName, ownerName, appName, options, optionalCallback) {
    ...
    if (!optionalCallback) {
      ...
      return self._rollback(deploymentName, ownerName, appName, options, optionalCallback);
    }
  }
