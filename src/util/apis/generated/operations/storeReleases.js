 ...
 */
function _getRealTimeStatusByReleaseId(storeName, releaseId, ownerName, appName, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'v0.1/apps/{owner_name}/{app_name}/distribution_stores/{store_name}/releases/{release_id}/realtimestatus';
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _getPublishError(storeName, releaseId, ownerName, appName, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _deleteMethod(storeName, releaseId, ownerName, appName, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
...
class StoreReleases {
   ...
   */
  getRealTimeStatusByReleaseIdWithHttpOperationResponse(storeName, releaseId, ownerName, appName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._getRealTimeStatusByReleaseId(storeName, releaseId, ownerName, appName, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  getRealTimeStatusByReleaseId(storeName, releaseId, ownerName, appName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._getRealTimeStatusByReleaseId(storeName, releaseId, ownerName, appName, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  getPublishErrorWithHttpOperationResponse(storeName, releaseId, ownerName, appName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._getPublishError(storeName, releaseId, ownerName, appName, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  getPublishError(storeName, releaseId, ownerName, appName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._getPublishError(storeName, releaseId, ownerName, appName, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  getWithHttpOperationResponse(storeName, releaseId, ownerName, appName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._get(storeName, releaseId, ownerName, appName, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
  ...
  get(storeName, releaseId, ownerName, appName, options, optionalCallback) {
    ...
    if (!optionalCallback) {
      ...
      return self._get(storeName, releaseId, ownerName, appName, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  deleteMethodWithHttpOperationResponse(storeName, releaseId, ownerName, appName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._deleteMethod(storeName, releaseId, ownerName, appName, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  deleteMethod(storeName, releaseId, ownerName, appName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._deleteMethod(storeName, releaseId, ownerName, appName, options, optionalCallback);
    }
  }
  ...
  listWithHttpOperationResponse(storeName, ownerName, appName, options) {
    ...
    let self = this;
    return new Promise((resolve, reject) => {
      self._list(storeName, ownerName, appName, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
  ...
  list(storeName, ownerName, appName, options, optionalCallback) {
    ...
    if (!optionalCallback) {
      ...
      return self._list(storeName, ownerName, appName, options, optionalCallback);
    }
  }
  ...
  getLatestWithHttpOperationResponse(storeName, ownerName, appName, options) {
    ...
    let self = this;
    return new Promise((resolve, reject) => {
      self._getLatest(storeName, ownerName, appName, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
  ...
  getLatest(storeName, ownerName, appName, options, optionalCallback) {
    ...
    if (!optionalCallback) {
      ...
      return self._getLatest(storeName, ownerName, appName, options, optionalCallback);
    }
  }
