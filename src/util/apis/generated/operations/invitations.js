 ...
 */
function _sent(options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'v0.1/invitations/sent';
...
class Invitations {
   ...
   */
  sentWithHttpOperationResponse(options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._sent(options, (err, result, request, response) => {
  ...
  sent(options, optionalCallback) {
    ...
    if (!optionalCallback) {
      ...
      return self._sent(options, optionalCallback);
    }
  }
