 ...
 */
PackageUpload.prototype.commitOrAbort = function (uploadId, ownerName, appName, status, options, callback) {
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
PackageUpload.prototype.begin = function (ownerName, appName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
