 ...
 * Initializes a new instance of the XcodeVersions class.
 * @constructor
 *
 * @param {SonomaClient} client Reference to the service client.
 */
function XcodeVersions(client) {
  this.client = client;
}
 ...
 */
XcodeVersions.prototype.list = function (ownerName, appName, options, callback) {
