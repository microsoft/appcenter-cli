 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _updatePermissions(ownerName, appName, userEmail, permissions, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
...
class AppInvitations {
   ...
   * @reject {Error} - The error object.
   */
  createByEmailWithHttpOperationResponse(ownerName, appName, userEmail, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._createByEmail(ownerName, appName, userEmail, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
  ...
  createByEmail(ownerName, appName, userEmail, options, optionalCallback) {
    ...
    if (!optionalCallback) {
      ...
      return self._createByEmail(ownerName, appName, userEmail, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  updatePermissionsWithHttpOperationResponse(ownerName, appName, userEmail, permissions, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._updatePermissions(ownerName, appName, userEmail, permissions, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  updatePermissions(ownerName, appName, userEmail, permissions, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._updatePermissions(ownerName, appName, userEmail, permissions, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  deleteMethodWithHttpOperationResponse(ownerName, appName, userEmail, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._deleteMethod(ownerName, appName, userEmail, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
  ...
  deleteMethod(ownerName, appName, userEmail, options, optionalCallback) {
    ...
    if (!optionalCallback) {
      ...
      return self._deleteMethod(ownerName, appName, userEmail, options, optionalCallback);
    }
  }
  ...
  createWithHttpOperationResponse(ownerName, appName, userEmail, options) {
    ...
    let self = this;
    return new Promise((resolve, reject) => {
      self._create(ownerName, appName, userEmail, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
  ...
  create(ownerName, appName, userEmail, options, optionalCallback) {
    ...
    if (!optionalCallback) {
      ...
      return self._create(ownerName, appName, userEmail, options, optionalCallback);
    }
  }
