 ...
 */
function _update(deploymentName, releaseLabel, release, ownerName, appName, options, callback) {
...
class DeploymentReleases {
   ...
   */
  updateWithHttpOperationResponse(deploymentName, releaseLabel, release, ownerName, appName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._update(deploymentName, releaseLabel, release, ownerName, appName, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  update(deploymentName, releaseLabel, release, ownerName, appName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._update(deploymentName, releaseLabel, release, ownerName, appName, options, optionalCallback);
    }
  }
