  ...
  return client.pipeline(httpRequest, (err, response, responseBody) => {
    ...
    if (statusCode === 400) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['ProfileBadRequestResponse']().mapper();
          result = client.deserialize(resultMapper, parsedResponse, 'result');
        }
      } catch (error) {
...
class Provisioning {
  ...
  profileWithHttpOperationResponse(releaseId, ownerName, appName, options) {
    ...
    return new Promise((resolve, reject) => {
      self._profile(releaseId, ownerName, appName, options, (err, result, request, response) => {
  ...
  profile(releaseId, ownerName, appName, options, optionalCallback) {
    ...
    if (!optionalCallback) {
      ...
      return self._profile(releaseId, ownerName, appName, options, optionalCallback);
    }
  }
