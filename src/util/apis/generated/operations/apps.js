 ...
 */
function _testerAppReleases(ownerName, appName, options, callback) {
...
class Apps {
   ...
   */
  testerAppReleasesWithHttpOperationResponse(ownerName, appName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._testerAppReleases(ownerName, appName, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  testerAppReleases(ownerName, appName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._testerAppReleases(ownerName, appName, options, optionalCallback);
    }
  }
