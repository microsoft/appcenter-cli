 ...
 */
CrashOperations.prototype.getCrashRaw = function (crashId, ownerName, appName, options, callback) {
  ...
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'v0.1/management/crashes/apps/{owner_name}/{app_name}/crashes/{crash_id}/raw';
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
CrashOperations.prototype.postIgnoreSymbol = function (symbolId, ownerName, appName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
  ...
  // Construct URL
  var baseUrl = this.client.baseUri;
  var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'v0.1/apps/{owner_name}/{app_name}/symbols/{symbol_id}/ignore';
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
CrashOperations.prototype.postSymbolUpload = function (ownerName, appName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
