 ...
 */
Account.prototype.rejectOrganizationInvitation = function (invitationToken, options, callback) {
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Account.prototype.acceptOrganizationInvitation = function (invitationToken, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Account.prototype.patch = function (ownerName, appName, userEmail, permissions, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
