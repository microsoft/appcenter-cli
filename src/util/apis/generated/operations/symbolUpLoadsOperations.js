 ...
 * Initializes a new instance of the SymbolUpLoadsOperations class.
 * @constructor
 *
 * @param {SonomaClient} client Reference to the service client.
 */
function SymbolUpLoadsOperations(client) {
  this.client = client;
}
 ...
 */
SymbolUpLoadsOperations.prototype.commitOrAbort = function (symbolUploadId, ownerName, appName, status, options, callback) {
...
module.exports = SymbolUpLoadsOperations;
