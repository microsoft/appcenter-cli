 ...
 */
Sessions.prototype.countsPerDevice = function (options, callback) {
  ...
  try {
    ...
    if (this.client.interval === null || this.client.interval === undefined || typeof this.client.interval.valueOf() !== 'string') {
      throw new Error('this.client.interval cannot be null or undefined and it must be of type string.');
    }
  ...
  queryParameters.push('interval=' + encodeURIComponent(this.client.interval));
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Sessions.prototype.durationDistribution = function (options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Sessions.prototype.counts = function (options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
