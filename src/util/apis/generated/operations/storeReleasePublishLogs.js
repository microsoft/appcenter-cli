...
function _get(storeName, releaseId, ownerName, appName, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'v0.1/apps/{owner_name}/{app_name}/distribution_stores/{store_name}/releases/{release_id}/publish_logs';
    ...
    if (statusCode !== 200) {
      ...
      try {
        ...
        if (parsedErrorResponse !== null && parsedErrorResponse !== undefined) {
          let resultMapper = new client.models['GetErrorModel1']().mapper();
...
/** Class representing a StoreReleasePublishLogs. */
class StoreReleasePublishLogs {
  /**
   * Create a StoreReleasePublishLogs.
...
module.exports = StoreReleasePublishLogs;
