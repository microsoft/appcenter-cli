...
/**
 * Class representing a UpdateBadRequestResponseDestinationsItem.
 */
class UpdateBadRequestResponseDestinationsItem {
  /**
   * Create a UpdateBadRequestResponseDestinationsItem.
  ...
  /**
   * Defines the metadata of UpdateBadRequestResponseDestinationsItem
   *
   * @returns {object} metadata of UpdateBadRequestResponseDestinationsItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'UpdateBadRequestResponse_destinationsItem',
      type: {
        name: 'Composite',
...
module.exports = UpdateBadRequestResponseDestinationsItem;
