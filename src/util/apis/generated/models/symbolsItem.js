...
/**
 * Class representing a SymbolsItem.
 */
class SymbolsItem {
  /**
   * Create a SymbolsItem.
  ...
  /**
   * Defines the metadata of SymbolsItem
   *
   * @returns {object} metadata of SymbolsItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'SymbolsItem',
      type: {
        name: 'Composite',
