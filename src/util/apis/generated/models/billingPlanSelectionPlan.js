 ...
 *
 */
class BillingPlanSelectionPlan {
  /**
   * Create a BillingPlanSelectionPlan.
  ...
  /**
   * Defines the metadata of BillingPlanSelectionPlan
   *
   * @returns {object} metadata of BillingPlanSelectionPlan
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'BillingPlanSelection_plan',
      type: {
        name: 'Composite',
...
module.exports = BillingPlanSelectionPlan;
