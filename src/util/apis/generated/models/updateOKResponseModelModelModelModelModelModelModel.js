...
/**
 * Class representing a UpdateOKResponseModelModelModelModelModelModelModel.
 */
class UpdateOKResponseModelModelModelModelModelModelModel {
  /**
   * Create a UpdateOKResponseModelModelModelModelModelModelModel.
  ...
  /**
   * Defines the metadata of UpdateOKResponseModelModelModelModelModelModelModel
   *
   * @returns {object} metadata of UpdateOKResponseModelModelModelModelModelModelModel
   *
   */
  mapper() {
    return {
      ...
      type: {
        name: 'Composite',
        className: 'UpdateOKResponseModelModelModelModelModelModelModel',
        modelProperties: {
          id: {
            required: true,
            serializedName: 'id',
...
module.exports = UpdateOKResponseModelModelModelModelModelModelModel;
