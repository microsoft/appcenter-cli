 ...
 *
 */
class AppWithTeamPermissionsResponseOwner {
  /**
   * Create a AppWithTeamPermissionsResponseOwner.
  ...
  /**
   * Defines the metadata of AppWithTeamPermissionsResponseOwner
   *
   * @returns {object} metadata of AppWithTeamPermissionsResponseOwner
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'AppWithTeamPermissionsResponse_owner',
      type: {
        name: 'Composite',
        className: 'AppWithTeamPermissionsResponseOwner',
        modelProperties: {
          id: {
            required: true,
            serializedName: 'id',
...
module.exports = AppWithTeamPermissionsResponseOwner;
