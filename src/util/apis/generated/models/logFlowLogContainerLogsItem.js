...
/**
 * Class representing a LogFlowLogContainerLogsItem.
 */
class LogFlowLogContainerLogsItem {
  /**
   * Create a LogFlowLogContainerLogsItem.
  ...
  /**
   * Defines the metadata of LogFlowLogContainerLogsItem
   *
   * @returns {object} metadata of LogFlowLogContainerLogsItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'LogFlowLogContainer_logsItem',
      type: {
        name: 'Composite',
...
module.exports = LogFlowLogContainerLogsItem;
