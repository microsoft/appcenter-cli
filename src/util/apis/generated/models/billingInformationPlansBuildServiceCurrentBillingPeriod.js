 ...
 *
 */
class BillingInformationPlansBuildServiceCurrentBillingPeriod {
  /**
   * Create a BillingInformationPlansBuildServiceCurrentBillingPeriod.
  ...
  /**
   * Defines the metadata of BillingInformationPlansBuildServiceCurrentBillingPeriod
   *
   * @returns {object} metadata of BillingInformationPlansBuildServiceCurrentBillingPeriod
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'BillingInformationPlans_buildService_currentBillingPeriod',
      type: {
        name: 'Composite',
...
module.exports = BillingInformationPlansBuildServiceCurrentBillingPeriod;
