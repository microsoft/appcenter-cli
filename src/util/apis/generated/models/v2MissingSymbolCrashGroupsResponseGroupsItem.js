 ...
 *
 */
class V2MissingSymbolCrashGroupsResponseGroupsItem {
  /**
   * Create a V2MissingSymbolCrashGroupsResponseGroupsItem.
  ...
  /**
   * Defines the metadata of V2MissingSymbolCrashGroupsResponseGroupsItem
   *
   * @returns {object} metadata of V2MissingSymbolCrashGroupsResponseGroupsItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'v2MissingSymbolCrashGroupsResponse_groupsItem',
      type: {
        name: 'Composite',
        ...
        modelProperties: {
          ...
          missingSymbols: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'V2MissingSymbolCrashGroupsResponseGroupsItemMissingSymbolsItemElementType',
                  type: {
                    name: 'Composite',
...
module.exports = V2MissingSymbolCrashGroupsResponseGroupsItem;
