 ...
 *
 */
class PropertiesModelModelModel {
  /**
   * Create a PropertiesModelModelModel.
  ...
  /**
   * Defines the metadata of PropertiesModelModelModel
   *
   * @returns {object} metadata of PropertiesModelModelModel
   *
   */
  mapper() {
    return {
      ...
      type: {
        ...
        uberParent: 'PropertiesModelModelModel',
        className: 'PropertiesModelModelModel',
        modelProperties: {
          exportEntities: {
            required: false,
...
module.exports = PropertiesModelModelModel;
