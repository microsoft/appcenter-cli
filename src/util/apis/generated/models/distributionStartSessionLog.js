...
/**
 * Log is used to update distribution group identifier for session (a marker
 * event for analytics service).
 *
 */
class DistributionStartSessionLog {
  /**
   * Create a DistributionStartSessionLog.
   ...
   * @property {uuid} distributionGroupId Distribution Group ID.
   */
  constructor() {
  }

  /**
   * Defines the metadata of DistributionStartSessionLog
   *
   * @returns {object} metadata of DistributionStartSessionLog
   *
   */
  mapper() {
    return {
      ...
      type: {
        ...
        modelProperties: {
          ...
          device: {
            ...
            type: {
              name: 'Composite',
              className: 'DistributionStartSessionLogDevice'
            }
          },
          distributionGroupId: {
            required: true,
...
module.exports = DistributionStartSessionLog;
