 ...
 *
 */
class CrashGroupsContainerCrashGroupsItemReasonFrame {
  /**
   * Create a CrashGroupsContainerCrashGroupsItemReasonFrame.
  ...
  /**
   * Defines the metadata of CrashGroupsContainerCrashGroupsItemReasonFrame
   *
   * @returns {object} metadata of CrashGroupsContainerCrashGroupsItemReasonFrame
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'CrashGroupsContainer_crash_groupsItem_reason_frame',
      type: {
        name: 'Composite',
...
module.exports = CrashGroupsContainerCrashGroupsItemReasonFrame;
