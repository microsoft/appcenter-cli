 ...
 *
 */
class CrashGroupReasonFrame {
  /**
   * Create a CrashGroupReasonFrame.
  ...
  /**
   * Defines the metadata of CrashGroupReasonFrame
   *
   * @returns {object} metadata of CrashGroupReasonFrame
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'CrashGroup_reason_frame',
      type: {
        name: 'Composite',
...
module.exports = CrashGroupReasonFrame;
