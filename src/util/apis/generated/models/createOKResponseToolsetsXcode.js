 ...
 *
 */
class CreateOKResponseToolsetsXcode {
  /**
   * Create a CreateOKResponseToolsetsXcode.
  ...
  /**
   * Defines the metadata of CreateOKResponseToolsetsXcode
   *
   * @returns {object} metadata of CreateOKResponseToolsetsXcode
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'CreateOKResponse_toolsets_xcode',
      type: {
        name: 'Composite',
        ...
        modelProperties: {
          ...
          appExtensionProvisioningProfileFiles: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'CreateOKResponseToolsetsXcodeAppExtensionProvisioningProfileFilesItemElementType',
                  type: {
                    name: 'Composite',
...
module.exports = CreateOKResponseToolsetsXcode;
