 ...
 *
 */
class ListDeviceSetsOfOwnerOKResponseItem {
  /**
   * Create a ListDeviceSetsOfOwnerOKResponseItem.
  ...
  /**
   * Defines the metadata of ListDeviceSetsOfOwnerOKResponseItem
   *
   * @returns {object} metadata of ListDeviceSetsOfOwnerOKResponseItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ListDeviceSetsOfOwnerOKResponseItem',
      type: {
        name: 'Composite',
        ...
        modelProperties: {
          ...
          deviceConfigurations: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'ListDeviceSetsOfOwnerOKResponseItemDeviceConfigurationsItemElementType',
                  type: {
                    name: 'Composite',
...
module.exports = ListDeviceSetsOfOwnerOKResponseItem;
