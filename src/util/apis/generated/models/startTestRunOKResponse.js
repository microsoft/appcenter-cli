 ...
 *
 */
class StartTestRunOKResponse {
  /**
   * Create a StartTestRunOKResponse.
  ...
  /**
   * Defines the metadata of StartTestRunOKResponse
   *
   * @returns {object} metadata of StartTestRunOKResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'StartTestRunOKResponse',
      type: {
        name: 'Composite',
        className: 'StartTestRunOKResponse',
        modelProperties: {
          acceptedDevices: {
            required: false,
...
module.exports = StartTestRunOKResponse;
