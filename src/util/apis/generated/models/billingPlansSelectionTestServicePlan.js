 ...
 *
 */
class BillingPlansSelectionTestServicePlan {
  /**
   * Create a BillingPlansSelectionTestServicePlan.
  ...
  /**
   * Defines the metadata of BillingPlansSelectionTestServicePlan
   *
   * @returns {object} metadata of BillingPlansSelectionTestServicePlan
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'BillingPlansSelection_testService_plan',
      type: {
        name: 'Composite',
...
module.exports = BillingPlansSelectionTestServicePlan;
