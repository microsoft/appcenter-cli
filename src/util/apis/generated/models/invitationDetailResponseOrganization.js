...
/**
 * Class representing a InvitationDetailResponseOrganization.
 */
class InvitationDetailResponseOrganization {
  /**
   * Create a InvitationDetailResponseOrganization.
  ...
  /**
   * Defines the metadata of InvitationDetailResponseOrganization
   *
   * @returns {object} metadata of InvitationDetailResponseOrganization
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'InvitationDetailResponse_organization',
      type: {
        name: 'Composite',
...
module.exports = InvitationDetailResponseOrganization;
