 ...
 *
 */
class MigrateReleaseRequestReleasesItemProvisioningProfilesItem {
  /**
   * Create a MigrateReleaseRequestReleasesItemProvisioningProfilesItem.
  ...
  /**
   * Defines the metadata of MigrateReleaseRequestReleasesItemProvisioningProfilesItem
   *
   * @returns {object} metadata of MigrateReleaseRequestReleasesItemProvisioningProfilesItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'MigrateReleaseRequest_releasesItem_provisioning_profilesItem',
      type: {
        name: 'Composite',
        className: 'MigrateReleaseRequestReleasesItemProvisioningProfilesItem',
        modelProperties: {
          name: {
            required: true,
            serializedName: 'name',
...
module.exports = MigrateReleaseRequestReleasesItemProvisioningProfilesItem;
