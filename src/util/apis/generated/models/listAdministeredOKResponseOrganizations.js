...
/**
 * Class representing a ListAdministeredOKResponseOrganizations.
 */
class ListAdministeredOKResponseOrganizations {
  /**
   * Create a ListAdministeredOKResponseOrganizations.
  ...
  /**
   * Defines the metadata of ListAdministeredOKResponseOrganizations
   *
   * @returns {object} metadata of ListAdministeredOKResponseOrganizations
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ListAdministeredOKResponse_organizations',
      type: {
        name: 'Composite',
...
module.exports = ListAdministeredOKResponseOrganizations;
