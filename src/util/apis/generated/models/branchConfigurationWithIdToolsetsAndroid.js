 ...
 *
 */
class BranchConfigurationWithIdToolsetsAndroid {
  /**
   * Create a BranchConfigurationWithIdToolsetsAndroid.
  ...
  /**
   * Defines the metadata of BranchConfigurationWithIdToolsetsAndroid
   *
   * @returns {object} metadata of BranchConfigurationWithIdToolsetsAndroid
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'BranchConfigurationWithId_toolsets_android',
      type: {
        name: 'Composite',
...
module.exports = BranchConfigurationWithIdToolsetsAndroid;
