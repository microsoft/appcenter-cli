 ...
 *
 */
class TestAudienceOKResponse {
  /**
   * Create a TestAudienceOKResponse.
  ...
  /**
   * Defines the metadata of TestAudienceOKResponse
   *
   * @returns {object} metadata of TestAudienceOKResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'TestAudienceOKResponse',
      type: {
        name: 'Composite',
        className: 'TestAudienceOKResponse',
        modelProperties: {
          definition: {
            required: false,
...
module.exports = TestAudienceOKResponse;
