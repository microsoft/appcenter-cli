 ...
 *
 */
class DiagnosticsThreadFramesItem {
  /**
   * Create a DiagnosticsThreadFramesItem.
  ...
  /**
   * Defines the metadata of DiagnosticsThreadFramesItem
   *
   * @returns {object} metadata of DiagnosticsThreadFramesItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'DiagnosticsThread_framesItem',
      type: {
        name: 'Composite',
...
module.exports = DiagnosticsThreadFramesItem;
