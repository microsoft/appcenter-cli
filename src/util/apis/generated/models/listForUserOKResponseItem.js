...
/**
 * Class representing a ListForUserOKResponseItem.
 */
class ListForUserOKResponseItem {
  /**
   * Create a ListForUserOKResponseItem.
  ...
  /**
   * Defines the metadata of ListForUserOKResponseItem
   *
   * @returns {object} metadata of ListForUserOKResponseItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ListForUserOKResponseItem',
      type: {
        name: 'Composite',
...
module.exports = ListForUserOKResponseItem;
