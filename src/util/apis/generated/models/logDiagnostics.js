...
/**
 * Class representing a LogDiagnostics.
 */
class LogDiagnostics {
  /**
   * Create a LogDiagnostics.
  ...
  /**
   * Defines the metadata of LogDiagnostics
   *
   * @returns {object} metadata of LogDiagnostics
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'Log_Diagnostics',
      type: {
        name: 'Composite',
