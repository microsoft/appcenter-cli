...
/**
 * Class representing a SentOKResponseItemOrganization.
 */
class SentOKResponseItemOrganization {
  /**
   * Create a SentOKResponseItemOrganization.
  ...
  /**
   * Defines the metadata of SentOKResponseItemOrganization
   *
   * @returns {object} metadata of SentOKResponseItemOrganization
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'SentOKResponseItem_organization',
      type: {
        name: 'Composite',
...
module.exports = SentOKResponseItemOrganization;
