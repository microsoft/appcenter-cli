...
/**
 * Class representing a UpdateStateOKResponseReasonFramesItem.
 */
class UpdateStateOKResponseReasonFramesItem {
  /**
   * Create a UpdateStateOKResponseReasonFramesItem.
  ...
  /**
   * Defines the metadata of UpdateStateOKResponseReasonFramesItem
   *
   * @returns {object} metadata of UpdateStateOKResponseReasonFramesItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'UpdateStateOKResponse_reasonFramesItem',
      type: {
        name: 'Composite',
        className: 'UpdateStateOKResponseReasonFramesItem',
        modelProperties: {
          className: {
            required: false,
...
module.exports = UpdateStateOKResponseReasonFramesItem;
