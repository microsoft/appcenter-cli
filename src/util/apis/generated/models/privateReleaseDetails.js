 ...
 * 
 */
function PrivateReleaseDetails() {
}

/**
 * Defines the metadata of PrivateReleaseDetails
 *
 * @returns {object} metadata of PrivateReleaseDetails
 *
 */
PrivateReleaseDetails.prototype.mapper = function () {
  return {
    required: false,
    serializedName: 'PrivateReleaseDetails',
    type: {
      name: 'Composite',
      className: 'PrivateReleaseDetails',
      modelProperties: {
        id: {
          required: false,
          serializedName: 'id',
...
module.exports = PrivateReleaseDetails;
