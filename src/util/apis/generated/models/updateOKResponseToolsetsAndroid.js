 ...
 *
 */
class UpdateOKResponseToolsetsAndroid {
  /**
   * Create a UpdateOKResponseToolsetsAndroid.
  ...
  /**
   * Defines the metadata of UpdateOKResponseToolsetsAndroid
   *
   * @returns {object} metadata of UpdateOKResponseToolsetsAndroid
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'UpdateOKResponse_toolsets_android',
      type: {
        name: 'Composite',
...
module.exports = UpdateOKResponseToolsetsAndroid;
