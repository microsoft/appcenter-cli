 ...
 *
 */
class BranchConfigurationToolsetsModel {
  /**
   * Create a BranchConfigurationToolsetsModel.
  ...
  /**
   * Defines the metadata of BranchConfigurationToolsetsModel
   *
   * @returns {object} metadata of BranchConfigurationToolsetsModel
   *
   */
  mapper() {
    return {
      ...
      type: {
        name: 'Composite',
        className: 'BranchConfigurationToolsetsModel',
        modelProperties: {
          xcode: {
            required: false,
          ...
          xamarin: {
            ...
            type: {
              name: 'Composite',
              className: 'BranchConfigurationToolsetsXamarinModel'
            }
          },
          android: {
            required: false,
...
module.exports = BranchConfigurationToolsetsModel;
