 ...
 *
 */
class LogFlowGenericLogDevice {
  /**
   * Create a LogFlowGenericLogDevice.
  ...
  /**
   * Defines the metadata of LogFlowGenericLogDevice
   *
   * @returns {object} metadata of LogFlowGenericLogDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'LogFlowGenericLog_device',
      type: {
        name: 'Composite',
...
module.exports = LogFlowGenericLogDevice;
