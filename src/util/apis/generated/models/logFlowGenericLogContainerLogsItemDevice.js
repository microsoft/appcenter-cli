 ...
 *
 */
class LogFlowGenericLogContainerLogsItemDevice {
  /**
   * Create a LogFlowGenericLogContainerLogsItemDevice.
  ...
  /**
   * Defines the metadata of LogFlowGenericLogContainerLogsItemDevice
   *
   * @returns {object} metadata of LogFlowGenericLogContainerLogsItemDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'LogFlowGenericLogContainer_logsItem_device',
      type: {
        name: 'Composite',
...
module.exports = LogFlowGenericLogContainerLogsItemDevice;
