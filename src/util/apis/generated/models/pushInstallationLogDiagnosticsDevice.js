 ...
 *
 */
class PushInstallationLogDiagnosticsDevice {
  /**
   * Create a PushInstallationLogDiagnosticsDevice.
  ...
  /**
   * Defines the metadata of PushInstallationLogDiagnosticsDevice
   *
   * @returns {object} metadata of PushInstallationLogDiagnosticsDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'PushInstallationLog_Diagnostics_device',
      type: {
        name: 'Composite',
        className: 'PushInstallationLogDiagnosticsDevice',
        modelProperties: {
          sdkName: {
            required: true,
...
module.exports = PushInstallationLogDiagnosticsDevice;
