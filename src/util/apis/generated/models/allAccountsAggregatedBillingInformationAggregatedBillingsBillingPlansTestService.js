 ...
 *
 */
class AllAccountsAggregatedBillingInformationAggregatedBillingsBillingPlansTestService {
  /**
   * Create a AllAccountsAggregatedBillingInformationAggregatedBillingsBillingPlansTestService.
  ...
  /**
   * Defines the metadata of AllAccountsAggregatedBillingInformationAggregatedBillingsBillingPlansTestService
   *
   * @returns {object} metadata of AllAccountsAggregatedBillingInformationAggregatedBillingsBillingPlansTestService
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'AllAccountsAggregatedBillingInformation_aggregatedBillings_billingPlans_testService',
      type: {
        name: 'Composite',
        className: 'AllAccountsAggregatedBillingInformationAggregatedBillingsBillingPlansTestService',
        modelProperties: {
          canSelectTrialPlan: {
            required: false,
...
module.exports = AllAccountsAggregatedBillingInformationAggregatedBillingsBillingPlansTestService;
