...
/**
 * Class representing a OrganizationInvitationDetailResponseInvitedBy.
 */
class OrganizationInvitationDetailResponseInvitedBy {
  /**
   * Create a OrganizationInvitationDetailResponseInvitedBy.
  ...
  /**
   * Defines the metadata of OrganizationInvitationDetailResponseInvitedBy
   *
   * @returns {object} metadata of OrganizationInvitationDetailResponseInvitedBy
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'OrganizationInvitationDetailResponse_invited_by',
      type: {
        name: 'Composite',
...
module.exports = OrganizationInvitationDetailResponseInvitedBy;
