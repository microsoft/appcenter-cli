...
/**
 * Class representing a GetDeviceConfigurationsOKResponseItemModel.
 */
class GetDeviceConfigurationsOKResponseItemModel {
  /**
   * Create a GetDeviceConfigurationsOKResponseItemModel.
  ...
  /**
   * Defines the metadata of GetDeviceConfigurationsOKResponseItemModel
   *
   * @returns {object} metadata of GetDeviceConfigurationsOKResponseItemModel
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetDeviceConfigurationsOKResponseItem_model',
      type: {
        name: 'Composite',
        className: 'GetDeviceConfigurationsOKResponseItemModel',
        modelProperties: {
          name: {
            required: false,
            serializedName: 'name',
          ...
          dimensions: {
            ...
            type: {
              name: 'Composite',
              className: 'GetDeviceConfigurationsOKResponseItemModelDimensions'
            }
          },
          resolution: {
            required: false,
...
module.exports = GetDeviceConfigurationsOKResponseItemModel;
