 ...
 *
 */
class GenericLogDevice {
  /**
   * Create a GenericLogDevice.
  ...
  /**
   * Defines the metadata of GenericLogDevice
   *
   * @returns {object} metadata of GenericLogDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GenericLog_device',
      type: {
        name: 'Composite',
...
module.exports = GenericLogDevice;
