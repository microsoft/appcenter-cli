...
/**
 * Class representing a ErrorGroupListItemReasonFramesItem.
 */
class ErrorGroupListItemReasonFramesItem {
  /**
   * Create a ErrorGroupListItemReasonFramesItem.
  ...
  /**
   * Defines the metadata of ErrorGroupListItemReasonFramesItem
   *
   * @returns {object} metadata of ErrorGroupListItemReasonFramesItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ErrorGroupListItem_reasonFramesItem',
      type: {
        name: 'Composite',
...
module.exports = ErrorGroupListItemReasonFramesItem;
