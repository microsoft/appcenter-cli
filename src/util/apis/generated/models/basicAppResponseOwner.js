 ...
 *
 */
class BasicAppResponseOwner {
  /**
   * Create a BasicAppResponseOwner.
  ...
  /**
   * Defines the metadata of BasicAppResponseOwner
   *
   * @returns {object} metadata of BasicAppResponseOwner
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'BasicAppResponse_owner',
      type: {
        name: 'Composite',
...
module.exports = BasicAppResponseOwner;
