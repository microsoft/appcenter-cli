 ...
 *
 */
class PartialUpdateOKResponse {
  /**
   * Create a PartialUpdateOKResponse.
  ...
  /**
   * Defines the metadata of PartialUpdateOKResponse
   *
   * @returns {object} metadata of PartialUpdateOKResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'PartialUpdateOKResponse',
      type: {
        name: 'Composite',
        className: 'PartialUpdateOKResponse',
        modelProperties: {
          id: {
            required: true,
            serializedName: 'id',
...
module.exports = PartialUpdateOKResponse;
