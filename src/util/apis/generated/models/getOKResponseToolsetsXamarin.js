 ...
 *
 */
class GetOKResponseToolsetsXamarin {
  /**
   * Create a GetOKResponseToolsetsXamarin.
  ...
  /**
   * Defines the metadata of GetOKResponseToolsetsXamarin
   *
   * @returns {object} metadata of GetOKResponseToolsetsXamarin
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetOKResponse_toolsets_xamarin',
      type: {
        name: 'Composite',
...
module.exports = GetOKResponseToolsetsXamarin;
