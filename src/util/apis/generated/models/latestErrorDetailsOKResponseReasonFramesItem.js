...
/**
 * Class representing a LatestErrorDetailsOKResponseReasonFramesItem.
 */
class LatestErrorDetailsOKResponseReasonFramesItem {
  /**
   * Create a LatestErrorDetailsOKResponseReasonFramesItem.
  ...
  /**
   * Defines the metadata of LatestErrorDetailsOKResponseReasonFramesItem
   *
   * @returns {object} metadata of LatestErrorDetailsOKResponseReasonFramesItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'LatestErrorDetailsOKResponse_reasonFramesItem',
      type: {
        name: 'Composite',
...
module.exports = LatestErrorDetailsOKResponseReasonFramesItem;
