 ...
 *
 */
class AppInvitationDetailResponseDistributionGroupOwner {
  /**
   * Create a AppInvitationDetailResponseDistributionGroupOwner.
  ...
  /**
   * Defines the metadata of AppInvitationDetailResponseDistributionGroupOwner
   *
   * @returns {object} metadata of AppInvitationDetailResponseDistributionGroupOwner
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'AppInvitationDetailResponse_distribution_group_owner',
      type: {
        name: 'Composite',
...
module.exports = AppInvitationDetailResponseDistributionGroupOwner;
