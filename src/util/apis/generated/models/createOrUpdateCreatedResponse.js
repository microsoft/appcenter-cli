...
/**
 * Class representing a CreateOrUpdateCreatedResponse.
 */
class CreateOrUpdateCreatedResponse {
  /**
   * Create a CreateOrUpdateCreatedResponse.
  ...
  /**
   * Defines the metadata of CreateOrUpdateCreatedResponse
   *
   * @returns {object} metadata of CreateOrUpdateCreatedResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'CreateOrUpdateCreatedResponse',
      type: {
        name: 'Composite',
        className: 'CreateOrUpdateCreatedResponse',
        modelProperties: {
          id: {
            required: true,
            serializedName: 'id',
...
module.exports = CreateOrUpdateCreatedResponse;
