 ...
 *
 */
class GetForOrgOKResponseModelModel {
  /**
   * Create a GetForOrgOKResponseModelModel.
  ...
  /**
   * Defines the metadata of GetForOrgOKResponseModelModel
   *
   * @returns {object} metadata of GetForOrgOKResponseModelModel
   *
   */
  mapper() {
    return {
      ...
      type: {
        name: 'Composite',
        className: 'GetForOrgOKResponseModelModel',
        modelProperties: {
          version: {
            required: false,
          ...
          usage: {
            ...
            type: {
              name: 'Composite',
              className: 'GetForOrgOKResponseUsage'
            }
          },
          azureSubscriptionId: {
            required: false,
...
module.exports = GetForOrgOKResponseModelModel;
