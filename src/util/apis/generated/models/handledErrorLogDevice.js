 ...
 *
 */
class HandledErrorLogDevice {
  /**
   * Create a HandledErrorLogDevice.
  ...
  /**
   * Defines the metadata of HandledErrorLogDevice
   *
   * @returns {object} metadata of HandledErrorLogDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'HandledErrorLog_device',
      type: {
        name: 'Composite',
        className: 'HandledErrorLogDevice',
        modelProperties: {
          sdkName: {
            required: true,
...
module.exports = HandledErrorLogDevice;
