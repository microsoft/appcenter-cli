 ...
 *
 */
class GetForOrgUserOKResponseItemOwner {
  /**
   * Create a GetForOrgUserOKResponseItemOwner.
  ...
  /**
   * Defines the metadata of GetForOrgUserOKResponseItemOwner
   *
   * @returns {object} metadata of GetForOrgUserOKResponseItemOwner
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetForOrgUserOKResponseItem_owner',
      type: {
        name: 'Composite',
...
module.exports = GetForOrgUserOKResponseItemOwner;
