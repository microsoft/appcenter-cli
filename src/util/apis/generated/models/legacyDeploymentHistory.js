...
class LegacyDeploymentHistory {
  /**
   * Create a LegacyDeploymentHistory.
  ...
  /**
   * Defines the metadata of LegacyDeploymentHistory
   *
   * @returns {object} metadata of LegacyDeploymentHistory
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'LegacyDeploymentHistory',
      type: {
        name: 'Composite',
...
module.exports = LegacyDeploymentHistory;
