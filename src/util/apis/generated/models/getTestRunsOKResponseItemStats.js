 ...
 *
 */
class GetTestRunsOKResponseItemStats {
  /**
   * Create a GetTestRunsOKResponseItemStats.
  ...
  /**
   * Defines the metadata of GetTestRunsOKResponseItemStats
   *
   * @returns {object} metadata of GetTestRunsOKResponseItemStats
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetTestRunsOKResponseItem_stats',
      type: {
        name: 'Composite',
        className: 'GetTestRunsOKResponseItemStats',
        modelProperties: {
          devices: {
            required: false,
...
module.exports = GetTestRunsOKResponseItemStats;
