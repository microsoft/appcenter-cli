...
/**
 * Class representing a LegacyDeployment.
 */
class LegacyDeployment {
  /**
   * Create a LegacyDeployment.
  ...
  /**
   * Defines the metadata of LegacyDeployment
   *
   * @returns {object} metadata of LegacyDeployment
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'LegacyDeployment',
      type: {
        name: 'Composite',
...
module.exports = LegacyDeployment;
