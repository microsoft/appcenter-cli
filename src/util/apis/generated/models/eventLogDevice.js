 ...
 *
 */
class EventLogDevice {
  /**
   * Create a EventLogDevice.
  ...
  /**
   * Defines the metadata of EventLogDevice
   *
   * @returns {object} metadata of EventLogDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'EventLog_device',
      type: {
        name: 'Composite',
        className: 'EventLogDevice',
        modelProperties: {
          sdkName: {
            required: true,
