...
/**
 * Class representing a CreateCreatedResponseModelModel.
 */
class CreateCreatedResponseModelModel {
  /**
   * Create a CreateCreatedResponseModelModel.
  ...
  /**
   * Defines the metadata of CreateCreatedResponseModelModel
   *
   * @returns {object} metadata of CreateCreatedResponseModelModel
   *
   */
  mapper() {
    return {
      ...
      type: {
        name: 'Composite',
        className: 'CreateCreatedResponseModelModel',
        modelProperties: {
          id: {
            required: true,
            serializedName: 'id',
...
module.exports = CreateCreatedResponseModelModel;
