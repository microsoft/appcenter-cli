...
/**
 * Class representing a SentOKResponseItemApp.
 */
class SentOKResponseItemApp {
  /**
   * Create a SentOKResponseItemApp.
  ...
  /**
   * Defines the metadata of SentOKResponseItemApp
   *
   * @returns {object} metadata of SentOKResponseItemApp
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'SentOKResponseItem_app',
      type: {
        name: 'Composite',
        ...
        modelProperties: {
          ...
          owner: {
            ...
            type: {
              name: 'Composite',
              className: 'SentOKResponseItemAppOwner'
            }
          },
          appSecret: {
            required: true,
...
module.exports = SentOKResponseItemApp;
