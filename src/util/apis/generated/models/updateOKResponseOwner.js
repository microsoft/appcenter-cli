 ...
 *
 */
class UpdateOKResponseOwner {
  /**
   * Create a UpdateOKResponseOwner.
  ...
  /**
   * Defines the metadata of UpdateOKResponseOwner
   *
   * @returns {object} metadata of UpdateOKResponseOwner
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'UpdateOKResponse_owner',
      type: {
        name: 'Composite',
...
module.exports = UpdateOKResponseOwner;
