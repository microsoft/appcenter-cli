 ...
 *
 */
class AppInvitationDetailResponseAppOwner {
  /**
   * Create a AppInvitationDetailResponseAppOwner.
  ...
  /**
   * Defines the metadata of AppInvitationDetailResponseAppOwner
   *
   * @returns {object} metadata of AppInvitationDetailResponseAppOwner
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'AppInvitationDetailResponse_app_owner',
      type: {
        name: 'Composite',
...
module.exports = AppInvitationDetailResponseAppOwner;
