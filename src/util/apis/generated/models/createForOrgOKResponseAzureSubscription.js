...
/**
 * Class representing a CreateForOrgOKResponseAzureSubscription.
 */
class CreateForOrgOKResponseAzureSubscription {
  /**
   * Create a CreateForOrgOKResponseAzureSubscription.
  ...
  /**
   * Defines the metadata of CreateForOrgOKResponseAzureSubscription
   *
   * @returns {object} metadata of CreateForOrgOKResponseAzureSubscription
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'CreateForOrgOKResponse_azure_subscription',
      type: {
        name: 'Composite',
        className: 'CreateForOrgOKResponseAzureSubscription',
        modelProperties: {
          subscriptionId: {
            required: true,
...
module.exports = CreateForOrgOKResponseAzureSubscription;
