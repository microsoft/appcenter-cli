...
/**
 * Class representing a DeleteAvatarOKResponse.
 */
class DeleteAvatarOKResponse {
  /**
   * Create a DeleteAvatarOKResponse.
  ...
  /**
   * Defines the metadata of DeleteAvatarOKResponse
   *
   * @returns {object} metadata of DeleteAvatarOKResponse
   *
   */
  mapper() {
    return {
      ...
      type: {
        name: 'Composite',
        className: 'DeleteAvatarOKResponse',
        modelProperties: {
          id: {
            required: true,
            serializedName: 'id',
...
module.exports = DeleteAvatarOKResponse;
