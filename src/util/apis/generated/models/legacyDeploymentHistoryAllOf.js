...
/**
 * Class representing a LegacyDeploymentHistoryAllOf.
 */
class LegacyDeploymentHistoryAllOf {
  /**
   * Create a LegacyDeploymentHistoryAllOf.
  ...
  /**
   * Defines the metadata of LegacyDeploymentHistoryAllOf
   *
   * @returns {object} metadata of LegacyDeploymentHistoryAllOf
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'LegacyDeploymentHistory_allOf',
      type: {
        name: 'Composite',
...
module.exports = LegacyDeploymentHistoryAllOf;
