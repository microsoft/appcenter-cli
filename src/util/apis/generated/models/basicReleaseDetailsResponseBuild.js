 ...
 *
 */
class BasicReleaseDetailsResponseBuild {
  /**
   * Create a BasicReleaseDetailsResponseBuild.
  ...
  /**
   * Defines the metadata of BasicReleaseDetailsResponseBuild
   *
   * @returns {object} metadata of BasicReleaseDetailsResponseBuild
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'BasicReleaseDetailsResponse_build',
      type: {
        name: 'Composite',
...
module.exports = BasicReleaseDetailsResponseBuild;
