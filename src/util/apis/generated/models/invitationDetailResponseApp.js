...
/**
 * Class representing a InvitationDetailResponseApp.
 */
class InvitationDetailResponseApp {
  /**
   * Create a InvitationDetailResponseApp.
  ...
  /**
   * Defines the metadata of InvitationDetailResponseApp
   *
   * @returns {object} metadata of InvitationDetailResponseApp
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'InvitationDetailResponse_app',
      type: {
        name: 'Composite',
        ...
        modelProperties: {
          ...
          owner: {
            ...
            type: {
              name: 'Composite',
              className: 'InvitationDetailResponseAppOwner'
            }
          },
          appSecret: {
            required: true,
...
module.exports = InvitationDetailResponseApp;
