...
/**
 * Class representing a ListForAppOKResponseItem.
 */
class ListForAppOKResponseItem {
  /**
   * Create a ListForAppOKResponseItem.
  ...
  /**
   * Defines the metadata of ListForAppOKResponseItem
   *
   * @returns {object} metadata of ListForAppOKResponseItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ListForAppOKResponseItem',
      type: {
        name: 'Composite',
...
module.exports = ListForAppOKResponseItem;
