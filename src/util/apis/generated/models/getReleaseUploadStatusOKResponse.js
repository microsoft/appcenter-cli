...
/**
 * Class representing a GetReleaseUploadStatusOKResponse.
 */
class GetReleaseUploadStatusOKResponse {
  /**
   * Create a GetReleaseUploadStatusOKResponse.
  ...
  /**
   * Defines the metadata of GetReleaseUploadStatusOKResponse
   *
   * @returns {object} metadata of GetReleaseUploadStatusOKResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetReleaseUploadStatusOKResponse',
      type: {
        name: 'Composite',
        className: 'GetReleaseUploadStatusOKResponse',
        modelProperties: {
          id: {
            required: true,
            serializedName: 'id',
...
module.exports = GetReleaseUploadStatusOKResponse;
