...
/**
 * Class representing a ErrorGroupReasonFramesItem.
 */
class ErrorGroupReasonFramesItem {
  /**
   * Create a ErrorGroupReasonFramesItem.
  ...
  /**
   * Defines the metadata of ErrorGroupReasonFramesItem
   *
   * @returns {object} metadata of ErrorGroupReasonFramesItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ErrorGroup_reasonFramesItem',
      type: {
        name: 'Composite',
...
module.exports = ErrorGroupReasonFramesItem;
