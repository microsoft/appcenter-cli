...
/**
 * Class representing a AppInvitationDetailResponseInvitedBy.
 */
class AppInvitationDetailResponseInvitedBy {
  /**
   * Create a AppInvitationDetailResponseInvitedBy.
  ...
  /**
   * Defines the metadata of AppInvitationDetailResponseInvitedBy
   *
   * @returns {object} metadata of AppInvitationDetailResponseInvitedBy
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'AppInvitationDetailResponse_invited_by',
      type: {
        name: 'Composite',
...
module.exports = AppInvitationDetailResponseInvitedBy;
