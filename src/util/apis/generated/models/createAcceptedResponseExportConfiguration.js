 ...
 *
 */
class CreateAcceptedResponseExportConfiguration {
  /**
   * Create a CreateAcceptedResponseExportConfiguration.
  ...
  /**
   * Defines the metadata of CreateAcceptedResponseExportConfiguration
   *
   * @returns {object} metadata of CreateAcceptedResponseExportConfiguration
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'CreateAcceptedResponse_export_configuration',
      type: {
        name: 'Composite',
        ...
        uberParent: 'CreateAcceptedResponseExportConfiguration',
        className: 'CreateAcceptedResponseExportConfiguration',
        modelProperties: {
          exportEntities: {
            required: false,
...
module.exports = CreateAcceptedResponseExportConfiguration;
