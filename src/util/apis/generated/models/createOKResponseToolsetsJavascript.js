 ...
 *
 */
class CreateOKResponseToolsetsJavascript {
  /**
   * Create a CreateOKResponseToolsetsJavascript.
  ...
  /**
   * Defines the metadata of CreateOKResponseToolsetsJavascript
   *
   * @returns {object} metadata of CreateOKResponseToolsetsJavascript
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'CreateOKResponse_toolsets_javascript',
      type: {
        name: 'Composite',
...
module.exports = CreateOKResponseToolsetsJavascript;
