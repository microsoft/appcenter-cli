 ...
 *
 */
class UpdateDeviceSetOfUserOKResponse {
  /**
   * Create a UpdateDeviceSetOfUserOKResponse.
  ...
  /**
   * Defines the metadata of UpdateDeviceSetOfUserOKResponse
   *
   * @returns {object} metadata of UpdateDeviceSetOfUserOKResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'UpdateDeviceSetOfUserOKResponse',
      type: {
        name: 'Composite',
        className: 'UpdateDeviceSetOfUserOKResponse',
        modelProperties: {
          id: {
            required: true,
            serializedName: 'id',
          ...
          owner: {
            ...
            type: {
              name: 'Composite',
              className: 'UpdateDeviceSetOfUserOKResponseOwner'
            }
          },
          osVersionCount: {
            required: false,
          ...
          deviceConfigurations: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'UpdateDeviceSetOfUserOKResponseDeviceConfigurationsItemElementType',
                  type: {
                    name: 'Composite',
...
module.exports = UpdateDeviceSetOfUserOKResponse;
