...
/**
 * Class representing a ReleaseDetailsResponseDistributionStoresItem.
 */
class ReleaseDetailsResponseDistributionStoresItem {
  /**
   * Create a ReleaseDetailsResponseDistributionStoresItem.
  ...
  /**
   * Defines the metadata of ReleaseDetailsResponseDistributionStoresItem
   *
   * @returns {object} metadata of ReleaseDetailsResponseDistributionStoresItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ReleaseDetailsResponse_distribution_storesItem',
      type: {
        name: 'Composite',
...
module.exports = ReleaseDetailsResponseDistributionStoresItem;
