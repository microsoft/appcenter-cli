 ...
 * 
 */
function AggregatedBillingInformation001() {
}

/**
 * Defines the metadata of AggregatedBillingInformation001
 *
 * @returns {object} metadata of AggregatedBillingInformation001
 *
 */
AggregatedBillingInformation001.prototype.mapper = function () {
  return {
    required: false,
    serializedName: 'AggregatedBillingInformation_0_0_1',
    type: {
      name: 'Composite',
      className: 'AggregatedBillingInformation001',
      modelProperties: {
        version: {
          required: false,
        ...
        billingPlans: {
          ...
          type: {
            name: 'Composite',
            className: 'BillingInformationPlans001'
          }
        },
        usage: {
          required: false,
...
module.exports = AggregatedBillingInformation001;
