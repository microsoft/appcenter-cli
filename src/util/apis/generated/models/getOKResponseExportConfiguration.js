 ...
 *
 */
class GetOKResponseExportConfiguration {
  /**
   * Create a GetOKResponseExportConfiguration.
  ...
  /**
   * Defines the metadata of GetOKResponseExportConfiguration
   *
   * @returns {object} metadata of GetOKResponseExportConfiguration
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetOKResponse_export_configuration',
      type: {
        name: 'Composite',
...
module.exports = GetOKResponseExportConfiguration;
