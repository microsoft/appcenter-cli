 ...
 *
 */
class ErrorLogDiagnosticsDevice {
  /**
   * Create a ErrorLogDiagnosticsDevice.
  ...
  /**
   * Defines the metadata of ErrorLogDiagnosticsDevice
   *
   * @returns {object} metadata of ErrorLogDiagnosticsDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ErrorLog_Diagnostics_device',
      type: {
        name: 'Composite',
        className: 'ErrorLogDiagnosticsDevice',
        modelProperties: {
          sdkName: {
            required: true,
...
module.exports = ErrorLogDiagnosticsDevice;
