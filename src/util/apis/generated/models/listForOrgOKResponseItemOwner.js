 ...
 *
 */
class ListForOrgOKResponseItemOwner {
  /**
   * Create a ListForOrgOKResponseItemOwner.
  ...
  /**
   * Defines the metadata of ListForOrgOKResponseItemOwner
   *
   * @returns {object} metadata of ListForOrgOKResponseItemOwner
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ListForOrgOKResponseItem_owner',
      type: {
        name: 'Composite',
...
module.exports = ListForOrgOKResponseItemOwner;
