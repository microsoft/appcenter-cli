 ...
 *
 */
class ListOKResponseDistributionGroupOwner {
  /**
   * Create a ListOKResponseDistributionGroupOwner.
  ...
  /**
   * Defines the metadata of ListOKResponseDistributionGroupOwner
   *
   * @returns {object} metadata of ListOKResponseDistributionGroupOwner
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ListOKResponse_distribution_group_owner',
      type: {
        name: 'Composite',
...
module.exports = ListOKResponseDistributionGroupOwner;
