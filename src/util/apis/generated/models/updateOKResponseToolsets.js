 ...
 *
 */
class UpdateOKResponseToolsets {
  /**
   * Create a UpdateOKResponseToolsets.
  ...
  /**
   * Defines the metadata of UpdateOKResponseToolsets
   *
   * @returns {object} metadata of UpdateOKResponseToolsets
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'UpdateOKResponse_toolsets',
      type: {
        name: 'Composite',
        ...
        modelProperties: {
          ...
          xamarin: {
            ...
            type: {
              name: 'Composite',
              className: 'UpdateOKResponseToolsetsXamarin'
            }
          },
          android: {
            required: false,
            ...
            type: {
              name: 'Composite',
              className: 'UpdateOKResponseToolsetsAndroid'
            }
          }
        }
      }
...
module.exports = UpdateOKResponseToolsets;
