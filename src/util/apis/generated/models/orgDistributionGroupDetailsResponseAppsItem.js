...
/**
 * Class representing a OrgDistributionGroupDetailsResponseAppsItem.
 */
class OrgDistributionGroupDetailsResponseAppsItem {
  /**
   * Create a OrgDistributionGroupDetailsResponseAppsItem.
  ...
  /**
   * Defines the metadata of OrgDistributionGroupDetailsResponseAppsItem
   *
   * @returns {object} metadata of OrgDistributionGroupDetailsResponseAppsItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'OrgDistributionGroupDetailsResponse_appsItem',
      type: {
        name: 'Composite',
        ...
        modelProperties: {
          ...
          owner: {
            ...
            type: {
              name: 'Composite',
              className: 'OrgDistributionGroupDetailsResponseAppsItemOwner'
            }
          },
          appSecret: {
            required: true,
...
module.exports = OrgDistributionGroupDetailsResponseAppsItem;
