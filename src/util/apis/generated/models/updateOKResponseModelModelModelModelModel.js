...
/**
 * Class representing a UpdateOKResponseModelModelModelModelModel.
 */
class UpdateOKResponseModelModelModelModelModel {
  /**
   * Create a UpdateOKResponseModelModelModelModelModel.
  ...
  /**
   * Defines the metadata of UpdateOKResponseModelModelModelModelModel
   *
   * @returns {object} metadata of UpdateOKResponseModelModelModelModelModel
   *
   */
  mapper() {
    return {
      ...
      type: {
        name: 'Composite',
        className: 'UpdateOKResponseModelModelModelModelModel',
        modelProperties: {
          targetBinaryRange: {
            required: false,
          ...
          diffPackageMap: {
            ...
            type: {
              ...
              value: {
                  required: false,
                  serializedName: 'UpdateOKResponseDiffPackageMapValueElementType',
                  type: {
                    name: 'Composite',
                    className: 'UpdateOKResponseDiffPackageMapValue'
                  }
              }
            }
          },
...
module.exports = UpdateOKResponseModelModelModelModelModel;
