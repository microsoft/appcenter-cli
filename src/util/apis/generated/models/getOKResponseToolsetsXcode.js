 ...
 *
 */
class GetOKResponseToolsetsXcode {
  /**
   * Create a GetOKResponseToolsetsXcode.
  ...
  /**
   * Defines the metadata of GetOKResponseToolsetsXcode
   *
   * @returns {object} metadata of GetOKResponseToolsetsXcode
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetOKResponse_toolsets_xcode',
      type: {
        name: 'Composite',
        className: 'GetOKResponseToolsetsXcode',
        modelProperties: {
          ...
          appExtensionProvisioningProfileFiles: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'GetOKResponseToolsetsXcodeAppExtensionProvisioningProfileFilesItemElementType',
                  type: {
                    name: 'Composite',
...
module.exports = GetOKResponseToolsetsXcode;
