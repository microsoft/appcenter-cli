...
/**
 * Class representing a CreateOKResponseModelModelModel.
 */
class CreateOKResponseModelModelModel {
  /**
   * Create a CreateOKResponseModelModelModel.
  ...
  /**
   * Defines the metadata of CreateOKResponseModelModelModel
   *
   * @returns {object} metadata of CreateOKResponseModelModelModel
   *
   */
  mapper() {
    return {
      ...
      type: {
        name: 'Composite',
        className: 'CreateOKResponseModelModelModel',
        modelProperties: {
          trigger: {
            required: false,
          ...
          artifactVersioning: {
            ...
            type: {
              name: 'Composite',
              className: 'CreateOKResponseArtifactVersioning'
            }
          },
          id: {
            required: true,
...
module.exports = CreateOKResponseModelModelModel;
