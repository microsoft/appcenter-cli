 ...
 *
 */
class UploadedReleaseReleaseUpload {
  /**
   * Create a UploadedReleaseReleaseUpload.
  ...
  /**
   * Defines the metadata of UploadedReleaseReleaseUpload
   *
   * @returns {object} metadata of UploadedReleaseReleaseUpload
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'uploaded_release_release_upload',
      type: {
        name: 'Composite',
        className: 'UploadedReleaseReleaseUpload',
        modelProperties: {
          id: {
            required: true,
            serializedName: 'id',
...
module.exports = UploadedReleaseReleaseUpload;
