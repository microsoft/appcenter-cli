...
class ListOKResponseItemModelModelModelModelModelModel {
  ...
  /**
   * Defines the metadata of ListOKResponseItemModelModelModelModelModelModel
   *
   * @returns {object} metadata of ListOKResponseItemModelModelModelModelModelModel
   *
   */
  mapper() {
    return {
...
module.exports = ListOKResponseItemModelModelModelModelModelModel;
