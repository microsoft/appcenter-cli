...
/**
 * Class representing a DetailsForOrgOKResponseItemAppsItem.
 */
class DetailsForOrgOKResponseItemAppsItem {
  /**
   * Create a DetailsForOrgOKResponseItemAppsItem.
  ...
  /**
   * Defines the metadata of DetailsForOrgOKResponseItemAppsItem
   *
   * @returns {object} metadata of DetailsForOrgOKResponseItemAppsItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'DetailsForOrgOKResponseItem_appsItem',
      type: {
        name: 'Composite',
...
module.exports = DetailsForOrgOKResponseItemAppsItem;
