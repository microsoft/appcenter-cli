...
/**
 * Class representing a ListUsersForOrgOKResponseItem.
 */
class ListUsersForOrgOKResponseItem {
  /**
   * Create a ListUsersForOrgOKResponseItem.
  ...
  /**
   * Defines the metadata of ListUsersForOrgOKResponseItem
   *
   * @returns {object} metadata of ListUsersForOrgOKResponseItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ListUsersForOrgOKResponseItem',
      type: {
        name: 'Composite',
...
module.exports = ListUsersForOrgOKResponseItem;
