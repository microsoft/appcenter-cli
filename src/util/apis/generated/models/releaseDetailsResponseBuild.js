 ...
 *
 */
class ReleaseDetailsResponseBuild {
  /**
   * Create a ReleaseDetailsResponseBuild.
  ...
  /**
   * Defines the metadata of ReleaseDetailsResponseBuild
   *
   * @returns {object} metadata of ReleaseDetailsResponseBuild
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ReleaseDetailsResponse_build',
      type: {
        name: 'Composite',
...
module.exports = ReleaseDetailsResponseBuild;
