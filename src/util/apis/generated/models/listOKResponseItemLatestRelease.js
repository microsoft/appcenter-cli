...
/**
 * Class representing a ListOKResponseItemLatestRelease.
 */
class ListOKResponseItemLatestRelease {
  /**
   * Create a ListOKResponseItemLatestRelease.
  ...
  /**
   * Defines the metadata of ListOKResponseItemLatestRelease
   *
   * @returns {object} metadata of ListOKResponseItemLatestRelease
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ListOKResponseItem_latest_release',
      type: {
        name: 'Composite',
        ...
        modelProperties: {
          ...
          diffPackageMap: {
            ...
            type: {
              ...
              value: {
                  required: false,
                  serializedName: 'ListOKResponseItemLatestReleaseDiffPackageMapValueElementType',
                  type: {
                    name: 'Composite',
...
module.exports = ListOKResponseItemLatestRelease;
