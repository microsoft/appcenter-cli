 ...
 *
 */
class TransferOwnershipOKResponseOwner {
  /**
   * Create a TransferOwnershipOKResponseOwner.
  ...
  /**
   * Defines the metadata of TransferOwnershipOKResponseOwner
   *
   * @returns {object} metadata of TransferOwnershipOKResponseOwner
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'TransferOwnershipOKResponse_owner',
      type: {
        name: 'Composite',
...
module.exports = TransferOwnershipOKResponseOwner;
