 ...
 *
 */
class GetDeviceSetOfUserOKResponse {
  /**
   * Create a GetDeviceSetOfUserOKResponse.
  ...
  /**
   * Defines the metadata of GetDeviceSetOfUserOKResponse
   *
   * @returns {object} metadata of GetDeviceSetOfUserOKResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetDeviceSetOfUserOKResponse',
      type: {
        name: 'Composite',
        className: 'GetDeviceSetOfUserOKResponse',
        modelProperties: {
          id: {
            required: true,
            serializedName: 'id',
          ...
          owner: {
            ...
            type: {
              name: 'Composite',
              className: 'GetDeviceSetOfUserOKResponseOwner'
            }
          },
          osVersionCount: {
            required: false,
          ...
          deviceConfigurations: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'GetDeviceSetOfUserOKResponseDeviceConfigurationsItemElementType',
                  type: {
                    name: 'Composite',
...
module.exports = GetDeviceSetOfUserOKResponse;
