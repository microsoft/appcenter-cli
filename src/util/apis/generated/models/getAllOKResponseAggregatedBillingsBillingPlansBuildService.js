 ...
 *
 */
class GetAllOKResponseAggregatedBillingsBillingPlansBuildService {
  /**
   * Create a GetAllOKResponseAggregatedBillingsBillingPlansBuildService.
  ...
  /**
   * Defines the metadata of GetAllOKResponseAggregatedBillingsBillingPlansBuildService
   *
   * @returns {object} metadata of GetAllOKResponseAggregatedBillingsBillingPlansBuildService
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetAllOKResponse_aggregatedBillings_billingPlans_buildService',
      type: {
        name: 'Composite',
        className: 'GetAllOKResponseAggregatedBillingsBillingPlansBuildService',
        modelProperties: {
          canSelectTrialPlan: {
            required: false,
...
module.exports = GetAllOKResponseAggregatedBillingsBillingPlansBuildService;
