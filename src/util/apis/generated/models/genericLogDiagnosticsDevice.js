 ...
 *
 */
class GenericLogDiagnosticsDevice {
  /**
   * Create a GenericLogDiagnosticsDevice.
  ...
  /**
   * Defines the metadata of GenericLogDiagnosticsDevice
   *
   * @returns {object} metadata of GenericLogDiagnosticsDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GenericLog_Diagnostics_device',
      type: {
        name: 'Composite',
...
module.exports = GenericLogDiagnosticsDevice;
