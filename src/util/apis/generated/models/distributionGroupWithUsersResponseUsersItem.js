...
/**
 * Class representing a DistributionGroupWithUsersResponseUsersItem.
 */
class DistributionGroupWithUsersResponseUsersItem {
  /**
   * Create a DistributionGroupWithUsersResponseUsersItem.
  ...
  /**
   * Defines the metadata of DistributionGroupWithUsersResponseUsersItem
   *
   * @returns {object} metadata of DistributionGroupWithUsersResponseUsersItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'DistributionGroupWithUsersResponse_usersItem',
      type: {
        name: 'Composite',
...
module.exports = DistributionGroupWithUsersResponseUsersItem;
