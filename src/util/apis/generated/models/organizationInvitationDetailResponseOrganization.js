...
/**
 * Class representing a OrganizationInvitationDetailResponseOrganization.
 */
class OrganizationInvitationDetailResponseOrganization {
  /**
   * Create a OrganizationInvitationDetailResponseOrganization.
  ...
  /**
   * Defines the metadata of OrganizationInvitationDetailResponseOrganization
   *
   * @returns {object} metadata of OrganizationInvitationDetailResponseOrganization
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'OrganizationInvitationDetailResponse_organization',
      type: {
        name: 'Composite',
...
module.exports = OrganizationInvitationDetailResponseOrganization;
