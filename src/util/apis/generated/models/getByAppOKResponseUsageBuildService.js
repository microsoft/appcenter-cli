 ...
 *
 */
class GetByAppOKResponseUsageBuildService {
  /**
   * Create a GetByAppOKResponseUsageBuildService.
  ...
  /**
   * Defines the metadata of GetByAppOKResponseUsageBuildService
   *
   * @returns {object} metadata of GetByAppOKResponseUsageBuildService
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetByAppOKResponse_usage_buildService',
      type: {
        name: 'Composite',
        className: 'GetByAppOKResponseUsageBuildService',
        modelProperties: {
          currentUsagePeriod: {
            required: false,
...
module.exports = GetByAppOKResponseUsageBuildService;
