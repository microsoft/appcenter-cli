 ...
 *
 */
class GetTestRunsOKResponseItem {
  /**
   * Create a GetTestRunsOKResponseItem.
  ...
  /**
   * Defines the metadata of GetTestRunsOKResponseItem
   *
   * @returns {object} metadata of GetTestRunsOKResponseItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetTestRunsOKResponseItem',
      type: {
        name: 'Composite',
...
module.exports = GetTestRunsOKResponseItem;
