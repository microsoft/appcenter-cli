...
/**
 * Class representing a UpdateOKResponseAzureSubscription.
 */
class UpdateOKResponseAzureSubscription {
  /**
   * Create a UpdateOKResponseAzureSubscription.
  ...
  /**
   * Defines the metadata of UpdateOKResponseAzureSubscription
   *
   * @returns {object} metadata of UpdateOKResponseAzureSubscription
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'UpdateOKResponse_azure_subscription',
      type: {
        name: 'Composite',
...
module.exports = UpdateOKResponseAzureSubscription;
