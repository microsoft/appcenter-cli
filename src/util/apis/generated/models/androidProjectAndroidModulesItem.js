...
/**
 * Class representing a AndroidProjectAndroidModulesItem.
 */
class AndroidProjectAndroidModulesItem {
  /**
   * Create a AndroidProjectAndroidModulesItem.
  ...
  /**
   * Defines the metadata of AndroidProjectAndroidModulesItem
   *
   * @returns {object} metadata of AndroidProjectAndroidModulesItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'AndroidProject_androidModulesItem',
      type: {
        name: 'Composite',
        ...
        modelProperties: {
          ...
          buildConfigurations: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'AndroidProjectAndroidModulesItemBuildConfigurationsItemElementType',
                  type: {
                    name: 'Composite',
...
module.exports = AndroidProjectAndroidModulesItem;
