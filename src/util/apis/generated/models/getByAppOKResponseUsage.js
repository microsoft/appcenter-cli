 ...
 *
 */
class GetByAppOKResponseUsage {
  /**
   * Create a GetByAppOKResponseUsage.
  ...
  /**
   * Defines the metadata of GetByAppOKResponseUsage
   *
   * @returns {object} metadata of GetByAppOKResponseUsage
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetByAppOKResponse_usage',
      type: {
        name: 'Composite',
...
module.exports = GetByAppOKResponseUsage;
