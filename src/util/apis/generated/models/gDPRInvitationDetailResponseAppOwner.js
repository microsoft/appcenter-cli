 ...
 *
 */
class GDPRInvitationDetailResponseAppOwner {
  /**
   * Create a GDPRInvitationDetailResponseAppOwner.
  ...
  /**
   * Defines the metadata of GDPRInvitationDetailResponseAppOwner
   *
   * @returns {object} metadata of GDPRInvitationDetailResponseAppOwner
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GDPRInvitationDetailResponse_app_owner',
      type: {
        name: 'Composite',
...
module.exports = GDPRInvitationDetailResponseAppOwner;
