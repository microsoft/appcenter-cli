...
/**
 * Class representing a ListTestersOKResponseItem.
 */
class ListTestersOKResponseItem {
  /**
   * Create a ListTestersOKResponseItem.
  ...
  /**
   * Defines the metadata of ListTestersOKResponseItem
   *
   * @returns {object} metadata of ListTestersOKResponseItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ListTestersOKResponseItem',
      type: {
        name: 'Composite',
...
module.exports = ListTestersOKResponseItem;
