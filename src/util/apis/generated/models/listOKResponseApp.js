...
/**
 * Class representing a ListOKResponseApp.
 */
class ListOKResponseApp {
  /**
   * Create a ListOKResponseApp.
  ...
  /**
   * Defines the metadata of ListOKResponseApp
   *
   * @returns {object} metadata of ListOKResponseApp
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ListOKResponse_app',
      type: {
        name: 'Composite',
        className: 'ListOKResponseApp',
        modelProperties: {
          id: {
            required: true,
            serializedName: 'id',
          ...
          owner: {
            ...
            type: {
              name: 'Composite',
              className: 'ListOKResponseAppOwner'
            }
          },
          appSecret: {
            required: true,
...
module.exports = ListOKResponseApp;
