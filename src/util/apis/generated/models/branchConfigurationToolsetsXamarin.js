 ...
 *
 */
class BranchConfigurationToolsetsXamarin {
  /**
   * Create a BranchConfigurationToolsetsXamarin.
  ...
  /**
   * Defines the metadata of BranchConfigurationToolsetsXamarin
   *
   * @returns {object} metadata of BranchConfigurationToolsetsXamarin
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'BranchConfiguration_toolsets_xamarin',
      type: {
        name: 'Composite',
...
module.exports = BranchConfigurationToolsetsXamarin;
