 ...
 *
 */
class ServiceBillingPlansCurrentBillingPeriodByAccountPlan {
  /**
   * Create a ServiceBillingPlansCurrentBillingPeriodByAccountPlan.
  ...
  /**
   * Defines the metadata of ServiceBillingPlansCurrentBillingPeriodByAccountPlan
   *
   * @returns {object} metadata of ServiceBillingPlansCurrentBillingPeriodByAccountPlan
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ServiceBillingPlans_currentBillingPeriod_byAccount_plan',
      type: {
        name: 'Composite',
...
module.exports = ServiceBillingPlansCurrentBillingPeriodByAccountPlan;
