...
/**
 * Class representing a ErrorGroupsErrorGroupsItemReasonFramesItem.
 */
class ErrorGroupsErrorGroupsItemReasonFramesItem {
  /**
   * Create a ErrorGroupsErrorGroupsItemReasonFramesItem.
  ...
  /**
   * Defines the metadata of ErrorGroupsErrorGroupsItemReasonFramesItem
   *
   * @returns {object} metadata of ErrorGroupsErrorGroupsItemReasonFramesItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ErrorGroups_errorGroupsItem_reasonFramesItem',
      type: {
        name: 'Composite',
        className: 'ErrorGroupsErrorGroupsItemReasonFramesItem',
        modelProperties: {
          className: {
            required: false,
...
module.exports = ErrorGroupsErrorGroupsItemReasonFramesItem;
