 ...
 *
 */
class BillingPeriodByAccountPlan {
  /**
   * Create a BillingPeriodByAccountPlan.
  ...
  /**
   * Defines the metadata of BillingPeriodByAccountPlan
   *
   * @returns {object} metadata of BillingPeriodByAccountPlan
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'BillingPeriod_byAccount_plan',
      type: {
        name: 'Composite',
...
module.exports = BillingPeriodByAccountPlan;
