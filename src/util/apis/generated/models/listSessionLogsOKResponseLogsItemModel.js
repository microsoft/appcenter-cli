 ...
 *
 */
class ListSessionLogsOKResponseLogsItemModel {
  /**
   * Create a ListSessionLogsOKResponseLogsItemModel.
  ...
  /**
   * Defines the metadata of ListSessionLogsOKResponseLogsItemModel
   *
   * @returns {object} metadata of ListSessionLogsOKResponseLogsItemModel
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ListSessionLogsOKResponse_logsItem',
      type: {
        name: 'Composite',
        ...
        modelProperties: {
          ...
          device: {
            ...
            type: {
              name: 'Composite',
              className: 'ListSessionLogsOKResponseLogsItemDevice'
            }
          },
          authProvider: {
            required: false,
...
module.exports = ListSessionLogsOKResponseLogsItemModel;
