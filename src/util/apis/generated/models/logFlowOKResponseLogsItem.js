...
/**
 * Class representing a LogFlowOKResponseLogsItem.
 */
class LogFlowOKResponseLogsItem {
  /**
   * Create a LogFlowOKResponseLogsItem.
  ...
  /**
   * Defines the metadata of LogFlowOKResponseLogsItem
   *
   * @returns {object} metadata of LogFlowOKResponseLogsItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'LogFlowOKResponse_logsItem',
      type: {
        name: 'Composite',
        ...
        uberParent: 'LogFlowOKResponseLogsItem',
        className: 'LogFlowOKResponseLogsItem',
        modelProperties: {
          timestamp: {
            required: true,
          ...
          device: {
            ...
            type: {
              name: 'Composite',
              className: 'LogFlowOKResponseLogsItemDevice'
            }
          },
          type: {
            required: true,
...
module.exports = LogFlowOKResponseLogsItem;
