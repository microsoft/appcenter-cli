...
class TestRunStats {
  ...
  /**
   * Defines the metadata of TestRunStats
   *
   * @returns {object} metadata of TestRunStats
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'TestRun_stats',
      type: {
        name: 'Composite',
