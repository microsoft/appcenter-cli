 ...
 *
 */
class LogFlowLogDevice {
  /**
   * Create a LogFlowLogDevice.
  ...
  /**
   * Defines the metadata of LogFlowLogDevice
   *
   * @returns {object} metadata of LogFlowLogDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'LogFlowLog_device',
      type: {
        name: 'Composite',
...
module.exports = LogFlowLogDevice;
