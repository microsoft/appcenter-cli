 ...
 *
 */
class StartSessionLogDevice {
  /**
   * Create a StartSessionLogDevice.
  ...
  /**
   * Defines the metadata of StartSessionLogDevice
   *
   * @returns {object} metadata of StartSessionLogDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'StartSessionLog_device',
      type: {
        name: 'Composite',
        className: 'StartSessionLogDevice',
        modelProperties: {
          sdkName: {
            required: true,
...
module.exports = StartSessionLogDevice;
