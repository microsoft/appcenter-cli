 ...
 *
 */
class GetOKResponseOwner {
  /**
   * Create a GetOKResponseOwner.
  ...
  /**
   * Defines the metadata of GetOKResponseOwner
   *
   * @returns {object} metadata of GetOKResponseOwner
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetOKResponse_owner',
      type: {
        name: 'Composite',
...
module.exports = GetOKResponseOwner;
