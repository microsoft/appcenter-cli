...
/**
 * Class representing a ListForOrgOKResponseItem.
 */
class ListForOrgOKResponseItem {
  /**
   * Create a ListForOrgOKResponseItem.
  ...
  /**
   * Defines the metadata of ListForOrgOKResponseItem
   *
   * @returns {object} metadata of ListForOrgOKResponseItem
   *
   */
  mapper() {
    return {
...
module.exports = ListForOrgOKResponseItem;
