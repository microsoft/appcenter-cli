...
/**
 * Class representing a GetOKResponseModelModel.
 */
class GetOKResponseModelModel {
  /**
   * Create a GetOKResponseModelModel.
  ...
  /**
   * Defines the metadata of GetOKResponseModelModel
   *
   * @returns {object} metadata of GetOKResponseModelModel
   *
   */
  mapper() {
    return {
      ...
      type: {
        name: 'Composite',
        className: 'GetOKResponseModelModel',
        modelProperties: {
          symbolId: {
            required: true,
...
module.exports = GetOKResponseModelModel;
