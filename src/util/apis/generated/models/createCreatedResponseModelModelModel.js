...
/**
 * Class representing a CreateCreatedResponseModelModelModel.
 */
class CreateCreatedResponseModelModelModel {
  /**
   * Create a CreateCreatedResponseModelModelModel.
  ...
  /**
   * Defines the metadata of CreateCreatedResponseModelModelModel
   *
   * @returns {object} metadata of CreateCreatedResponseModelModelModel
   *
   */
  mapper() {
    return {
      ...
      type: {
        name: 'Composite',
        className: 'CreateCreatedResponseModelModelModel',
        modelProperties: {
          targetBinaryRange: {
            required: false,
          ...
          diffPackageMap: {
            ...
            type: {
              ...
              value: {
                  required: false,
                  serializedName: 'CreateCreatedResponseDiffPackageMapValueElementType',
                  type: {
                    name: 'Composite',
...
module.exports = CreateCreatedResponseModelModelModel;
