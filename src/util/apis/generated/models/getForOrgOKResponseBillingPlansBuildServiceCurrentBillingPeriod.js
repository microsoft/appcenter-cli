 ...
 *
 */
class GetForOrgOKResponseBillingPlansBuildServiceCurrentBillingPeriod {
  /**
   * Create a GetForOrgOKResponseBillingPlansBuildServiceCurrentBillingPeriod.
  ...
  /**
   * Defines the metadata of GetForOrgOKResponseBillingPlansBuildServiceCurrentBillingPeriod
   *
   * @returns {object} metadata of GetForOrgOKResponseBillingPlansBuildServiceCurrentBillingPeriod
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetForOrgOKResponse_billingPlans_buildService_currentBillingPeriod',
      type: {
        name: 'Composite',
        ...
        modelProperties: {
          ...
          byAccount: {
            ...
            type: {
              name: 'Composite',
              className: 'GetForOrgOKResponseBillingPlansBuildServiceCurrentBillingPeriodByAccount'
            }
          }
        }
      }
...
module.exports = GetForOrgOKResponseBillingPlansBuildServiceCurrentBillingPeriod;
