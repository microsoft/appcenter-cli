 ...
 *
 */
class LogWithPropertiesDiagnosticsDevice {
  /**
   * Create a LogWithPropertiesDiagnosticsDevice.
  ...
  /**
   * Defines the metadata of LogWithPropertiesDiagnosticsDevice
   *
   * @returns {object} metadata of LogWithPropertiesDiagnosticsDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'LogWithProperties_Diagnostics_device',
      type: {
        name: 'Composite',
        className: 'LogWithPropertiesDiagnosticsDevice',
        modelProperties: {
          sdkName: {
            required: true,
...
module.exports = LogWithPropertiesDiagnosticsDevice;
