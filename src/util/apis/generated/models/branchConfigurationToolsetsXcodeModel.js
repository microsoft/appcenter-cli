 ...
 *
 */
class BranchConfigurationToolsetsXcodeModel {
  /**
   * Create a BranchConfigurationToolsetsXcodeModel.
  ...
  /**
   * Defines the metadata of BranchConfigurationToolsetsXcodeModel
   *
   * @returns {object} metadata of BranchConfigurationToolsetsXcodeModel
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'BranchConfigurationToolsets_xcode',
      type: {
        name: 'Composite',
        className: 'BranchConfigurationToolsetsXcodeModel',
        modelProperties: {
          ...
          appExtensionProvisioningProfileFiles: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'BranchConfigurationToolsetsXcodeAppExtensionProvisioningProfileFilesItemModelElementType',
                  type: {
                    name: 'Composite',
...
module.exports = BranchConfigurationToolsetsXcodeModel;
