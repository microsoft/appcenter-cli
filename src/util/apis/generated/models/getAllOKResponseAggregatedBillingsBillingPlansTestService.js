 ...
 *
 */
class GetAllOKResponseAggregatedBillingsBillingPlansTestService {
  /**
   * Create a GetAllOKResponseAggregatedBillingsBillingPlansTestService.
  ...
  /**
   * Defines the metadata of GetAllOKResponseAggregatedBillingsBillingPlansTestService
   *
   * @returns {object} metadata of GetAllOKResponseAggregatedBillingsBillingPlansTestService
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetAllOKResponse_aggregatedBillings_billingPlans_testService',
      type: {
        name: 'Composite',
        className: 'GetAllOKResponseAggregatedBillingsBillingPlansTestService',
        modelProperties: {
          canSelectTrialPlan: {
            required: false,
...
module.exports = GetAllOKResponseAggregatedBillingsBillingPlansTestService;
