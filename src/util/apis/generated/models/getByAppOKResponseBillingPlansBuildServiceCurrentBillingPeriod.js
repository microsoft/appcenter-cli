 ...
 *
 */
class GetByAppOKResponseBillingPlansBuildServiceCurrentBillingPeriod {
  /**
   * Create a GetByAppOKResponseBillingPlansBuildServiceCurrentBillingPeriod.
  ...
  /**
   * Defines the metadata of GetByAppOKResponseBillingPlansBuildServiceCurrentBillingPeriod
   *
   * @returns {object} metadata of GetByAppOKResponseBillingPlansBuildServiceCurrentBillingPeriod
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetByAppOKResponse_billingPlans_buildService_currentBillingPeriod',
      type: {
        name: 'Composite',
        className: 'GetByAppOKResponseBillingPlansBuildServiceCurrentBillingPeriod',
        modelProperties: {
          startTime: {
            required: false,
...
module.exports = GetByAppOKResponseBillingPlansBuildServiceCurrentBillingPeriod;
