...
/**
 * Class representing a TransferToOrgOKResponse.
 */
class TransferToOrgOKResponse {
  /**
   * Create a TransferToOrgOKResponse.
  ...
  /**
   * Defines the metadata of TransferToOrgOKResponse
   *
   * @returns {object} metadata of TransferToOrgOKResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'TransferToOrgOKResponse',
      type: {
        name: 'Composite',
        className: 'TransferToOrgOKResponse',
        modelProperties: {
          id: {
            required: true,
            serializedName: 'id',
...
module.exports = TransferToOrgOKResponse;
