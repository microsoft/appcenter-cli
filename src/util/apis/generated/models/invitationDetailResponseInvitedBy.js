...
/**
 * Class representing a InvitationDetailResponseInvitedBy.
 */
class InvitationDetailResponseInvitedBy {
  /**
   * Create a InvitationDetailResponseInvitedBy.
  ...
  /**
   * Defines the metadata of InvitationDetailResponseInvitedBy
   *
   * @returns {object} metadata of InvitationDetailResponseInvitedBy
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'InvitationDetailResponse_invited_by',
      type: {
        name: 'Composite',
...
module.exports = InvitationDetailResponseInvitedBy;
