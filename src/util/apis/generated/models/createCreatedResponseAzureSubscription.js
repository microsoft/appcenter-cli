...
/**
 * Class representing a CreateCreatedResponseAzureSubscription.
 */
class CreateCreatedResponseAzureSubscription {
  /**
   * Create a CreateCreatedResponseAzureSubscription.
  ...
  /**
   * Defines the metadata of CreateCreatedResponseAzureSubscription
   *
   * @returns {object} metadata of CreateCreatedResponseAzureSubscription
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'CreateCreatedResponse_azure_subscription',
      type: {
        name: 'Composite',
...
module.exports = CreateCreatedResponseAzureSubscription;
