...
/**
 * Class representing a ListLatestOKResponseItemDestinationsItem.
 */
class ListLatestOKResponseItemDestinationsItem {
  /**
   * Create a ListLatestOKResponseItemDestinationsItem.
  ...
  /**
   * Defines the metadata of ListLatestOKResponseItemDestinationsItem
   *
   * @returns {object} metadata of ListLatestOKResponseItemDestinationsItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ListLatestOKResponseItem_destinationsItem',
      type: {
        name: 'Composite',
...
module.exports = ListLatestOKResponseItemDestinationsItem;
