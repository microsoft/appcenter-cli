 ...
 *
 */
class ReleaseDetailsUpdateRequestBuild {
  /**
   * Create a ReleaseDetailsUpdateRequestBuild.
  ...
  /**
   * Defines the metadata of ReleaseDetailsUpdateRequestBuild
   *
   * @returns {object} metadata of ReleaseDetailsUpdateRequestBuild
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ReleaseDetailsUpdateRequest_build',
      type: {
        name: 'Composite',
...
module.exports = ReleaseDetailsUpdateRequestBuild;
