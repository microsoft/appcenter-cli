...
/**
 * Class representing a AppResponseInternalAzureSubscription.
 */
class AppResponseInternalAzureSubscription {
  /**
   * Create a AppResponseInternalAzureSubscription.
  ...
  /**
   * Defines the metadata of AppResponseInternalAzureSubscription
   *
   * @returns {object} metadata of AppResponseInternalAzureSubscription
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'AppResponseInternal_azure_subscription',
      type: {
        name: 'Composite',
...
module.exports = AppResponseInternalAzureSubscription;
