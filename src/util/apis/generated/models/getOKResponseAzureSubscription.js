...
/**
 * Class representing a GetOKResponseAzureSubscription.
 */
class GetOKResponseAzureSubscription {
  /**
   * Create a GetOKResponseAzureSubscription.
  ...
  /**
   * Defines the metadata of GetOKResponseAzureSubscription
   *
   * @returns {object} metadata of GetOKResponseAzureSubscription
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetOKResponse_azure_subscription',
      type: {
        name: 'Composite',
...
module.exports = GetOKResponseAzureSubscription;
