 ...
 *
 */
class ExportConfigurationListResultValuesItem {
  /**
   * Create a ExportConfigurationListResultValuesItem.
  ...
  /**
   * Defines the metadata of ExportConfigurationListResultValuesItem
   *
   * @returns {object} metadata of ExportConfigurationListResultValuesItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ExportConfigurationListResult_valuesItem',
      type: {
        name: 'Composite',
...
module.exports = ExportConfigurationListResultValuesItem;
