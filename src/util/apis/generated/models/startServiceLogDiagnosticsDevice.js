 ...
 *
 */
class StartServiceLogDiagnosticsDevice {
  /**
   * Create a StartServiceLogDiagnosticsDevice.
  ...
  /**
   * Defines the metadata of StartServiceLogDiagnosticsDevice
   *
   * @returns {object} metadata of StartServiceLogDiagnosticsDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'StartServiceLog_Diagnostics_device',
      type: {
        name: 'Composite',
        className: 'StartServiceLogDiagnosticsDevice',
        modelProperties: {
          sdkName: {
            required: true,
...
module.exports = StartServiceLogDiagnosticsDevice;
