 ...
 *
 */
class CreateCreatedResponseModelModelModelModelModel {
  /**
   * Create a CreateCreatedResponseModelModelModelModelModel.
  ...
  /**
   * Defines the metadata of CreateCreatedResponseModelModelModelModelModel
   *
   * @returns {object} metadata of CreateCreatedResponseModelModelModelModelModel
   *
   */
  mapper() {
    return {
      ...
      type: {
        name: 'Composite',
        className: 'CreateCreatedResponseModelModelModelModelModel',
        modelProperties: {
          appId: {
            required: false,
...
module.exports = CreateCreatedResponseModelModelModelModelModel;
