 ...
 *
 */
class RegisterUserForDeviceOKResponse {
  /**
   * Create a RegisterUserForDeviceOKResponse.
  ...
  /**
   * Defines the metadata of RegisterUserForDeviceOKResponse
   *
   * @returns {object} metadata of RegisterUserForDeviceOKResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'RegisterUserForDeviceOKResponse',
      type: {
        name: 'Composite',
        className: 'RegisterUserForDeviceOKResponse',
        modelProperties: {
          udid: {
            required: true,
            serializedName: 'udid',
...
module.exports = RegisterUserForDeviceOKResponse;
