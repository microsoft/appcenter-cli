 ...
 *
 */
class BranchConfigurationWithIdToolsetsXamarin {
  /**
   * Create a BranchConfigurationWithIdToolsetsXamarin.
  ...
  /**
   * Defines the metadata of BranchConfigurationWithIdToolsetsXamarin
   *
   * @returns {object} metadata of BranchConfigurationWithIdToolsetsXamarin
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'BranchConfigurationWithId_toolsets_xamarin',
      type: {
        name: 'Composite',
...
module.exports = BranchConfigurationWithIdToolsetsXamarin;
