...
/**
 * Class representing a GetAppsOKResponseItem.
 */
class GetAppsOKResponseItem {
  /**
   * Create a GetAppsOKResponseItem.
  ...
  /**
   * Defines the metadata of GetAppsOKResponseItem
   *
   * @returns {object} metadata of GetAppsOKResponseItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetAppsOKResponseItem',
      type: {
        name: 'Composite',
        ...
        modelProperties: {
          ...
          owner: {
            ...
            type: {
              name: 'Composite',
              className: 'GetAppsOKResponseItemOwner'
            }
          },
          platform: {
            required: false,
...
module.exports = GetAppsOKResponseItem;
