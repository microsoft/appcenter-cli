...
/**
 * Class representing a ListOKResponseItemDestinationsItem.
 */
class ListOKResponseItemDestinationsItem {
  /**
   * Create a ListOKResponseItemDestinationsItem.
  ...
  /**
   * Defines the metadata of ListOKResponseItemDestinationsItem
   *
   * @returns {object} metadata of ListOKResponseItemDestinationsItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ListOKResponseItem_destinationsItem',
      type: {
        name: 'Composite',
...
module.exports = ListOKResponseItemDestinationsItem;
