 ...
 *
 */
class LogFlowErrorLogDevice {
  /**
   * Create a LogFlowErrorLogDevice.
  ...
  /**
   * Defines the metadata of LogFlowErrorLogDevice
   *
   * @returns {object} metadata of LogFlowErrorLogDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'LogFlowErrorLog_device',
      type: {
        name: 'Composite',
        className: 'LogFlowErrorLogDevice',
        modelProperties: {
          sdkName: {
            required: true,
...
module.exports = LogFlowErrorLogDevice;
