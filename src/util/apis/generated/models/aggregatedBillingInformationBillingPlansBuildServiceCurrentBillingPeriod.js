 ...
 *
 */
class AggregatedBillingInformationBillingPlansBuildServiceCurrentBillingPeriod {
  /**
   * Create a AggregatedBillingInformationBillingPlansBuildServiceCurrentBillingPeriod.
  ...
  /**
   * Defines the metadata of AggregatedBillingInformationBillingPlansBuildServiceCurrentBillingPeriod
   *
   * @returns {object} metadata of AggregatedBillingInformationBillingPlansBuildServiceCurrentBillingPeriod
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'AggregatedBillingInformation_billingPlans_buildService_currentBillingPeriod',
      type: {
        name: 'Composite',
        className: 'AggregatedBillingInformationBillingPlansBuildServiceCurrentBillingPeriod',
        modelProperties: {
          startTime: {
            required: false,
...
module.exports = AggregatedBillingInformationBillingPlansBuildServiceCurrentBillingPeriod;
