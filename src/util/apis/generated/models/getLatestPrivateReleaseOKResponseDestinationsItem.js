...
/**
 * Class representing a GetLatestPrivateReleaseOKResponseDestinationsItem.
 */
class GetLatestPrivateReleaseOKResponseDestinationsItem {
  /**
   * Create a GetLatestPrivateReleaseOKResponseDestinationsItem.
  ...
  /**
   * Defines the metadata of GetLatestPrivateReleaseOKResponseDestinationsItem
   *
   * @returns {object} metadata of GetLatestPrivateReleaseOKResponseDestinationsItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetLatestPrivateReleaseOKResponse_destinationsItem',
      type: {
        name: 'Composite',
...
module.exports = GetLatestPrivateReleaseOKResponseDestinationsItem;
