 ...
 *
 */
class LogContainerLogsItemDevice {
  /**
   * Create a LogContainerLogsItemDevice.
  ...
  /**
   * Defines the metadata of LogContainerLogsItemDevice
   *
   * @returns {object} metadata of LogContainerLogsItemDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'LogContainer_logsItem_device',
      type: {
        name: 'Composite',
...
module.exports = LogContainerLogsItemDevice;
