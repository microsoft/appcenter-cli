...
/**
 * Class representing a AppResponseAzureSubscription.
 */
class AppResponseAzureSubscription {
  /**
   * Create a AppResponseAzureSubscription.
  ...
  /**
   * Defines the metadata of AppResponseAzureSubscription
   *
   * @returns {object} metadata of AppResponseAzureSubscription
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'AppResponse_azure_subscription',
      type: {
        name: 'Composite',
...
module.exports = AppResponseAzureSubscription;
