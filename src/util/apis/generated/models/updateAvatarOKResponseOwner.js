 ...
 *
 */
class UpdateAvatarOKResponseOwner {
  /**
   * Create a UpdateAvatarOKResponseOwner.
  ...
  /**
   * Defines the metadata of UpdateAvatarOKResponseOwner
   *
   * @returns {object} metadata of UpdateAvatarOKResponseOwner
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'UpdateAvatarOKResponse_owner',
      type: {
        name: 'Composite',
...
module.exports = UpdateAvatarOKResponseOwner;
