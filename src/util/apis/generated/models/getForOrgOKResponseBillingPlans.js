 ...
 *
 */
class GetForOrgOKResponseBillingPlans {
  /**
   * Create a GetForOrgOKResponseBillingPlans.
  ...
  /**
   * Defines the metadata of GetForOrgOKResponseBillingPlans
   *
   * @returns {object} metadata of GetForOrgOKResponseBillingPlans
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetForOrgOKResponse_billingPlans',
      type: {
        name: 'Composite',
        className: 'GetForOrgOKResponseBillingPlans',
        modelProperties: {
          buildService: {
            required: false,
...
module.exports = GetForOrgOKResponseBillingPlans;
