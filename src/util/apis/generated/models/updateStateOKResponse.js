...
/**
 * Class representing a UpdateStateOKResponse.
 */
class UpdateStateOKResponse {
  /**
   * Create a UpdateStateOKResponse.
  ...
  /**
   * Defines the metadata of UpdateStateOKResponse
   *
   * @returns {object} metadata of UpdateStateOKResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'UpdateStateOKResponse',
      type: {
        name: 'Composite',
        className: 'UpdateStateOKResponse',
        modelProperties: {
          state: {
            required: true,
          ...
          reasonFrames: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'UpdateStateOKResponseReasonFramesItemElementType',
                  type: {
                    name: 'Composite',
...
module.exports = UpdateStateOKResponse;
