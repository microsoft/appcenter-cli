 ...
 *
 */
class ExceptionFramesItem {
  /**
   * Create a ExceptionFramesItem.
  ...
  /**
   * Defines the metadata of ExceptionFramesItem
   *
   * @returns {object} metadata of ExceptionFramesItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'Exception_framesItem',
      type: {
        name: 'Composite',
...
module.exports = ExceptionFramesItem;
