...
/**
 * Class representing a GDPRInvitationDetailResponseApp.
 */
class GDPRInvitationDetailResponseApp {
  /**
   * Create a GDPRInvitationDetailResponseApp.
  ...
  /**
   * Defines the metadata of GDPRInvitationDetailResponseApp
   *
   * @returns {object} metadata of GDPRInvitationDetailResponseApp
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GDPRInvitationDetailResponse_app',
      type: {
        name: 'Composite',
        ...
        modelProperties: {
          ...
          owner: {
            ...
            type: {
              name: 'Composite',
              className: 'GDPRInvitationDetailResponseAppOwner'
            }
          },
          appSecret: {
            required: true,
...
module.exports = GDPRInvitationDetailResponseApp;
