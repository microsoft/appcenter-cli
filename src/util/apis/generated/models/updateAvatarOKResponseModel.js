...
/**
 * Class representing a UpdateAvatarOKResponseModel.
 */
class UpdateAvatarOKResponseModel {
  /**
   * Create a UpdateAvatarOKResponseModel.
  ...
  /**
   * Defines the metadata of UpdateAvatarOKResponseModel
   *
   * @returns {object} metadata of UpdateAvatarOKResponseModel
   *
   */
  mapper() {
    return {
      ...
      type: {
        name: 'Composite',
        className: 'UpdateAvatarOKResponseModel',
        modelProperties: {
          id: {
            required: true,
            serializedName: 'id',
          ...
          owner: {
            ...
            type: {
              name: 'Composite',
              className: 'UpdateAvatarOKResponseOwner'
            }
          },
          appSecret: {
            required: true,
...
module.exports = UpdateAvatarOKResponseModel;
