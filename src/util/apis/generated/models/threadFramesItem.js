 ...
 *
 */
class ThreadFramesItem {
  /**
   * Create a ThreadFramesItem.
  ...
  /**
   * Defines the metadata of ThreadFramesItem
   *
   * @returns {object} metadata of ThreadFramesItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'Thread_framesItem',
      type: {
        name: 'Composite',
...
module.exports = ThreadFramesItem;
