 ...
 *
 */
class ListOKResponseAppOwner {
  /**
   * Create a ListOKResponseAppOwner.
  ...
  /**
   * Defines the metadata of ListOKResponseAppOwner
   *
   * @returns {object} metadata of ListOKResponseAppOwner
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ListOKResponse_app_owner',
      type: {
        name: 'Composite',
...
module.exports = ListOKResponseAppOwner;
