 ...
 *
 */
class CreateForOrgCreatedResponseOwner {
  /**
   * Create a CreateForOrgCreatedResponseOwner.
  ...
  /**
   * Defines the metadata of CreateForOrgCreatedResponseOwner
   *
   * @returns {object} metadata of CreateForOrgCreatedResponseOwner
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'CreateForOrgCreatedResponse_owner',
      type: {
        name: 'Composite',
...
module.exports = CreateForOrgCreatedResponseOwner;
