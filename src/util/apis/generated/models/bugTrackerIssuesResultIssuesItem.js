 ...
 *
 */
class BugTrackerIssuesResultIssuesItem {
  /**
   * Create a BugTrackerIssuesResultIssuesItem.
   * @property {string} [id]
   * @property {string} [url]
  ...
  /**
   * Defines the metadata of BugTrackerIssuesResultIssuesItem
   *
   * @returns {object} metadata of BugTrackerIssuesResultIssuesItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'BugTrackerIssuesResult_issuesItem',
      type: {
        name: 'Composite',
...
module.exports = BugTrackerIssuesResultIssuesItem;
