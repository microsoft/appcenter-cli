 ...
 *
 */
class PushInstallationLogDevice {
  /**
   * Create a PushInstallationLogDevice.
  ...
  /**
   * Defines the metadata of PushInstallationLogDevice
   *
   * @returns {object} metadata of PushInstallationLogDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'PushInstallationLog_device',
      type: {
        name: 'Composite',
        className: 'PushInstallationLogDevice',
        modelProperties: {
          sdkName: {
            required: true,
...
module.exports = PushInstallationLogDevice;
