 ...
 *
 */
class CreateAcceptedResponse {
  /**
   * Create a CreateAcceptedResponse.
  ...
  /**
   * Defines the metadata of CreateAcceptedResponse
   *
   * @returns {object} metadata of CreateAcceptedResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'CreateAcceptedResponse',
      type: {
        name: 'Composite',
        className: 'CreateAcceptedResponse',
        modelProperties: {
          id: {
            required: true,
            serializedName: 'id',
...
module.exports = CreateAcceptedResponse;
