...
/**
 * Class representing a ListBranchesOKResponseItemLastBuild.
 */
class ListBranchesOKResponseItemLastBuild {
  /**
   * Create a ListBranchesOKResponseItemLastBuild.
  ...
  /**
   * Defines the metadata of ListBranchesOKResponseItemLastBuild
   *
   * @returns {object} metadata of ListBranchesOKResponseItemLastBuild
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ListBranchesOKResponseItem_lastBuild',
      type: {
        name: 'Composite',
...
module.exports = ListBranchesOKResponseItemLastBuild;
