...
/**
 * Class representing a AddAppCreatedResponseAzureSubscription.
 */
class AddAppCreatedResponseAzureSubscription {
  /**
   * Create a AddAppCreatedResponseAzureSubscription.
  ...
  /**
   * Defines the metadata of AddAppCreatedResponseAzureSubscription
   *
   * @returns {object} metadata of AddAppCreatedResponseAzureSubscription
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'AddAppCreatedResponse_azure_subscription',
      type: {
        name: 'Composite',
        className: 'AddAppCreatedResponseAzureSubscription',
        modelProperties: {
          subscriptionId: {
            required: true,
...
module.exports = AddAppCreatedResponseAzureSubscription;
