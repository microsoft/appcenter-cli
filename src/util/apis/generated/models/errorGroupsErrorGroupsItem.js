...
/**
 * Class representing a ErrorGroupsErrorGroupsItem.
 */
class ErrorGroupsErrorGroupsItem {
  /**
   * Create a ErrorGroupsErrorGroupsItem.
  ...
  /**
   * Defines the metadata of ErrorGroupsErrorGroupsItem
   *
   * @returns {object} metadata of ErrorGroupsErrorGroupsItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ErrorGroups_errorGroupsItem',
      type: {
        name: 'Composite',
        className: 'ErrorGroupsErrorGroupsItem',
        modelProperties: {
          state: {
            required: true,
          ...
          reasonFrames: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'ErrorGroupsErrorGroupsItemReasonFramesItemElementType',
                  type: {
                    name: 'Composite',
...
module.exports = ErrorGroupsErrorGroupsItem;
