 ...
 *
 */
class GetForOrgOKResponseUsage {
  /**
   * Create a GetForOrgOKResponseUsage.
  ...
  /**
   * Defines the metadata of GetForOrgOKResponseUsage
   *
   * @returns {object} metadata of GetForOrgOKResponseUsage
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetForOrgOKResponse_usage',
      type: {
        name: 'Composite',
...
module.exports = GetForOrgOKResponseUsage;
