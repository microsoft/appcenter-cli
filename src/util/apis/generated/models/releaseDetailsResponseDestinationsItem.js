...
/**
 * Class representing a ReleaseDetailsResponseDestinationsItem.
 */
class ReleaseDetailsResponseDestinationsItem {
  /**
   * Create a ReleaseDetailsResponseDestinationsItem.
  ...
  /**
   * Defines the metadata of ReleaseDetailsResponseDestinationsItem
   *
   * @returns {object} metadata of ReleaseDetailsResponseDestinationsItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ReleaseDetailsResponse_destinationsItem',
      type: {
        name: 'Composite',
...
module.exports = ReleaseDetailsResponseDestinationsItem;
