 ...
 *
 */
class AddAppCreatedResponseOwner {
  /**
   * Create a AddAppCreatedResponseOwner.
  ...
  /**
   * Defines the metadata of AddAppCreatedResponseOwner
   *
   * @returns {object} metadata of AddAppCreatedResponseOwner
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'AddAppCreatedResponse_owner',
      type: {
        name: 'Composite',
...
module.exports = AddAppCreatedResponseOwner;
