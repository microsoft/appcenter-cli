 ...
 *
 */
class ListTesterAppsOKResponseItemOwner {
  /**
   * Create a ListTesterAppsOKResponseItemOwner.
  ...
  /**
   * Defines the metadata of ListTesterAppsOKResponseItemOwner
   *
   * @returns {object} metadata of ListTesterAppsOKResponseItemOwner
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ListTesterAppsOKResponseItem_owner',
      type: {
        name: 'Composite',
...
module.exports = ListTesterAppsOKResponseItemOwner;
