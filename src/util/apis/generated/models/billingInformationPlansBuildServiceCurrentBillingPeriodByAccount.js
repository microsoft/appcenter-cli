 ...
 *
 */
class BillingInformationPlansBuildServiceCurrentBillingPeriodByAccount {
  /**
   * Create a BillingInformationPlansBuildServiceCurrentBillingPeriodByAccount.
  ...
  /**
   * Defines the metadata of BillingInformationPlansBuildServiceCurrentBillingPeriodByAccount
   *
   * @returns {object} metadata of BillingInformationPlansBuildServiceCurrentBillingPeriodByAccount
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'BillingInformationPlans_buildService_currentBillingPeriod_byAccount',
      type: {
        name: 'Composite',
        className: 'BillingInformationPlansBuildServiceCurrentBillingPeriodByAccount',
        modelProperties: {
          count: {
            required: false,
          ...
          plan: {
            ...
            type: {
              name: 'Composite',
              className: 'BillingInformationPlansBuildServiceCurrentBillingPeriodByAccountPlan'
            }
          }
        }
      }
...
module.exports = BillingInformationPlansBuildServiceCurrentBillingPeriodByAccount;
