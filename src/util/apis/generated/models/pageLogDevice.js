...
class PageLogDevice {
  ...
  /**
   * Defines the metadata of PageLogDevice
   *
   * @returns {object} metadata of PageLogDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'PageLog_device',
      type: {
        name: 'Composite',
        className: 'PageLogDevice',
        modelProperties: {
          sdkName: {
            required: true,
