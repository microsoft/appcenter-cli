 ...
 *
 */
class EventLogDiagnosticsDevice {
  /**
   * Create a EventLogDiagnosticsDevice.
  ...
  /**
   * Defines the metadata of EventLogDiagnosticsDevice
   *
   * @returns {object} metadata of EventLogDiagnosticsDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'EventLog_Diagnostics_device',
      type: {
        name: 'Composite',
        className: 'EventLogDiagnosticsDevice',
        modelProperties: {
          sdkName: {
            required: true,
...
module.exports = EventLogDiagnosticsDevice;
