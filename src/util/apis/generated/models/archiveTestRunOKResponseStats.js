 ...
 *
 */
class ArchiveTestRunOKResponseStats {
  /**
   * Create a ArchiveTestRunOKResponseStats.
  ...
  /**
   * Defines the metadata of ArchiveTestRunOKResponseStats
   *
   * @returns {object} metadata of ArchiveTestRunOKResponseStats
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ArchiveTestRunOKResponse_stats',
      type: {
        name: 'Composite',
...
module.exports = ArchiveTestRunOKResponseStats;
