 ...
 *
 */
class ParamsToolsetsXcode {
  /**
   * Create a ParamsToolsetsXcode.
  ...
  /**
   * Defines the metadata of ParamsToolsetsXcode
   *
   * @returns {object} metadata of ParamsToolsetsXcode
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'params_toolsets_xcode',
      type: {
        name: 'Composite',
        className: 'ParamsToolsetsXcode',
        modelProperties: {
          ...
          appExtensionProvisioningProfileFiles: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'ParamsToolsetsXcodeAppExtensionProvisioningProfileFilesItemElementType',
                  type: {
                    name: 'Composite',
...
module.exports = ParamsToolsetsXcode;
