...
export interface DistributionRequest {
  /**
   * DEPRECATED - A distribution group ID or a store group ID
  */
...
export interface BillingPlan {
  ...
  */
  ...
  /**
   * Name of the service that the plan applies to. Possible values include: 'Build', 'Push', 'Test'
  */
  service?: string;
...
export interface BillingInformationSearchResultsItem {
  ...
  */
  buildPlan?: string;
  /**
   * The ID of the Push Billing Plan
  */
  pushPlan?: string;
  /**
...
export interface UsageRecordStatus {
  ...
  */
  ...
  /**
   * Is the age of the most recent Push service usage record within expected limits
  */
  ...
  */
  ...
  /**
   * The time of the most recent Push service usage record
  */
