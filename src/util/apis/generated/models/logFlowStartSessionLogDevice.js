 ...
 *
 */
class LogFlowStartSessionLogDevice {
  /**
   * Create a LogFlowStartSessionLogDevice.
  ...
  /**
   * Defines the metadata of LogFlowStartSessionLogDevice
   *
   * @returns {object} metadata of LogFlowStartSessionLogDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'LogFlowStartSessionLog_device',
      type: {
        name: 'Composite',
        className: 'LogFlowStartSessionLogDevice',
        modelProperties: {
          sdkName: {
            required: true,
...
module.exports = LogFlowStartSessionLogDevice;
