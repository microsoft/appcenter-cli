...
/**
 * Class representing a DeploymentLatestRelease.
 */
class DeploymentLatestRelease {
  /**
   * Create a DeploymentLatestRelease.
  ...
  /**
   * Defines the metadata of DeploymentLatestRelease
   *
   * @returns {object} metadata of DeploymentLatestRelease
   *
   */
  mapper() {
    return {
        ...
        modelProperties: {
          ...
          diffPackageMap: {
            ...
            type: {
              ...
              value: {
                  required: false,
                  serializedName: 'DeploymentLatestReleaseDiffPackageMapValueElementType',
                  type: {
                    name: 'Composite',
...
module.exports = DeploymentLatestRelease;
