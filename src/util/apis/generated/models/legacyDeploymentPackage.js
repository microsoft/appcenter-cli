...
/**
 * Class representing a LegacyDeploymentPackage.
 */
class LegacyDeploymentPackage {
  /**
   * Create a LegacyDeploymentPackage.
  ...
  /**
   * Defines the metadata of LegacyDeploymentPackage
   *
   * @returns {object} metadata of LegacyDeploymentPackage
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'LegacyDeployment_package',
      type: {
        name: 'Composite',
...
module.exports = LegacyDeploymentPackage;
