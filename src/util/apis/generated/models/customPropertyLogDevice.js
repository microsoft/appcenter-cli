 ...
 *
 */
class CustomPropertyLogDevice {
  /**
   * Create a CustomPropertyLogDevice.
  ...
  /**
   * Defines the metadata of CustomPropertyLogDevice
   *
   * @returns {object} metadata of CustomPropertyLogDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'CustomPropertyLog_device',
      type: {
        name: 'Composite',
        className: 'CustomPropertyLogDevice',
        modelProperties: {
          sdkName: {
            required: true,
...
module.exports = CustomPropertyLogDevice;
