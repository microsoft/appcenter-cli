 ...
 *
 */
class ParamsToolsets {
  /**
   * Create a ParamsToolsets.
  ...
  /**
   * Defines the metadata of ParamsToolsets
   *
   * @returns {object} metadata of ParamsToolsets
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'params_toolsets',
      type: {
        name: 'Composite',
