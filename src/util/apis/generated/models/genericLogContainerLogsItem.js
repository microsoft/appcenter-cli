 ...
 *
 */
class GenericLogContainerLogsItem {
  /**
   * Create a GenericLogContainerLogsItem.
  ...
  /**
   * Defines the metadata of GenericLogContainerLogsItem
   *
   * @returns {object} metadata of GenericLogContainerLogsItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GenericLogContainer_logsItem',
      type: {
        name: 'Composite',
...
module.exports = GenericLogContainerLogsItem;
