 ...
 *
 */
class ServiceBillingPlansCurrentBillingPeriodByAccount {
  /**
   * Create a ServiceBillingPlansCurrentBillingPeriodByAccount.
  ...
  /**
   * Defines the metadata of ServiceBillingPlansCurrentBillingPeriodByAccount
   *
   * @returns {object} metadata of ServiceBillingPlansCurrentBillingPeriodByAccount
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ServiceBillingPlans_currentBillingPeriod_byAccount',
      type: {
        name: 'Composite',
...
module.exports = ServiceBillingPlansCurrentBillingPeriodByAccount;
