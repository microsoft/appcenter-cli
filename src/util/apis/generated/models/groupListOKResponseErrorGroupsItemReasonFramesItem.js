...
/**
 * Class representing a GroupListOKResponseErrorGroupsItemReasonFramesItem.
 */
class GroupListOKResponseErrorGroupsItemReasonFramesItem {
  /**
   * Create a GroupListOKResponseErrorGroupsItemReasonFramesItem.
  ...
  /**
   * Defines the metadata of GroupListOKResponseErrorGroupsItemReasonFramesItem
   *
   * @returns {object} metadata of GroupListOKResponseErrorGroupsItemReasonFramesItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GroupListOKResponse_errorGroupsItem_reasonFramesItem',
      type: {
        name: 'Composite',
...
module.exports = GroupListOKResponseErrorGroupsItemReasonFramesItem;
