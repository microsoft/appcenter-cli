...
/**
 * Class representing a XcodeSchemeContainerSharedSchemesItem.
 */
class XcodeSchemeContainerSharedSchemesItem {
  /**
   * Create a XcodeSchemeContainerSharedSchemesItem.
  ...
  /**
   * Defines the metadata of XcodeSchemeContainerSharedSchemesItem
   *
   * @returns {object} metadata of XcodeSchemeContainerSharedSchemesItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'XcodeSchemeContainer_sharedSchemesItem',
      type: {
        name: 'Composite',
...
module.exports = XcodeSchemeContainerSharedSchemesItem;
