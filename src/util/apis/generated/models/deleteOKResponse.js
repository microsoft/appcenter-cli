...
class DeleteOKResponse {
  ...
  /**
   * Defines the metadata of DeleteOKResponse
   *
   * @returns {object} metadata of DeleteOKResponse
   *
   */
  mapper() {
    return {
      ...
      type: {
        ...
        modelProperties: {
          ...
          user: {
            ...
            type: {
              name: 'Composite',
              className: 'DeleteOKResponseUser'
            }
          },
          status: {
            required: true,
          ...
          symbolsUploaded: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'DeleteOKResponseSymbolsUploadedItemElementType',
                  type: {
                    name: 'Composite',
...
module.exports = DeleteOKResponse;
