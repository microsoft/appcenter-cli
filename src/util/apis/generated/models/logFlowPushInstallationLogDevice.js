 ...
 *
 */
class LogFlowPushInstallationLogDevice {
  /**
   * Create a LogFlowPushInstallationLogDevice.
  ...
  /**
   * Defines the metadata of LogFlowPushInstallationLogDevice
   *
   * @returns {object} metadata of LogFlowPushInstallationLogDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'LogFlowPushInstallationLog_device',
      type: {
        name: 'Composite',
        className: 'LogFlowPushInstallationLogDevice',
        modelProperties: {
          sdkName: {
            required: true,
...
module.exports = LogFlowPushInstallationLogDevice;
