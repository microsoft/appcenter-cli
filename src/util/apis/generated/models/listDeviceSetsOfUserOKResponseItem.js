 ...
 *
 */
class ListDeviceSetsOfUserOKResponseItem {
  /**
   * Create a ListDeviceSetsOfUserOKResponseItem.
  ...
  /**
   * Defines the metadata of ListDeviceSetsOfUserOKResponseItem
   *
   * @returns {object} metadata of ListDeviceSetsOfUserOKResponseItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ListDeviceSetsOfUserOKResponseItem',
      type: {
        name: 'Composite',
        ...
        modelProperties: {
          ...
          deviceConfigurations: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'ListDeviceSetsOfUserOKResponseItemDeviceConfigurationsItemElementType',
                  type: {
                    name: 'Composite',
...
module.exports = ListDeviceSetsOfUserOKResponseItem;
