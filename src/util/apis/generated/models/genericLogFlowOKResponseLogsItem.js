 ...
 *
 */
class GenericLogFlowOKResponseLogsItem {
  /**
   * Create a GenericLogFlowOKResponseLogsItem.
  ...
  /**
   * Defines the metadata of GenericLogFlowOKResponseLogsItem
   *
   * @returns {object} metadata of GenericLogFlowOKResponseLogsItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GenericLogFlowOKResponse_logsItem',
      type: {
        name: 'Composite',
        ...
        modelProperties: {
          ...
          device: {
            ...
            type: {
              name: 'Composite',
              className: 'GenericLogFlowOKResponseLogsItemDevice'
            }
          },
          authProvider: {
            required: false,
...
module.exports = GenericLogFlowOKResponseLogsItem;
