 ...
 *
 */
class ParamsToolsetsAndroid {
  /**
   * Create a ParamsToolsetsAndroid.
  ...
  /**
   * Defines the metadata of ParamsToolsetsAndroid
   *
   * @returns {object} metadata of ParamsToolsetsAndroid
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'params_toolsets_android',
      type: {
        name: 'Composite',
...
module.exports = ParamsToolsetsAndroid;
