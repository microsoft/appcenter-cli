...
/**
 * Class representing a GetErrorDetailsOKResponseReasonFramesItem.
 */
class GetErrorDetailsOKResponseReasonFramesItem {
  /**
   * Create a GetErrorDetailsOKResponseReasonFramesItem.
  ...
  /**
   * Defines the metadata of GetErrorDetailsOKResponseReasonFramesItem
   *
   * @returns {object} metadata of GetErrorDetailsOKResponseReasonFramesItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetErrorDetailsOKResponse_reasonFramesItem',
      type: {
        name: 'Composite',
        className: 'GetErrorDetailsOKResponseReasonFramesItem',
        modelProperties: {
          className: {
            required: false,
...
module.exports = GetErrorDetailsOKResponseReasonFramesItem;
