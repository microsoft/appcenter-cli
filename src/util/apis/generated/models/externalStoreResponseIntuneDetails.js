 ...
 *
 */
class ExternalStoreResponseIntuneDetails {
  /**
   * Create a ExternalStoreResponseIntuneDetails.
  ...
  /**
   * Defines the metadata of ExternalStoreResponseIntuneDetails
   *
   * @returns {object} metadata of ExternalStoreResponseIntuneDetails
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ExternalStoreResponse_intune_details',
      type: {
        name: 'Composite',
...
module.exports = ExternalStoreResponseIntuneDetails;
