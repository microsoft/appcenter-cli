 ...
 *
 */
class GetLatestByDistributionGroupOKResponse {
  /**
   * Create a GetLatestByDistributionGroupOKResponse.
  ...
  /**
   * Defines the metadata of GetLatestByDistributionGroupOKResponse
   *
   * @returns {object} metadata of GetLatestByDistributionGroupOKResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetLatestByDistributionGroupOKResponse',
      type: {
        name: 'Composite',
        className: 'GetLatestByDistributionGroupOKResponse',
        modelProperties: {
          id: {
            required: true,
            serializedName: 'id',
          ...
          distributionGroups: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'GetLatestByDistributionGroupOKResponseDistributionGroupsItemElementType',
                  type: {
                    name: 'Composite',
          ...
          distributionStores: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'GetLatestByDistributionGroupOKResponseDistributionStoresItemElementType',
                  type: {
                    name: 'Composite',
                    className: 'GetLatestByDistributionGroupOKResponseDistributionStoresItem'
                  }
              }
            }
          },
          destinations: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'GetLatestByDistributionGroupOKResponseDestinationsItemElementType',
                  type: {
                    name: 'Composite',
          ...
          build: {
            ...
            type: {
              name: 'Composite',
              className: 'GetLatestByDistributionGroupOKResponseBuild'
            }
          },
          enabled: {
            required: true,
...
module.exports = GetLatestByDistributionGroupOKResponse;
