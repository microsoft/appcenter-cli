 ...
 *
 */
class LogFlowPageLogDevice {
  /**
   * Create a LogFlowPageLogDevice.
  ...
  /**
   * Defines the metadata of LogFlowPageLogDevice
   *
   * @returns {object} metadata of LogFlowPageLogDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'LogFlowPageLog_device',
      type: {
        name: 'Composite',
        className: 'LogFlowPageLogDevice',
        modelProperties: {
          sdkName: {
            required: true,
...
module.exports = LogFlowPageLogDevice;
