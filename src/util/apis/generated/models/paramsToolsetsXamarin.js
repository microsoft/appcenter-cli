 ...
 *
 */
class ParamsToolsetsXamarin {
  /**
   * Create a ParamsToolsetsXamarin.
  ...
  /**
   * Defines the metadata of ParamsToolsetsXamarin
   *
   * @returns {object} metadata of ParamsToolsetsXamarin
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'params_toolsets_xamarin',
      type: {
        name: 'Composite',
        className: 'ParamsToolsetsXamarin',
        modelProperties: {
          slnPath: {
            required: false,
...
module.exports = ParamsToolsetsXamarin;
