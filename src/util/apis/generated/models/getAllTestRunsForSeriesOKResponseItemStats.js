 ...
 *
 */
class GetAllTestRunsForSeriesOKResponseItemStats {
  /**
   * Create a GetAllTestRunsForSeriesOKResponseItemStats.
  ...
  /**
   * Defines the metadata of GetAllTestRunsForSeriesOKResponseItemStats
   *
   * @returns {object} metadata of GetAllTestRunsForSeriesOKResponseItemStats
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetAllTestRunsForSeriesOKResponseItem_stats',
      type: {
        name: 'Composite',
        className: 'GetAllTestRunsForSeriesOKResponseItemStats',
        modelProperties: {
          devices: {
            required: false,
...
module.exports = GetAllTestRunsForSeriesOKResponseItemStats;
