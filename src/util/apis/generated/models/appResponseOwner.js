 ...
 *
 */
class AppResponseOwner {
  /**
   * Create a AppResponseOwner.
  ...
  /**
   * Defines the metadata of AppResponseOwner
   *
   * @returns {object} metadata of AppResponseOwner
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'AppResponse_owner',
      type: {
        name: 'Composite',
...
module.exports = AppResponseOwner;
