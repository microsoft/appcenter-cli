 ...
 *
 */
class ToolsetsXamarinItem {
  /**
   * Create a ToolsetsXamarinItem.
  ...
  /**
   * Defines the metadata of ToolsetsXamarinItem
   *
   * @returns {object} metadata of ToolsetsXamarinItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'Toolsets_xamarinItem',
      type: {
        name: 'Composite',
...
module.exports = ToolsetsXamarinItem;
