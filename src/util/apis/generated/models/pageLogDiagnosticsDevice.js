 ...
 *
 */
class PageLogDiagnosticsDevice {
  /**
   * Create a PageLogDiagnosticsDevice.
  ...
  /**
   * Defines the metadata of PageLogDiagnosticsDevice
   *
   * @returns {object} metadata of PageLogDiagnosticsDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'PageLog_Diagnostics_device',
      type: {
        name: 'Composite',
        className: 'PageLogDiagnosticsDevice',
        modelProperties: {
          sdkName: {
            required: true,
...
module.exports = PageLogDiagnosticsDevice;
