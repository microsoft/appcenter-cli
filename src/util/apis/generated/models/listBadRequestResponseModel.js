...
/**
 * Class representing a ListBadRequestResponseModel.
 */
class ListBadRequestResponseModel {
  ...
  /**
   * Defines the metadata of ListBadRequestResponseModel
   *
   * @returns {object} metadata of ListBadRequestResponseModel
   *
   */
  mapper() {
    return {
...
module.exports = ListBadRequestResponseModel;
