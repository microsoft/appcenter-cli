...
/**
 * Class representing a UpdateOKResponseModelModelModelModelModelModel.
 */
class UpdateOKResponseModelModelModelModelModelModel {
  /**
   * Create a UpdateOKResponseModelModelModelModelModelModel.
  ...
  /**
   * Defines the metadata of UpdateOKResponseModelModelModelModelModelModel
   *
   * @returns {object} metadata of UpdateOKResponseModelModelModelModelModelModel
   *
   */
  mapper() {
    return {
      ...
      type: {
        name: 'Composite',
        className: 'UpdateOKResponseModelModelModelModelModelModel',
        modelProperties: {
          crashGroupId: {
            required: true,
          ...
          reasonFrame: {
            ...
            type: {
              name: 'Composite',
              className: 'UpdateOKResponseReasonFrame'
            }
          },
          fatal: {
            required: true,
...
module.exports = UpdateOKResponseModelModelModelModelModelModel;
