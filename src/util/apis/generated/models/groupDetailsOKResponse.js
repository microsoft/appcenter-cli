...
/**
 * Class representing a GroupDetailsOKResponse.
 */
class GroupDetailsOKResponse {
  /**
   * Create a GroupDetailsOKResponse.
  ...
  /**
   * Defines the metadata of GroupDetailsOKResponse
   *
   * @returns {object} metadata of GroupDetailsOKResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GroupDetailsOKResponse',
      type: {
        name: 'Composite',
        className: 'GroupDetailsOKResponse',
        modelProperties: {
          state: {
            required: true,
          ...
          reasonFrames: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'GroupDetailsOKResponseReasonFramesItemElementType',
                  type: {
                    name: 'Composite',
...
module.exports = GroupDetailsOKResponse;
