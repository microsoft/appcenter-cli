 ...
 *
 */
class ListOKResponseItemOwner {
  /**
   * Create a ListOKResponseItemOwner.
  ...
  /**
   * Defines the metadata of ListOKResponseItemOwner
   *
   * @returns {object} metadata of ListOKResponseItemOwner
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ListOKResponseItem_owner',
      type: {
        name: 'Composite',
...
module.exports = ListOKResponseItemOwner;
