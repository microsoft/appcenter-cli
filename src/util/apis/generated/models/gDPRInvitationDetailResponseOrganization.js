...
/**
 * Class representing a GDPRInvitationDetailResponseOrganization.
 */
class GDPRInvitationDetailResponseOrganization {
  /**
   * Create a GDPRInvitationDetailResponseOrganization.
  ...
  /**
   * Defines the metadata of GDPRInvitationDetailResponseOrganization
   *
   * @returns {object} metadata of GDPRInvitationDetailResponseOrganization
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GDPRInvitationDetailResponse_organization',
      type: {
        name: 'Composite',
...
module.exports = GDPRInvitationDetailResponseOrganization;
