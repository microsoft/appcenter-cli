 ...
 *
 */
class GenericLogContainerDiagnosticsLogsItemDevice {
  /**
   * Create a GenericLogContainerDiagnosticsLogsItemDevice.
  ...
  /**
   * Defines the metadata of GenericLogContainerDiagnosticsLogsItemDevice
   *
   * @returns {object} metadata of GenericLogContainerDiagnosticsLogsItemDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GenericLogContainer_Diagnostics_logsItem_device',
      type: {
        name: 'Composite',
...
module.exports = GenericLogContainerDiagnosticsLogsItemDevice;
