...
/**
 * Class representing a GetOKResponseModelModelModelModelModelModelModelModelModelModel.
 */
class GetOKResponseModelModelModelModelModelModelModelModelModelModel {
  /**
   * Create a GetOKResponseModelModelModelModelModelModelModelModelModelModel.
  ...
  /**
   * Defines the metadata of GetOKResponseModelModelModelModelModelModelModelModelModelModel
   *
   * @returns {object} metadata of GetOKResponseModelModelModelModelModelModelModelModelModelModel
   *
   */
  mapper() {
    return {
      ...
      type: {
        name: 'Composite',
        className: 'GetOKResponseModelModelModelModelModelModelModelModelModelModel',
        modelProperties: {
          crashGroupId: {
            required: true,
          ...
          reasonFrame: {
            ...
            type: {
              name: 'Composite',
              className: 'GetOKResponseReasonFrame'
            }
          },
          fatal: {
            required: true,
...
module.exports = GetOKResponseModelModelModelModelModelModelModelModelModelModel;
