 ...
 *
 */
class ListOKResponseCrashGroupsItemReasonFrame {
  /**
   * Create a ListOKResponseCrashGroupsItemReasonFrame.
  ...
  /**
   * Defines the metadata of ListOKResponseCrashGroupsItemReasonFrame
   *
   * @returns {object} metadata of ListOKResponseCrashGroupsItemReasonFrame
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ListOKResponse_crash_groupsItem_reason_frame',
      type: {
        name: 'Composite',
...
module.exports = ListOKResponseCrashGroupsItemReasonFrame;
