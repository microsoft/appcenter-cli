 ...
 *
 */
class BillingPeriodByAccount {
  /**
   * Create a BillingPeriodByAccount.
  ...
  /**
   * Defines the metadata of BillingPeriodByAccount
   *
   * @returns {object} metadata of BillingPeriodByAccount
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'BillingPeriod_byAccount',
      type: {
        name: 'Composite',
...
module.exports = BillingPeriodByAccount;
