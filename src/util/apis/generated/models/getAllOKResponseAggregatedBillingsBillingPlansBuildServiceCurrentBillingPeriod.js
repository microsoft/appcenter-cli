 ...
 *
 */
class GetAllOKResponseAggregatedBillingsBillingPlansBuildServiceCurrentBillingPeriod {
  /**
   * Create a GetAllOKResponseAggregatedBillingsBillingPlansBuildServiceCurrentBillingPeriod.
  ...
  /**
   * Defines the metadata of GetAllOKResponseAggregatedBillingsBillingPlansBuildServiceCurrentBillingPeriod
   *
   * @returns {object} metadata of GetAllOKResponseAggregatedBillingsBillingPlansBuildServiceCurrentBillingPeriod
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetAllOKResponse_aggregatedBillings_billingPlans_buildService_currentBillingPeriod',
      type: {
        name: 'Composite',
        className: 'GetAllOKResponseAggregatedBillingsBillingPlansBuildServiceCurrentBillingPeriod',
        modelProperties: {
          startTime: {
            required: false,
...
module.exports = GetAllOKResponseAggregatedBillingsBillingPlansBuildServiceCurrentBillingPeriod;
