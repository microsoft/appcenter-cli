 ...
 *
 */
class ListOKResponseItemBuild {
  /**
   * Create a ListOKResponseItemBuild.
  ...
  /**
   * Defines the metadata of ListOKResponseItemBuild
   *
   * @returns {object} metadata of ListOKResponseItemBuild
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ListOKResponseItem_build',
      type: {
        name: 'Composite',
...
module.exports = ListOKResponseItemBuild;
