 ...
 *
 */
class TesterAppResponseOwner {
  /**
   * Create a TesterAppResponseOwner.
  ...
  /**
   * Defines the metadata of TesterAppResponseOwner
   *
   * @returns {object} metadata of TesterAppResponseOwner
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'TesterAppResponse_owner',
      type: {
        name: 'Composite',
...
module.exports = TesterAppResponseOwner;
