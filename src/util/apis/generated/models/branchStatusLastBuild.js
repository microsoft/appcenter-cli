...
/**
 * Class representing a BranchStatusLastBuild.
 */
class BranchStatusLastBuild {
  /**
   * Create a BranchStatusLastBuild.
  ...
  /**
   * Defines the metadata of BranchStatusLastBuild
   *
   * @returns {object} metadata of BranchStatusLastBuild
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'BranchStatus_lastBuild',
      type: {
        name: 'Composite',
...
module.exports = BranchStatusLastBuild;
