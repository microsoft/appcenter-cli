...
/**
 * Class representing a PatchForOrgOKResponse.
 */
class PatchForOrgOKResponse {
  /**
   * Create a PatchForOrgOKResponse.
  ...
  /**
   * Defines the metadata of PatchForOrgOKResponse
   *
   * @returns {object} metadata of PatchForOrgOKResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'PatchForOrgOKResponse',
      type: {
        name: 'Composite',
        className: 'PatchForOrgOKResponse',
        modelProperties: {
          id: {
            required: true,
            serializedName: 'id',
...
module.exports = PatchForOrgOKResponse;
