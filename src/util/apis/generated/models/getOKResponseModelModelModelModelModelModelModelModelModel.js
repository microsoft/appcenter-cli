...
/**
 * Class representing a GetOKResponseModelModelModelModelModelModelModelModelModel.
 */
class GetOKResponseModelModelModelModelModelModelModelModelModel {
  /**
   * Create a GetOKResponseModelModelModelModelModelModelModelModelModel.
   * @property {string} [key]
  ...
  /**
   * Defines the metadata of GetOKResponseModelModelModelModelModelModelModelModelModel
   *
   * @returns {object} metadata of GetOKResponseModelModelModelModelModelModelModelModelModel
   *
   */
  mapper() {
    return {
      ...
      type: {
        name: 'Composite',
        className: 'GetOKResponseModelModelModelModelModelModelModelModelModel',
        modelProperties: {
          key: {
            required: false,
            serializedName: 'key',
...
module.exports = GetOKResponseModelModelModelModelModelModelModelModelModel;
