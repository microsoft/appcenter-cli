 ...
 *
 */
class ServiceResourceUsageCurrentUsagePeriod {
  /**
   * Create a ServiceResourceUsageCurrentUsagePeriod.
  ...
  /**
   * Defines the metadata of ServiceResourceUsageCurrentUsagePeriod
   *
   * @returns {object} metadata of ServiceResourceUsageCurrentUsagePeriod
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ServiceResourceUsage_currentUsagePeriod',
      type: {
        name: 'Composite',
...
module.exports = ServiceResourceUsageCurrentUsagePeriod;
