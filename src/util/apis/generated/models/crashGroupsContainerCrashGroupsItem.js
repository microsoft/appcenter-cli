...
/**
 * Class representing a CrashGroupsContainerCrashGroupsItem.
 */
class CrashGroupsContainerCrashGroupsItem {
  /**
   * Create a CrashGroupsContainerCrashGroupsItem.
  ...
  /**
   * Defines the metadata of CrashGroupsContainerCrashGroupsItem
   *
   * @returns {object} metadata of CrashGroupsContainerCrashGroupsItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'CrashGroupsContainer_crash_groupsItem',
      type: {
        name: 'Composite',
...
module.exports = CrashGroupsContainerCrashGroupsItem;
