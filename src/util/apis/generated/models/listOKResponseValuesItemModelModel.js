 ...
 *
 */
class ListOKResponseValuesItemModelModel {
  /**
   * Create a ListOKResponseValuesItemModelModel.
  ...
  /**
   * Defines the metadata of ListOKResponseValuesItemModelModel
   *
   * @returns {object} metadata of ListOKResponseValuesItemModelModel
   *
   */
  mapper() {
    return {
...
module.exports = ListOKResponseValuesItemModelModel;
