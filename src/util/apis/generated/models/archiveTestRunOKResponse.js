 ...
 *
 */
class ArchiveTestRunOKResponse {
  /**
   * Create a ArchiveTestRunOKResponse.
  ...
  /**
   * Defines the metadata of ArchiveTestRunOKResponse
   *
   * @returns {object} metadata of ArchiveTestRunOKResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ArchiveTestRunOKResponse',
      type: {
        name: 'Composite',
        className: 'ArchiveTestRunOKResponse',
        modelProperties: {
          id: {
            required: false,
            serializedName: 'id',
          ...
          stats: {
            ...
            type: {
              name: 'Composite',
              className: 'ArchiveTestRunOKResponseStats'
            }
          },
          testType: {
            required: false,
...
module.exports = ArchiveTestRunOKResponse;
