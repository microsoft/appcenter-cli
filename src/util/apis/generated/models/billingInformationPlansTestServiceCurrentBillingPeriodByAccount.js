 ...
 *
 */
class BillingInformationPlansTestServiceCurrentBillingPeriodByAccount {
  /**
   * Create a BillingInformationPlansTestServiceCurrentBillingPeriodByAccount.
  ...
  /**
   * Defines the metadata of BillingInformationPlansTestServiceCurrentBillingPeriodByAccount
   *
   * @returns {object} metadata of BillingInformationPlansTestServiceCurrentBillingPeriodByAccount
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'BillingInformationPlans_testService_currentBillingPeriod_byAccount',
      type: {
        name: 'Composite',
        className: 'BillingInformationPlansTestServiceCurrentBillingPeriodByAccount',
        modelProperties: {
          count: {
            required: false,
          ...
          plan: {
            ...
            type: {
              name: 'Composite',
              className: 'BillingInformationPlansTestServiceCurrentBillingPeriodByAccountPlan'
            }
          }
        }
      }
...
module.exports = BillingInformationPlansTestServiceCurrentBillingPeriodByAccount;
