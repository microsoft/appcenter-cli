...
/**
 * Class representing a TransferOwnershipOKResponse.
 */
class TransferOwnershipOKResponse {
  /**
   * Create a TransferOwnershipOKResponse.
  ...
  /**
   * Defines the metadata of TransferOwnershipOKResponse
   *
   * @returns {object} metadata of TransferOwnershipOKResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'TransferOwnershipOKResponse',
      type: {
        name: 'Composite',
        className: 'TransferOwnershipOKResponse',
        modelProperties: {
          id: {
            required: true,
            serializedName: 'id',
          ...
          owner: {
            ...
            type: {
              name: 'Composite',
              className: 'TransferOwnershipOKResponseOwner'
            }
          },
          appSecret: {
            required: true,
...
module.exports = TransferOwnershipOKResponse;
