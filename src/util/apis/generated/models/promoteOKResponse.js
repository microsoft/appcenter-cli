...
/**
 * Class representing a PromoteOKResponse.
 */
class PromoteOKResponse {
  /**
   * Create a PromoteOKResponse.
  ...
  /**
   * Defines the metadata of PromoteOKResponse
   *
   * @returns {object} metadata of PromoteOKResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'PromoteOKResponse',
      type: {
        name: 'Composite',
        className: 'PromoteOKResponse',
        modelProperties: {
          targetBinaryRange: {
            required: false,
          ...
          diffPackageMap: {
            ...
            type: {
              ...
              value: {
                  required: false,
                  serializedName: 'PromoteOKResponseDiffPackageMapValueElementType',
                  type: {
                    name: 'Composite',
...
module.exports = PromoteOKResponse;
