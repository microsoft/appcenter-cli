 ...
 *
 */
class UpdateOKResponseToolsetsXamarin {
  /**
   * Create a UpdateOKResponseToolsetsXamarin.
  ...
  /**
   * Defines the metadata of UpdateOKResponseToolsetsXamarin
   *
   * @returns {object} metadata of UpdateOKResponseToolsetsXamarin
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'UpdateOKResponse_toolsets_xamarin',
      type: {
        name: 'Composite',
...
module.exports = UpdateOKResponseToolsetsXamarin;
