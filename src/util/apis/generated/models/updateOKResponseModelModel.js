...
/**
 * Class representing a UpdateOKResponseModelModel.
 */
class UpdateOKResponseModelModel {
  /**
   * Create a UpdateOKResponseModelModel.
  ...
  /**
   * Defines the metadata of UpdateOKResponseModelModel
   *
   * @returns {object} metadata of UpdateOKResponseModelModel
   *
   */
  mapper() {
    return {
      ...
      type: {
        name: 'Composite',
        className: 'UpdateOKResponseModelModel',
        modelProperties: {
          id: {
            required: true,
            serializedName: 'id',
...
module.exports = UpdateOKResponseModelModel;
