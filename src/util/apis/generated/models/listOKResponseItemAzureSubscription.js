...
/**
 * Class representing a ListOKResponseItemAzureSubscription.
 */
class ListOKResponseItemAzureSubscription {
  /**
   * Create a ListOKResponseItemAzureSubscription.
  ...
  /**
   * Defines the metadata of ListOKResponseItemAzureSubscription
   *
   * @returns {object} metadata of ListOKResponseItemAzureSubscription
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ListOKResponseItem_azure_subscription',
      type: {
        name: 'Composite',
...
module.exports = ListOKResponseItemAzureSubscription;
