...
/**
 * Class representing a AddAppCreatedResponse.
 */
class AddAppCreatedResponse {
  /**
   * Create a AddAppCreatedResponse.
  ...
  /**
   * Defines the metadata of AddAppCreatedResponse
   *
   * @returns {object} metadata of AddAppCreatedResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'AddAppCreatedResponse',
      type: {
        name: 'Composite',
        className: 'AddAppCreatedResponse',
        modelProperties: {
          id: {
            required: true,
            serializedName: 'id',
          ...
          owner: {
            ...
            type: {
              name: 'Composite',
              className: 'AddAppCreatedResponseOwner'
            }
          },
          appSecret: {
            required: true,
...
module.exports = AddAppCreatedResponse;
