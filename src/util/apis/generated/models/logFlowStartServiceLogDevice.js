 ...
 *
 */
class LogFlowStartServiceLogDevice {
  /**
   * Create a LogFlowStartServiceLogDevice.
  ...
  /**
   * Defines the metadata of LogFlowStartServiceLogDevice
   *
   * @returns {object} metadata of LogFlowStartServiceLogDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'LogFlowStartServiceLog_device',
      type: {
        name: 'Composite',
        className: 'LogFlowStartServiceLogDevice',
        modelProperties: {
          sdkName: {
            required: true,
...
module.exports = LogFlowStartServiceLogDevice;
