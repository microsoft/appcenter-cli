...
/**
 * Class representing a LogFlowOKResponse.
 */
class LogFlowOKResponse {
  /**
   * Create a LogFlowOKResponse.
  ...
  /**
   * Defines the metadata of LogFlowOKResponse
   *
   * @returns {object} metadata of LogFlowOKResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'LogFlowOKResponse',
      type: {
        name: 'Composite',
        className: 'LogFlowOKResponse',
        modelProperties: {
          exceededMaxLimit: {
            required: false,
          ...
          logs: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'LogFlowOKResponseLogsItemElementType',
                  type: {
                    name: 'Composite',
...
module.exports = LogFlowOKResponse;
