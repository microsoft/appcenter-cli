...
/**
 * Class representing a LegacyCodePushReleaseResponsePackage.
 */
class LegacyCodePushReleaseResponsePackage {
  /**
   * Create a LegacyCodePushReleaseResponsePackage.
  ...
  /**
   * Defines the metadata of LegacyCodePushReleaseResponsePackage
   *
   * @returns {object} metadata of LegacyCodePushReleaseResponsePackage
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'LegacyCodePushReleaseResponse_package',
      type: {
        name: 'Composite',
...
module.exports = LegacyCodePushReleaseResponsePackage;
