 ...
 *
 */
class LogFlowGenericLogContainerLogsItem {
  /**
   * Create a LogFlowGenericLogContainerLogsItem.
  ...
  /**
   * Defines the metadata of LogFlowGenericLogContainerLogsItem
   *
   * @returns {object} metadata of LogFlowGenericLogContainerLogsItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'LogFlowGenericLogContainer_logsItem',
      type: {
        name: 'Composite',
...
module.exports = LogFlowGenericLogContainerLogsItem;
