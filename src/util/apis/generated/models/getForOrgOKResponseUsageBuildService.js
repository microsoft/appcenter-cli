 ...
 *
 */
class GetForOrgOKResponseUsageBuildService {
  /**
   * Create a GetForOrgOKResponseUsageBuildService.
  ...
  /**
   * Defines the metadata of GetForOrgOKResponseUsageBuildService
   *
   * @returns {object} metadata of GetForOrgOKResponseUsageBuildService
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetForOrgOKResponse_usage_buildService',
      type: {
        name: 'Composite',
        className: 'GetForOrgOKResponseUsageBuildService',
        modelProperties: {
          currentUsagePeriod: {
            required: false,
...
module.exports = GetForOrgOKResponseUsageBuildService;
