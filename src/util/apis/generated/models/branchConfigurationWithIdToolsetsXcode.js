 ...
 *
 */
class BranchConfigurationWithIdToolsetsXcode {
  /**
   * Create a BranchConfigurationWithIdToolsetsXcode.
  ...
  /**
   * Defines the metadata of BranchConfigurationWithIdToolsetsXcode
   *
   * @returns {object} metadata of BranchConfigurationWithIdToolsetsXcode
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'BranchConfigurationWithId_toolsets_xcode',
      type: {
        name: 'Composite',
        className: 'BranchConfigurationWithIdToolsetsXcode',
        modelProperties: {
          ...
          appExtensionProvisioningProfileFiles: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'BranchConfigurationWithIdToolsetsXcodeAppExtensionProvisioningProfileFilesItemElementType',
                  type: {
                    name: 'Composite',
...
module.exports = BranchConfigurationWithIdToolsetsXcode;
