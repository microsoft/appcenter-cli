...
/**
 * Class representing a ListByShaListOKResponseItem.
 */
class ListByShaListOKResponseItem {
  /**
   * Create a ListByShaListOKResponseItem.
  ...
  /**
   * Defines the metadata of ListByShaListOKResponseItem
   *
   * @returns {object} metadata of ListByShaListOKResponseItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ListByShaListOKResponseItem',
      type: {
        name: 'Composite',
...
module.exports = ListByShaListOKResponseItem;
