...
/**
 * Class representing a DistributionGroupDetailsResponseUsersItem.
 */
class DistributionGroupDetailsResponseUsersItem {
  /**
   * Create a DistributionGroupDetailsResponseUsersItem.
  ...
  /**
   * Defines the metadata of DistributionGroupDetailsResponseUsersItem
   *
   * @returns {object} metadata of DistributionGroupDetailsResponseUsersItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'DistributionGroupDetailsResponse_usersItem',
      type: {
        name: 'Composite',
...
module.exports = DistributionGroupDetailsResponseUsersItem;
