...
/**
 * Class representing a ReleaseCountsCountsItem.
 */
class ReleaseCountsCountsItem {
  /**
   * Create a ReleaseCountsCountsItem.
  ...
  /**
   * Defines the metadata of ReleaseCountsCountsItem
   *
   * @returns {object} metadata of ReleaseCountsCountsItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ReleaseCounts_countsItem',
      type: {
        name: 'Composite',
...
module.exports = ReleaseCountsCountsItem;
