 ...
 *
 */
class VersionedBillingPlanDocument {
  /**
   * Create a VersionedBillingPlanDocument.
  ...
  /**
   * Defines the metadata of VersionedBillingPlanDocument
   *
   * @returns {object} metadata of VersionedBillingPlanDocument
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'VersionedBillingPlan_document',
      type: {
        name: 'Composite',
...
module.exports = VersionedBillingPlanDocument;
