 ...
 *
 */
class SymbolUploadsItem {
  /**
   * Create a SymbolUploadsItem.
  ...
  /**
   * Defines the metadata of SymbolUploadsItem
   *
   * @returns {object} metadata of SymbolUploadsItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'SymbolUploadsItem',
      type: {
        name: 'Composite',
        ...
        modelProperties: {
          ...
          symbolsUploaded: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'SymbolUploadsItemSymbolsUploadedItemElementType',
                  type: {
                    name: 'Composite',
...
module.exports = SymbolUploadsItem;
