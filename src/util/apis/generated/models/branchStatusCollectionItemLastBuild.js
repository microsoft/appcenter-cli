...
/**
 * Class representing a BranchStatusCollectionItemLastBuild.
 */
class BranchStatusCollectionItemLastBuild {
  /**
   * Create a BranchStatusCollectionItemLastBuild.
  ...
  /**
   * Defines the metadata of BranchStatusCollectionItemLastBuild
   *
   * @returns {object} metadata of BranchStatusCollectionItemLastBuild
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'BranchStatusCollectionItem_lastBuild',
      type: {
        name: 'Composite',
...
module.exports = BranchStatusCollectionItemLastBuild;
