...
/**
 * Class representing a ToolsetProjectsAndroidAndroidModulesItem.
 */
class ToolsetProjectsAndroidAndroidModulesItem {
  /**
   * Create a ToolsetProjectsAndroidAndroidModulesItem.
  ...
  /**
   * Defines the metadata of ToolsetProjectsAndroidAndroidModulesItem
   *
   * @returns {object} metadata of ToolsetProjectsAndroidAndroidModulesItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ToolsetProjects_android_androidModulesItem',
      type: {
        name: 'Composite',
        ...
        modelProperties: {
          ...
          buildConfigurations: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'ToolsetProjectsAndroidAndroidModulesItemBuildConfigurationsItemElementType',
                  type: {
                    name: 'Composite',
...
module.exports = ToolsetProjectsAndroidAndroidModulesItem;
