...
/**
 * Class representing a UpdateOKResponse.
 */
class UpdateOKResponse {
  /**
   * Create a UpdateOKResponse.
  ...
  /**
   * Defines the metadata of UpdateOKResponse
   *
   * @returns {object} metadata of UpdateOKResponse
   *
   */
  mapper() {
    return {
...
module.exports = UpdateOKResponse;
