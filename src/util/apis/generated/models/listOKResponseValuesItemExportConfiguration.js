 ...
 *
 */
class ListOKResponseValuesItemExportConfiguration {
  /**
   * Create a ListOKResponseValuesItemExportConfiguration.
  ...
  /**
   * Defines the metadata of ListOKResponseValuesItemExportConfiguration
   *
   * @returns {object} metadata of ListOKResponseValuesItemExportConfiguration
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ListOKResponse_valuesItem_export_configuration',
      type: {
        name: 'Composite',
        ...
        uberParent: 'ListOKResponseValuesItemExportConfiguration',
        className: 'ListOKResponseValuesItemExportConfiguration',
        modelProperties: {
          exportEntities: {
            required: false,
...
module.exports = ListOKResponseValuesItemExportConfiguration;
