 ...
 *
 */
class CreateCreatedResponseOwner {
  /**
   * Create a CreateCreatedResponseOwner.
  ...
  /**
   * Defines the metadata of CreateCreatedResponseOwner
   *
   * @returns {object} metadata of CreateCreatedResponseOwner
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'CreateCreatedResponse_owner',
      type: {
        name: 'Composite',
...
module.exports = CreateCreatedResponseOwner;
