...
/**
 * Class representing a GetOKResponse.
 */
class GetOKResponse {
  /**
   * Create a GetOKResponse.
  ...
  /**
   * Defines the metadata of GetOKResponse
   *
   * @returns {object} metadata of GetOKResponse
   *
   */
  mapper() {
    return {
