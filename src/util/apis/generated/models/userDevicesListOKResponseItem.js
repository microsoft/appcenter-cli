 ...
 *
 */
class UserDevicesListOKResponseItem {
  /**
   * Create a UserDevicesListOKResponseItem.
  ...
  /**
   * Defines the metadata of UserDevicesListOKResponseItem
   *
   * @returns {object} metadata of UserDevicesListOKResponseItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'UserDevicesListOKResponseItem',
      type: {
        name: 'Composite',
...
module.exports = UserDevicesListOKResponseItem;
