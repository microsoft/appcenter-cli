...
/**
 * Class representing a DeleteAvatarOKResponseModel.
 */
class DeleteAvatarOKResponseModel {
  /**
   * Create a DeleteAvatarOKResponseModel.
  ...
  /**
   * Defines the metadata of DeleteAvatarOKResponseModel
   *
   * @returns {object} metadata of DeleteAvatarOKResponseModel
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'DeleteAvatarOKResponse',
      type: {
        name: 'Composite',
        className: 'DeleteAvatarOKResponseModel',
        modelProperties: {
          id: {
            required: true,
            serializedName: 'id',
          ...
          owner: {
            ...
            type: {
              name: 'Composite',
              className: 'DeleteAvatarOKResponseOwner'
            }
          },
          appSecret: {
            required: true,
...
module.exports = DeleteAvatarOKResponseModel;
