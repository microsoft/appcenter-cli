 ...
 *
 */
class BranchConfigurationToolsetsAndroidModel {
  /**
   * Create a BranchConfigurationToolsetsAndroidModel.
  ...
  /**
   * Defines the metadata of BranchConfigurationToolsetsAndroidModel
   *
   * @returns {object} metadata of BranchConfigurationToolsetsAndroidModel
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'BranchConfigurationToolsets_android',
      type: {
        name: 'Composite',
...
module.exports = BranchConfigurationToolsetsAndroidModel;
