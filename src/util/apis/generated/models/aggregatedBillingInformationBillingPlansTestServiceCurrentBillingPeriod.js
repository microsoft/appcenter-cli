 ...
 *
 */
class AggregatedBillingInformationBillingPlansTestServiceCurrentBillingPeriod {
  /**
   * Create a AggregatedBillingInformationBillingPlansTestServiceCurrentBillingPeriod.
  ...
  /**
   * Defines the metadata of AggregatedBillingInformationBillingPlansTestServiceCurrentBillingPeriod
   *
   * @returns {object} metadata of AggregatedBillingInformationBillingPlansTestServiceCurrentBillingPeriod
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'AggregatedBillingInformation_billingPlans_testService_currentBillingPeriod',
      type: {
        name: 'Composite',
        className: 'AggregatedBillingInformationBillingPlansTestServiceCurrentBillingPeriod',
        modelProperties: {
          startTime: {
            required: false,
...
module.exports = AggregatedBillingInformationBillingPlansTestServiceCurrentBillingPeriod;
