...
/**
 * Class representing a GetAppCrashesInfoOKResponseFeatures.
 */
class GetAppCrashesInfoOKResponseFeatures {
  /**
   * Create a GetAppCrashesInfoOKResponseFeatures.
  ...
  /**
   * Defines the metadata of GetAppCrashesInfoOKResponseFeatures
   *
   * @returns {object} metadata of GetAppCrashesInfoOKResponseFeatures
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetAppCrashesInfoOKResponse_features',
      type: {
        name: 'Composite',
        className: 'GetAppCrashesInfoOKResponseFeatures',
        modelProperties: {
...
module.exports = GetAppCrashesInfoOKResponseFeatures;
