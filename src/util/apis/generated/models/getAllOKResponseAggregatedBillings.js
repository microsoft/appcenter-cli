 ...
 *
 */
class GetAllOKResponseAggregatedBillings {
  /**
   * Create a GetAllOKResponseAggregatedBillings.
  ...
  /**
   * Defines the metadata of GetAllOKResponseAggregatedBillings
   *
   * @returns {object} metadata of GetAllOKResponseAggregatedBillings
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetAllOKResponse_aggregatedBillings',
      type: {
        name: 'Composite',
...
module.exports = GetAllOKResponseAggregatedBillings;
