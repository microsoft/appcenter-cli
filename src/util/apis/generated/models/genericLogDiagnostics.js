...
class GenericLogDiagnostics {
  /**
   * Create a GenericLogDiagnostics.
  ...
  /**
   * Defines the metadata of GenericLogDiagnostics
   *
   * @returns {object} metadata of GenericLogDiagnostics
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GenericLog_Diagnostics',
      type: {
        name: 'Composite',
...
module.exports = GenericLogDiagnostics;
