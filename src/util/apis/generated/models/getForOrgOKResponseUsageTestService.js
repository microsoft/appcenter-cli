 ...
 *
 */
class GetForOrgOKResponseUsageTestService {
  /**
   * Create a GetForOrgOKResponseUsageTestService.
  ...
  /**
   * Defines the metadata of GetForOrgOKResponseUsageTestService
   *
   * @returns {object} metadata of GetForOrgOKResponseUsageTestService
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetForOrgOKResponse_usage_testService',
      type: {
        name: 'Composite',
        className: 'GetForOrgOKResponseUsageTestService',
        modelProperties: {
          currentUsagePeriod: {
            required: false,
...
module.exports = GetForOrgOKResponseUsageTestService;
