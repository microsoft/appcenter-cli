 ...
 *
 */
class GetOKResponseReasonFrame {
  /**
   * Create a GetOKResponseReasonFrame.
  ...
  /**
   * Defines the metadata of GetOKResponseReasonFrame
   *
   * @returns {object} metadata of GetOKResponseReasonFrame
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetOKResponse_reason_frame',
      type: {
        name: 'Composite',
...
module.exports = GetOKResponseReasonFrame;
