 ...
 *
 */
class LogFlowLogContainerLogsItemDevice {
  /**
   * Create a LogFlowLogContainerLogsItemDevice.
  ...
  /**
   * Defines the metadata of LogFlowLogContainerLogsItemDevice
   *
   * @returns {object} metadata of LogFlowLogContainerLogsItemDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'LogFlowLogContainer_logsItem_device',
      type: {
        name: 'Composite',
...
module.exports = LogFlowLogContainerLogsItemDevice;
