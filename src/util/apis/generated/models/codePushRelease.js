 ...
 * 
 */
function CodePushRelease() {
  CodePushRelease['super_'].call(this);
}

util.inherits(CodePushRelease, models['CodePushReleaseInfo']);
 ...
 *
 */
CodePushRelease.prototype.mapper = function () {
  return {
    required: false,
