...
/**
 * Class representing a GetLatestByHashOKResponseDestinationsItem.
 */
class GetLatestByHashOKResponseDestinationsItem {
  /**
   * Create a GetLatestByHashOKResponseDestinationsItem.
  ...
  /**
   * Defines the metadata of GetLatestByHashOKResponseDestinationsItem
   *
   * @returns {object} metadata of GetLatestByHashOKResponseDestinationsItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetLatestByHashOKResponse_destinationsItem',
      type: {
        name: 'Composite',
...
module.exports = GetLatestByHashOKResponseDestinationsItem;
