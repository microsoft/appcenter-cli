 ...
 *
 */
class StopTestRunOKResponseStats {
  /**
   * Create a StopTestRunOKResponseStats.
  ...
  /**
   * Defines the metadata of StopTestRunOKResponseStats
   *
   * @returns {object} metadata of StopTestRunOKResponseStats
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'StopTestRunOKResponse_stats',
      type: {
        name: 'Composite',
        className: 'StopTestRunOKResponseStats',
        modelProperties: {
          devices: {
            required: false,
...
module.exports = StopTestRunOKResponseStats;
