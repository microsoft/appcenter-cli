...
class ListOKResponseItemModelModelModelModelModel {
  ...
  /**
   * Defines the metadata of ListOKResponseItemModelModelModelModelModel
   *
   * @returns {object} metadata of ListOKResponseItemModelModelModelModelModel
   *
   */
  mapper() {
    return {
...
module.exports = ListOKResponseItemModelModelModelModelModel;
