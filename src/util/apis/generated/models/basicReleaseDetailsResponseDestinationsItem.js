...
/**
 * Class representing a BasicReleaseDetailsResponseDestinationsItem.
 */
class BasicReleaseDetailsResponseDestinationsItem {
  /**
   * Create a BasicReleaseDetailsResponseDestinationsItem.
  ...
  /**
   * Defines the metadata of BasicReleaseDetailsResponseDestinationsItem
   *
   * @returns {object} metadata of BasicReleaseDetailsResponseDestinationsItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'BasicReleaseDetailsResponse_destinationsItem',
      type: {
        name: 'Composite',
...
module.exports = BasicReleaseDetailsResponseDestinationsItem;
