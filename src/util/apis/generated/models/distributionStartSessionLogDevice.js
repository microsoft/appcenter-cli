 ...
 *
 */
class DistributionStartSessionLogDevice {
  /**
   * Create a DistributionStartSessionLogDevice.
  ...
  /**
   * Defines the metadata of DistributionStartSessionLogDevice
   *
   * @returns {object} metadata of DistributionStartSessionLogDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'DistributionStartSessionLog_device',
      type: {
        name: 'Composite',
...
module.exports = DistributionStartSessionLogDevice;
