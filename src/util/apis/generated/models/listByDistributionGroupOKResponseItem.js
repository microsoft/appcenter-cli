 ...
 *
 */
class ListByDistributionGroupOKResponseItem {
  /**
   * Create a ListByDistributionGroupOKResponseItem.
  ...
  /**
   * Defines the metadata of ListByDistributionGroupOKResponseItem
   *
   * @returns {object} metadata of ListByDistributionGroupOKResponseItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ListByDistributionGroupOKResponseItem',
      type: {
        name: 'Composite',
...
module.exports = ListByDistributionGroupOKResponseItem;
