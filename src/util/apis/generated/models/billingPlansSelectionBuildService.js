 ...
 *
 */
class BillingPlansSelectionBuildService {
  /**
   * Create a BillingPlansSelectionBuildService.
  ...
  /**
   * Defines the metadata of BillingPlansSelectionBuildService
   *
   * @returns {object} metadata of BillingPlansSelectionBuildService
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'BillingPlansSelection_buildService',
      type: {
        name: 'Composite',
...
module.exports = BillingPlansSelectionBuildService;
