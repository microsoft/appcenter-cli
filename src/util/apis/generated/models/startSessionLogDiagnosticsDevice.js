 ...
 *
 */
class StartSessionLogDiagnosticsDevice {
  /**
   * Create a StartSessionLogDiagnosticsDevice.
  ...
  /**
   * Defines the metadata of StartSessionLogDiagnosticsDevice
   *
   * @returns {object} metadata of StartSessionLogDiagnosticsDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'StartSessionLog_Diagnostics_device',
      type: {
        name: 'Composite',
        className: 'StartSessionLogDiagnosticsDevice',
        modelProperties: {
          sdkName: {
            required: true,
...
module.exports = StartSessionLogDiagnosticsDevice;
