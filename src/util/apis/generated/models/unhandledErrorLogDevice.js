 ...
 *
 */
class UnhandledErrorLogDevice {
  /**
   * Create a UnhandledErrorLogDevice.
  ...
  /**
   * Defines the metadata of UnhandledErrorLogDevice
   *
   * @returns {object} metadata of UnhandledErrorLogDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'UnhandledErrorLog_device',
      type: {
        name: 'Composite',
        className: 'UnhandledErrorLogDevice',
        modelProperties: {
          sdkName: {
            required: true,
...
module.exports = UnhandledErrorLogDevice;
