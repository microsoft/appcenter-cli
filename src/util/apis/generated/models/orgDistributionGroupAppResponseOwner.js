 ...
 *
 */
class OrgDistributionGroupAppResponseOwner {
  /**
   * Create a OrgDistributionGroupAppResponseOwner.
  ...
  /**
   * Defines the metadata of OrgDistributionGroupAppResponseOwner
   *
   * @returns {object} metadata of OrgDistributionGroupAppResponseOwner
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'OrgDistributionGroupAppResponse_owner',
      type: {
        name: 'Composite',
        className: 'OrgDistributionGroupAppResponseOwner',
        modelProperties: {
          id: {
            required: true,
            serializedName: 'id',
...
module.exports = OrgDistributionGroupAppResponseOwner;
