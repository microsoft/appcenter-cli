 ...
 *
 */
class MigrateReleaseRequestReleasesItem {
  /**
   * Create a MigrateReleaseRequestReleasesItem.
   * @property {number} [id]
  ...
  /**
   * Defines the metadata of MigrateReleaseRequestReleasesItem
   *
   * @returns {object} metadata of MigrateReleaseRequestReleasesItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'MigrateReleaseRequest_releasesItem',
      type: {
        name: 'Composite',
        ...
        modelProperties: {
          ...
          provisioningProfiles: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'MigrateReleaseRequestReleasesItemProvisioningProfilesItemElementType',
                  type: {
                    name: 'Composite',
...
module.exports = MigrateReleaseRequestReleasesItem;
