 ...
 *
 */
class GenericLogContainerLogsItemDevice {
  /**
   * Create a GenericLogContainerLogsItemDevice.
  ...
  /**
   * Defines the metadata of GenericLogContainerLogsItemDevice
   *
   * @returns {object} metadata of GenericLogContainerLogsItemDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GenericLogContainer_logsItem_device',
      type: {
        name: 'Composite',
...
module.exports = GenericLogContainerLogsItemDevice;
