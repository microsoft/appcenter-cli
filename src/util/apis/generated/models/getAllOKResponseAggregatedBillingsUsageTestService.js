 ...
 *
 */
class GetAllOKResponseAggregatedBillingsUsageTestService {
  /**
   * Create a GetAllOKResponseAggregatedBillingsUsageTestService.
  ...
  /**
   * Defines the metadata of GetAllOKResponseAggregatedBillingsUsageTestService
   *
   * @returns {object} metadata of GetAllOKResponseAggregatedBillingsUsageTestService
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetAllOKResponse_aggregatedBillings_usage_testService',
      type: {
        name: 'Composite',
...
module.exports = GetAllOKResponseAggregatedBillingsUsageTestService;
