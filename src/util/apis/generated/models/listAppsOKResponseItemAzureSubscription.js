...
/**
 * Class representing a ListAppsOKResponseItemAzureSubscription.
 */
class ListAppsOKResponseItemAzureSubscription {
  /**
   * Create a ListAppsOKResponseItemAzureSubscription.
  ...
  /**
   * Defines the metadata of ListAppsOKResponseItemAzureSubscription
   *
   * @returns {object} metadata of ListAppsOKResponseItemAzureSubscription
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ListAppsOKResponseItem_azure_subscription',
      type: {
        name: 'Composite',
        className: 'ListAppsOKResponseItemAzureSubscription',
        modelProperties: {
          subscriptionId: {
            required: true,
...
module.exports = ListAppsOKResponseItemAzureSubscription;
