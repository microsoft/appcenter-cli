...
/**
 * Class representing a CreateForOrgCreatedResponseModel.
 */
class CreateForOrgCreatedResponseModel {
  /**
   * Create a CreateForOrgCreatedResponseModel.
  ...
  /**
   * Defines the metadata of CreateForOrgCreatedResponseModel
   *
   * @returns {object} metadata of CreateForOrgCreatedResponseModel
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'CreateForOrgCreatedResponse',
      type: {
        name: 'Composite',
        className: 'CreateForOrgCreatedResponseModel',
        modelProperties: {
          id: {
            required: true,
            serializedName: 'id',
          ...
          owner: {
            ...
            type: {
              name: 'Composite',
              className: 'CreateForOrgCreatedResponseOwner'
            }
          },
          appSecret: {
            required: true,
...
module.exports = CreateForOrgCreatedResponseModel;
