 ...
 *
 */
class GetByAppOKResponseBillingPlansBuildService {
  /**
   * Create a GetByAppOKResponseBillingPlansBuildService.
  ...
  /**
   * Defines the metadata of GetByAppOKResponseBillingPlansBuildService
   *
   * @returns {object} metadata of GetByAppOKResponseBillingPlansBuildService
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetByAppOKResponse_billingPlans_buildService',
      type: {
        name: 'Composite',
        className: 'GetByAppOKResponseBillingPlansBuildService',
        modelProperties: {
          canSelectTrialPlan: {
            required: false,
...
module.exports = GetByAppOKResponseBillingPlansBuildService;
