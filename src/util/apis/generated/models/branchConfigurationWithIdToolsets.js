 ...
 *
 */
class BranchConfigurationWithIdToolsets {
  /**
   * Create a BranchConfigurationWithIdToolsets.
  ...
  /**
   * Defines the metadata of BranchConfigurationWithIdToolsets
   *
   * @returns {object} metadata of BranchConfigurationWithIdToolsets
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'BranchConfigurationWithId_toolsets',
      type: {
        name: 'Composite',
        className: 'BranchConfigurationWithIdToolsets',
        modelProperties: {
          xcode: {
            required: false,
          ...
          javascript: {
            ...
            type: {
              name: 'Composite',
              className: 'BranchConfigurationWithIdToolsetsJavascript'
            }
          },
          xamarin: {
            required: false,
            ...
            type: {
              name: 'Composite',
              className: 'BranchConfigurationWithIdToolsetsXamarin'
            }
          },
          android: {
            required: false,
            ...
            type: {
              name: 'Composite',
              className: 'BranchConfigurationWithIdToolsetsAndroid'
            }
          }
        }
      }
...
module.exports = BranchConfigurationWithIdToolsets;
