...
/**
 * Class representing a DeviceConfigurationModel.
 */
class DeviceConfigurationModel {
  /**
   * Create a DeviceConfigurationModel.
  ...
  /**
   * Defines the metadata of DeviceConfigurationModel
   *
   * @returns {object} metadata of DeviceConfigurationModel
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'DeviceConfiguration_model',
      type: {
        name: 'Composite',
...
module.exports = DeviceConfigurationModel;
