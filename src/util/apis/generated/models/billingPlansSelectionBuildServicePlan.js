 ...
 *
 */
class BillingPlansSelectionBuildServicePlan {
  /**
   * Create a BillingPlansSelectionBuildServicePlan.
  ...
  /**
   * Defines the metadata of BillingPlansSelectionBuildServicePlan
   *
   * @returns {object} metadata of BillingPlansSelectionBuildServicePlan
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'BillingPlansSelection_buildService_plan',
      type: {
        name: 'Composite',
...
module.exports = BillingPlansSelectionBuildServicePlan;
