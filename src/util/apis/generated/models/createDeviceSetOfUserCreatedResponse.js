 ...
 *
 */
class CreateDeviceSetOfUserCreatedResponse {
  /**
   * Create a CreateDeviceSetOfUserCreatedResponse.
  ...
  /**
   * Defines the metadata of CreateDeviceSetOfUserCreatedResponse
   *
   * @returns {object} metadata of CreateDeviceSetOfUserCreatedResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'CreateDeviceSetOfUserCreatedResponse',
      type: {
        name: 'Composite',
        className: 'CreateDeviceSetOfUserCreatedResponse',
        modelProperties: {
          id: {
            required: true,
            serializedName: 'id',
          ...
          deviceConfigurations: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'CreateDeviceSetOfUserCreatedResponseDeviceConfigurationsItemElementType',
                  type: {
                    name: 'Composite',
...
module.exports = CreateDeviceSetOfUserCreatedResponse;
