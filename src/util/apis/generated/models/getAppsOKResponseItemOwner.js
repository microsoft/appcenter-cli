 ...
 *
 */
class GetAppsOKResponseItemOwner {
  /**
   * Create a GetAppsOKResponseItemOwner.
  ...
  /**
   * Defines the metadata of GetAppsOKResponseItemOwner
   *
   * @returns {object} metadata of GetAppsOKResponseItemOwner
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetAppsOKResponseItem_owner',
      type: {
        name: 'Composite',
...
module.exports = GetAppsOKResponseItemOwner;
