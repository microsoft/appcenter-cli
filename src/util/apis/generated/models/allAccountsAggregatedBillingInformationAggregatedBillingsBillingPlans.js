 ...
 *
 */
class AllAccountsAggregatedBillingInformationAggregatedBillingsBillingPlans {
  /**
   * Create a AllAccountsAggregatedBillingInformationAggregatedBillingsBillingPlans.
  ...
  /**
   * Defines the metadata of AllAccountsAggregatedBillingInformationAggregatedBillingsBillingPlans
   *
   * @returns {object} metadata of AllAccountsAggregatedBillingInformationAggregatedBillingsBillingPlans
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'AllAccountsAggregatedBillingInformation_aggregatedBillings_billingPlans',
      type: {
        name: 'Composite',
...
module.exports = AllAccountsAggregatedBillingInformationAggregatedBillingsBillingPlans;
