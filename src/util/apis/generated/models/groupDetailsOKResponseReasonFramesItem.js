...
/**
 * Class representing a GroupDetailsOKResponseReasonFramesItem.
 */
class GroupDetailsOKResponseReasonFramesItem {
  /**
   * Create a GroupDetailsOKResponseReasonFramesItem.
  ...
  /**
   * Defines the metadata of GroupDetailsOKResponseReasonFramesItem
   *
   * @returns {object} metadata of GroupDetailsOKResponseReasonFramesItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GroupDetailsOKResponse_reasonFramesItem',
      type: {
        name: 'Composite',
        className: 'GroupDetailsOKResponseReasonFramesItem',
        modelProperties: {
          className: {
            required: false,
...
module.exports = GroupDetailsOKResponseReasonFramesItem;
