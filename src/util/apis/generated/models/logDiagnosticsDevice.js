 ...
 *
 */
class LogDiagnosticsDevice {
  /**
   * Create a LogDiagnosticsDevice.
  ...
  /**
   * Defines the metadata of LogDiagnosticsDevice
   *
   * @returns {object} metadata of LogDiagnosticsDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'Log_Diagnostics_device',
      type: {
        name: 'Composite',
...
module.exports = LogDiagnosticsDevice;
