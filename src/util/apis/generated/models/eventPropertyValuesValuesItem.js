 ...
 *
 */
class EventPropertyValuesValuesItem {
  /**
   * Create a EventPropertyValuesValuesItem.
  ...
  /**
   * Defines the metadata of EventPropertyValuesValuesItem
   *
   * @returns {object} metadata of EventPropertyValuesValuesItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'EventPropertyValues_valuesItem',
      type: {
        name: 'Composite',
...
module.exports = EventPropertyValuesValuesItem;
