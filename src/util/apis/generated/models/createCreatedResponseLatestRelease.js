...
/**
 * Class representing a CreateCreatedResponseLatestRelease.
 */
class CreateCreatedResponseLatestRelease {
  /**
   * Create a CreateCreatedResponseLatestRelease.
  ...
  /**
   * Defines the metadata of CreateCreatedResponseLatestRelease
   *
   * @returns {object} metadata of CreateCreatedResponseLatestRelease
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'CreateCreatedResponse_latest_release',
      type: {
        name: 'Composite',
        ...
        modelProperties: {
          ...
          diffPackageMap: {
            ...
            type: {
              ...
              value: {
                  required: false,
                  serializedName: 'CreateCreatedResponseLatestReleaseDiffPackageMapValueElementType',
                  type: {
                    name: 'Composite',
...
module.exports = CreateCreatedResponseLatestRelease;
