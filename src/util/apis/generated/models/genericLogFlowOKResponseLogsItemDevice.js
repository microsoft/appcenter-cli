 ...
 *
 */
class GenericLogFlowOKResponseLogsItemDevice {
  /**
   * Create a GenericLogFlowOKResponseLogsItemDevice.
  ...
  /**
   * Defines the metadata of GenericLogFlowOKResponseLogsItemDevice
   *
   * @returns {object} metadata of GenericLogFlowOKResponseLogsItemDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GenericLogFlowOKResponse_logsItem_device',
      type: {
        name: 'Composite',
...
module.exports = GenericLogFlowOKResponseLogsItemDevice;
