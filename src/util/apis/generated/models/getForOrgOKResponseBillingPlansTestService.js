 ...
 *
 */
class GetForOrgOKResponseBillingPlansTestService {
  /**
   * Create a GetForOrgOKResponseBillingPlansTestService.
  ...
  /**
   * Defines the metadata of GetForOrgOKResponseBillingPlansTestService
   *
   * @returns {object} metadata of GetForOrgOKResponseBillingPlansTestService
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetForOrgOKResponse_billingPlans_testService',
      type: {
        name: 'Composite',
        className: 'GetForOrgOKResponseBillingPlansTestService',
        modelProperties: {
          canSelectTrialPlan: {
            required: false,
...
module.exports = GetForOrgOKResponseBillingPlansTestService;
