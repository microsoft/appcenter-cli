...
/**
 * Class representing a SentOKResponseItemAppAzureSubscription.
 */
class SentOKResponseItemAppAzureSubscription {
  /**
   * Create a SentOKResponseItemAppAzureSubscription.
  ...
  /**
   * Defines the metadata of SentOKResponseItemAppAzureSubscription
   *
   * @returns {object} metadata of SentOKResponseItemAppAzureSubscription
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'SentOKResponseItem_app_azure_subscription',
      type: {
        name: 'Composite',
        className: 'SentOKResponseItemAppAzureSubscription',
        modelProperties: {
          subscriptionId: {
            required: true,
...
module.exports = SentOKResponseItemAppAzureSubscription;
