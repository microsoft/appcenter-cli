 ...
 *
 */
class ExportConfigurationResultExportConfiguration {
  /**
   * Create a ExportConfigurationResultExportConfiguration.
  ...
  /**
   * Defines the metadata of ExportConfigurationResultExportConfiguration
   *
   * @returns {object} metadata of ExportConfigurationResultExportConfiguration
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ExportConfigurationResult_export_configuration',
      type: {
        name: 'Composite',
...
module.exports = ExportConfigurationResultExportConfiguration;
