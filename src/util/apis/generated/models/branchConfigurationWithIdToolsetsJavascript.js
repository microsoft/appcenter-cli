 ...
 *
 */
class BranchConfigurationWithIdToolsetsJavascript {
  /**
   * Create a BranchConfigurationWithIdToolsetsJavascript.
  ...
  /**
   * Defines the metadata of BranchConfigurationWithIdToolsetsJavascript
   *
   * @returns {object} metadata of BranchConfigurationWithIdToolsetsJavascript
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'BranchConfigurationWithId_toolsets_javascript',
      type: {
        name: 'Composite',
...
module.exports = BranchConfigurationWithIdToolsetsJavascript;
