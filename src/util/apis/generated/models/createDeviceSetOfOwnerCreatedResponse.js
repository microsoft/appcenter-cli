 ...
 *
 */
class CreateDeviceSetOfOwnerCreatedResponse {
  /**
   * Create a CreateDeviceSetOfOwnerCreatedResponse.
  ...
  /**
   * Defines the metadata of CreateDeviceSetOfOwnerCreatedResponse
   *
   * @returns {object} metadata of CreateDeviceSetOfOwnerCreatedResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'CreateDeviceSetOfOwnerCreatedResponse',
      type: {
        name: 'Composite',
        className: 'CreateDeviceSetOfOwnerCreatedResponse',
        modelProperties: {
          id: {
            required: true,
            serializedName: 'id',
          ...
          deviceConfigurations: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'CreateDeviceSetOfOwnerCreatedResponseDeviceConfigurationsItemElementType',
                  type: {
                    name: 'Composite',
...
module.exports = CreateDeviceSetOfOwnerCreatedResponse;
