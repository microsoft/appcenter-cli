 ...
 *
 */
class GetByAppOKResponseUsageTestService {
  /**
   * Create a GetByAppOKResponseUsageTestService.
  ...
  /**
   * Defines the metadata of GetByAppOKResponseUsageTestService
   *
   * @returns {object} metadata of GetByAppOKResponseUsageTestService
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetByAppOKResponse_usage_testService',
      type: {
        name: 'Composite',
        className: 'GetByAppOKResponseUsageTestService',
        modelProperties: {
          currentUsagePeriod: {
            required: false,
...
module.exports = GetByAppOKResponseUsageTestService;
