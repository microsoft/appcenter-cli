 ...
 *
 */
class AggregatedBillingInformationBillingPlansBuildService {
  /**
   * Create a AggregatedBillingInformationBillingPlansBuildService.
  ...
  /**
   * Defines the metadata of AggregatedBillingInformationBillingPlansBuildService
   *
   * @returns {object} metadata of AggregatedBillingInformationBillingPlansBuildService
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'AggregatedBillingInformation_billingPlans_buildService',
      type: {
        name: 'Composite',
...
module.exports = AggregatedBillingInformationBillingPlansBuildService;
