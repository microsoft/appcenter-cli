 ...
 *
 */
class GetLatestByHashOKResponseBuild {
  /**
   * Create a GetLatestByHashOKResponseBuild.
  ...
  /**
   * Defines the metadata of GetLatestByHashOKResponseBuild
   *
   * @returns {object} metadata of GetLatestByHashOKResponseBuild
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetLatestByHashOKResponse_build',
      type: {
        name: 'Composite',
...
module.exports = GetLatestByHashOKResponseBuild;
