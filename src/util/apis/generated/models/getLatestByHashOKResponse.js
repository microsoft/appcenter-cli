 ...
 *
 */
class GetLatestByHashOKResponse {
  /**
   * Create a GetLatestByHashOKResponse.
  ...
  /**
   * Defines the metadata of GetLatestByHashOKResponse
   *
   * @returns {object} metadata of GetLatestByHashOKResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetLatestByHashOKResponse',
      type: {
        name: 'Composite',
        className: 'GetLatestByHashOKResponse',
        modelProperties: {
          id: {
            required: true,
            serializedName: 'id',
          ...
          distributionGroups: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'GetLatestByHashOKResponseDistributionGroupsItemElementType',
                  type: {
                    name: 'Composite',
          ...
          distributionStores: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'GetLatestByHashOKResponseDistributionStoresItemElementType',
                  type: {
                    name: 'Composite',
                    className: 'GetLatestByHashOKResponseDistributionStoresItem'
                  }
              }
            }
          },
          destinations: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'GetLatestByHashOKResponseDestinationsItemElementType',
                  type: {
                    name: 'Composite',
                    className: 'GetLatestByHashOKResponseDestinationsItem'
                  }
              }
            }
          },
          ...
          build: {
            ...
            type: {
              name: 'Composite',
              className: 'GetLatestByHashOKResponseBuild'
            }
          },
          enabled: {
            required: true,
...
module.exports = GetLatestByHashOKResponse;
