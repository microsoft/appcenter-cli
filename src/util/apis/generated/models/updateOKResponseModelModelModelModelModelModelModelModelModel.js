...
/**
 * Class representing a UpdateOKResponseModelModelModelModelModelModelModelModelModel.
 */
class UpdateOKResponseModelModelModelModelModelModelModelModelModel {
  /**
   * Create a UpdateOKResponseModelModelModelModelModelModelModelModelModel.
  ...
  /**
   * Defines the metadata of UpdateOKResponseModelModelModelModelModelModelModelModelModel
   *
   * @returns {object} metadata of UpdateOKResponseModelModelModelModelModelModelModelModelModel
   *
   */
  mapper() {
    return {
      ...
      type: {
        name: 'Composite',
        className: 'UpdateOKResponseModelModelModelModelModelModelModelModelModel',
        modelProperties: {
          id: {
            required: true,
            serializedName: 'id',
          ...
          owner: {
            ...
            type: {
              name: 'Composite',
              className: 'UpdateOKResponseOwner'
            }
          },
          appSecret: {
            required: true,
          ...
          azureSubscription: {
            ...
            type: {
              name: 'Composite',
              className: 'UpdateOKResponseAzureSubscription'
            }
          },
          platform: {
            required: true,
...
module.exports = UpdateOKResponseModelModelModelModelModelModelModelModelModel;
