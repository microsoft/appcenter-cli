 ...
 *
 */
class GetLatestPrivateReleaseOKResponseBuild {
  /**
   * Create a GetLatestPrivateReleaseOKResponseBuild.
  ...
  /**
   * Defines the metadata of GetLatestPrivateReleaseOKResponseBuild
   *
   * @returns {object} metadata of GetLatestPrivateReleaseOKResponseBuild
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetLatestPrivateReleaseOKResponse_build',
      type: {
        name: 'Composite',
...
module.exports = GetLatestPrivateReleaseOKResponseBuild;
