...
/**
 * Class representing a CreateForOrgOKResponse.
 */
class CreateForOrgOKResponse {
  /**
   * Create a CreateForOrgOKResponse.
  ...
  /**
   * Defines the metadata of CreateForOrgOKResponse
   *
   * @returns {object} metadata of CreateForOrgOKResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'CreateForOrgOKResponse',
      type: {
        name: 'Composite',
        className: 'CreateForOrgOKResponse',
        modelProperties: {
          id: {
            required: true,
            serializedName: 'id',
          ...
          owner: {
            ...
            type: {
              name: 'Composite',
              className: 'CreateForOrgOKResponseOwner'
            }
          },
          appSecret: {
            required: true,
...
module.exports = CreateForOrgOKResponse;
