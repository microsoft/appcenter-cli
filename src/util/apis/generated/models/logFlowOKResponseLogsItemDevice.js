 ...
 *
 */
class LogFlowOKResponseLogsItemDevice {
  /**
   * Create a LogFlowOKResponseLogsItemDevice.
  ...
  /**
   * Defines the metadata of LogFlowOKResponseLogsItemDevice
   *
   * @returns {object} metadata of LogFlowOKResponseLogsItemDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'LogFlowOKResponse_logsItem_device',
      type: {
        name: 'Composite',
...
module.exports = LogFlowOKResponseLogsItemDevice;
