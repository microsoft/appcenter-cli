...
/**
 * Class representing a DeleteAvatarOKResponseAzureSubscription.
 */
class DeleteAvatarOKResponseAzureSubscription {
  /**
   * Create a DeleteAvatarOKResponseAzureSubscription.
  ...
  /**
   * Defines the metadata of DeleteAvatarOKResponseAzureSubscription
   *
   * @returns {object} metadata of DeleteAvatarOKResponseAzureSubscription
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'DeleteAvatarOKResponse_azure_subscription',
      type: {
        name: 'Composite',
        className: 'DeleteAvatarOKResponseAzureSubscription',
        modelProperties: {
          subscriptionId: {
            required: true,
...
module.exports = DeleteAvatarOKResponseAzureSubscription;
