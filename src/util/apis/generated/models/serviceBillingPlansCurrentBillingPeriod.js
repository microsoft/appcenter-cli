 ...
 *
 */
class ServiceBillingPlansCurrentBillingPeriod {
  /**
   * Create a ServiceBillingPlansCurrentBillingPeriod.
  ...
  /**
   * Defines the metadata of ServiceBillingPlansCurrentBillingPeriod
   *
   * @returns {object} metadata of ServiceBillingPlansCurrentBillingPeriod
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ServiceBillingPlans_currentBillingPeriod',
      type: {
        name: 'Composite',
...
module.exports = ServiceBillingPlansCurrentBillingPeriod;
