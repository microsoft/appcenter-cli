...
/**
 * Class representing a LegacyCodePushRelease.
 */
class LegacyCodePushRelease {
  /**
   * Create a LegacyCodePushRelease.
  ...
  /**
   * Defines the metadata of LegacyCodePushRelease
   *
   * @returns {object} metadata of LegacyCodePushRelease
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'LegacyCodePushRelease',
      type: {
        name: 'Composite',
...
module.exports = LegacyCodePushRelease;
