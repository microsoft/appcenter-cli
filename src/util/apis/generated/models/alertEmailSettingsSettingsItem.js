 ...
 *
 */
class AlertEmailSettingsSettingsItem {
  /**
   * Create a AlertEmailSettingsSettingsItem.
  ...
  /**
   * Defines the metadata of AlertEmailSettingsSettingsItem
   *
   * @returns {object} metadata of AlertEmailSettingsSettingsItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'AlertEmailSettings_settingsItem',
      type: {
        name: 'Composite',
...
module.exports = AlertEmailSettingsSettingsItem;
