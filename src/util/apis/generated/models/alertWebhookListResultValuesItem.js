 ...
 *
 */
class AlertWebhookListResultValuesItem {
  /**
   * Create a AlertWebhookListResultValuesItem.
  ...
  /**
   * Defines the metadata of AlertWebhookListResultValuesItem
   *
   * @returns {object} metadata of AlertWebhookListResultValuesItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'AlertWebhookListResult_valuesItem',
      type: {
        name: 'Composite',
...
module.exports = AlertWebhookListResultValuesItem;
