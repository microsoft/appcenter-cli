...
/**
 * Class representing a AppModelModel.
 */
class AppModelModel {
  /**
   * Create a AppModelModel.
  ...
  /**
   * Defines the metadata of AppModelModel
   *
   * @returns {object} metadata of AppModelModel
   *
   */
  mapper() {
    return {
