 ...
 *
 */
class StopTestRunOKResponse {
  /**
   * Create a StopTestRunOKResponse.
  ...
  /**
   * Defines the metadata of StopTestRunOKResponse
   *
   * @returns {object} metadata of StopTestRunOKResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'StopTestRunOKResponse',
      type: {
        name: 'Composite',
        className: 'StopTestRunOKResponse',
        modelProperties: {
          id: {
            required: false,
            serializedName: 'id',
...
module.exports = StopTestRunOKResponse;
