 ...
 *
 */
class ListLatestOKResponseItem {
  /**
   * Create a ListLatestOKResponseItem.
  ...
  /**
   * Defines the metadata of ListLatestOKResponseItem
   *
  ...
  mapper() {
    return {
      required: false,
      serializedName: 'ListLatestOKResponseItem',
      type: {
        name: 'Composite',
        ...
        modelProperties: {
          ...
          distributionGroups: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'ListLatestOKResponseItemDistributionGroupsItemElementType',
                  type: {
                    name: 'Composite',
                    className: 'ListLatestOKResponseItemDistributionGroupsItem'
                  }
              }
            }
          },
          distributionStores: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'ListLatestOKResponseItemDistributionStoresItemElementType',
                  type: {
                    name: 'Composite',
                    className: 'ListLatestOKResponseItemDistributionStoresItem'
                  }
              }
            }
          },
          destinations: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'ListLatestOKResponseItemDestinationsItemElementType',
                  type: {
                    name: 'Composite',
                    className: 'ListLatestOKResponseItemDestinationsItem'
                  }
              }
            }
          },
...
module.exports = ListLatestOKResponseItem;
