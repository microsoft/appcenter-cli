...
/**
 * Class representing a ListLatestOKResponseItemDistributionStoresItem.
 */
class ListLatestOKResponseItemDistributionStoresItem {
  /**
   * Create a ListLatestOKResponseItemDistributionStoresItem.
  ...
  /**
   * Defines the metadata of ListLatestOKResponseItemDistributionStoresItem
   *
   * @returns {object} metadata of ListLatestOKResponseItemDistributionStoresItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ListLatestOKResponseItem_distribution_storesItem',
      type: {
        name: 'Composite',
...
module.exports = ListLatestOKResponseItemDistributionStoresItem;
