 ...
 *
 */
class AggregatedBillingInformationBillingPlansTestService {
  /**
   * Create a AggregatedBillingInformationBillingPlansTestService.
  ...
  /**
   * Defines the metadata of AggregatedBillingInformationBillingPlansTestService
   *
   * @returns {object} metadata of AggregatedBillingInformationBillingPlansTestService
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'AggregatedBillingInformation_billingPlans_testService',
      type: {
        name: 'Composite',
...
module.exports = AggregatedBillingInformationBillingPlansTestService;
