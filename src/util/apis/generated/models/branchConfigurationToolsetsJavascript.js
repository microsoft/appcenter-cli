 ...
 *
 */
class BranchConfigurationToolsetsJavascript {
  /**
   * Create a BranchConfigurationToolsetsJavascript.
  ...
  /**
   * Defines the metadata of BranchConfigurationToolsetsJavascript
   *
   * @returns {object} metadata of BranchConfigurationToolsetsJavascript
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'BranchConfiguration_toolsets_javascript',
      type: {
        name: 'Composite',
...
module.exports = BranchConfigurationToolsetsJavascript;
