 ...
 *
 */
class BranchConfigurationToolsetsXamarinModel {
  /**
   * Create a BranchConfigurationToolsetsXamarinModel.
  ...
  /**
   * Defines the metadata of BranchConfigurationToolsetsXamarinModel
   *
   * @returns {object} metadata of BranchConfigurationToolsetsXamarinModel
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'BranchConfigurationToolsets_xamarin',
      type: {
        name: 'Composite',
...
module.exports = BranchConfigurationToolsetsXamarinModel;
