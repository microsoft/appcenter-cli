 ...
 *
 */
class BillingInformationPlansBuildService {
  /**
   * Create a BillingInformationPlansBuildService.
  ...
  /**
   * Defines the metadata of BillingInformationPlansBuildService
   *
   * @returns {object} metadata of BillingInformationPlansBuildService
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'BillingInformationPlans_buildService',
      type: {
        name: 'Composite',
...
module.exports = BillingInformationPlansBuildService;
