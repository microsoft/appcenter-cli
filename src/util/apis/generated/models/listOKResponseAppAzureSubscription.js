...
/**
 * Class representing a ListOKResponseAppAzureSubscription.
 */
class ListOKResponseAppAzureSubscription {
  /**
   * Create a ListOKResponseAppAzureSubscription.
  ...
  /**
   * Defines the metadata of ListOKResponseAppAzureSubscription
   *
   * @returns {object} metadata of ListOKResponseAppAzureSubscription
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ListOKResponse_app_azure_subscription',
      type: {
        name: 'Composite',
        className: 'ListOKResponseAppAzureSubscription',
        modelProperties: {
          subscriptionId: {
            required: true,
...
module.exports = ListOKResponseAppAzureSubscription;
