 ...
 *
 */
class BillingPlansSelectionTestService {
  /**
   * Create a BillingPlansSelectionTestService.
  ...
  /**
   * Defines the metadata of BillingPlansSelectionTestService
   *
   * @returns {object} metadata of BillingPlansSelectionTestService
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'BillingPlansSelection_testService',
      type: {
        name: 'Composite',
...
module.exports = BillingPlansSelectionTestService;
