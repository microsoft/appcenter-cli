 ...
 *
 */
class UpdatePermissionsOKResponseOwner {
  /**
   * Create a UpdatePermissionsOKResponseOwner.
  ...
  /**
   * Defines the metadata of UpdatePermissionsOKResponseOwner
   *
   * @returns {object} metadata of UpdatePermissionsOKResponseOwner
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'UpdatePermissionsOKResponse_owner',
      type: {
        name: 'Composite',
...
module.exports = UpdatePermissionsOKResponseOwner;
