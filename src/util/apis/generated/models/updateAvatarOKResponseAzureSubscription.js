...
/**
 * Class representing a UpdateAvatarOKResponseAzureSubscription.
 */
class UpdateAvatarOKResponseAzureSubscription {
  /**
   * Create a UpdateAvatarOKResponseAzureSubscription.
  ...
  /**
   * Defines the metadata of UpdateAvatarOKResponseAzureSubscription
   *
   * @returns {object} metadata of UpdateAvatarOKResponseAzureSubscription
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'UpdateAvatarOKResponse_azure_subscription',
      type: {
        name: 'Composite',
        className: 'UpdateAvatarOKResponseAzureSubscription',
        modelProperties: {
          subscriptionId: {
            required: true,
...
module.exports = UpdateAvatarOKResponseAzureSubscription;
