 ...
 *
 */
class DeleteAvatarOKResponseOwner {
  /**
   * Create a DeleteAvatarOKResponseOwner.
  ...
  /**
   * Defines the metadata of DeleteAvatarOKResponseOwner
   *
   * @returns {object} metadata of DeleteAvatarOKResponseOwner
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'DeleteAvatarOKResponse_owner',
      type: {
        name: 'Composite',
...
module.exports = DeleteAvatarOKResponseOwner;
