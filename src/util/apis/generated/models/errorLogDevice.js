 ...
 *
 */
class ErrorLogDevice {
  /**
   * Create a ErrorLogDevice.
  ...
  /**
   * Defines the metadata of ErrorLogDevice
   *
   * @returns {object} metadata of ErrorLogDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ErrorLog_device',
      type: {
        name: 'Composite',
        className: 'ErrorLogDevice',
        modelProperties: {
          sdkName: {
            required: true,
