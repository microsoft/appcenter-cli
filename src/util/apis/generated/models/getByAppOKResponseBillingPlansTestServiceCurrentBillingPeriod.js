 ...
 *
 */
class GetByAppOKResponseBillingPlansTestServiceCurrentBillingPeriod {
  /**
   * Create a GetByAppOKResponseBillingPlansTestServiceCurrentBillingPeriod.
  ...
  /**
   * Defines the metadata of GetByAppOKResponseBillingPlansTestServiceCurrentBillingPeriod
   *
   * @returns {object} metadata of GetByAppOKResponseBillingPlansTestServiceCurrentBillingPeriod
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetByAppOKResponse_billingPlans_testService_currentBillingPeriod',
      type: {
        name: 'Composite',
        className: 'GetByAppOKResponseBillingPlansTestServiceCurrentBillingPeriod',
        modelProperties: {
          startTime: {
            required: false,
...
module.exports = GetByAppOKResponseBillingPlansTestServiceCurrentBillingPeriod;
