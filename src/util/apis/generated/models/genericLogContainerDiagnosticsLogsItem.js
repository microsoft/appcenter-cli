 ...
 *
 */
class GenericLogContainerDiagnosticsLogsItem {
  /**
   * Create a GenericLogContainerDiagnosticsLogsItem.
  ...
  /**
   * Defines the metadata of GenericLogContainerDiagnosticsLogsItem
   *
   * @returns {object} metadata of GenericLogContainerDiagnosticsLogsItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GenericLogContainer_Diagnostics_logsItem',
      type: {
        name: 'Composite',
...
module.exports = GenericLogContainerDiagnosticsLogsItem;
