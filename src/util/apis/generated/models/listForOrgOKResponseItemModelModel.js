...
/**
 * Class representing a ListForOrgOKResponseItemModelModel.
 */
class ListForOrgOKResponseItemModelModel {
  /**
   * Create a ListForOrgOKResponseItemModelModel.
  ...
  /**
   * Defines the metadata of ListForOrgOKResponseItemModelModel
   *
   * @returns {object} metadata of ListForOrgOKResponseItemModelModel
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ListForOrgOKResponseItem',
      type: {
        name: 'Composite',
        ...
        modelProperties: {
          ...
          owner: {
            ...
            type: {
              name: 'Composite',
              className: 'ListForOrgOKResponseItemOwner'
            }
          },
          appSecret: {
            required: true,
...
module.exports = ListForOrgOKResponseItemModelModel;
