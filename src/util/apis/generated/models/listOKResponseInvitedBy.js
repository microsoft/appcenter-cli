...
/**
 * Class representing a ListOKResponseInvitedBy.
 */
class ListOKResponseInvitedBy {
  /**
   * Create a ListOKResponseInvitedBy.
  ...
  /**
   * Defines the metadata of ListOKResponseInvitedBy
   *
   * @returns {object} metadata of ListOKResponseInvitedBy
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ListOKResponse_invited_by',
      type: {
        name: 'Composite',
        className: 'ListOKResponseInvitedBy',
        modelProperties: {
          id: {
            required: true,
            serializedName: 'id',
...
module.exports = ListOKResponseInvitedBy;
