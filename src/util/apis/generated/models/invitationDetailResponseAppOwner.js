 ...
 *
 */
class InvitationDetailResponseAppOwner {
  /**
   * Create a InvitationDetailResponseAppOwner.
  ...
  /**
   * Defines the metadata of InvitationDetailResponseAppOwner
   *
   * @returns {object} metadata of InvitationDetailResponseAppOwner
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'InvitationDetailResponse_app_owner',
      type: {
        name: 'Composite',
...
module.exports = InvitationDetailResponseAppOwner;
