 ...
 *
 */
class ListSessionLogsOKResponseLogsItem {
  /**
   * Create a ListSessionLogsOKResponseLogsItem.
  ...
  /**
   * Defines the metadata of ListSessionLogsOKResponseLogsItem
   *
   * @returns {object} metadata of ListSessionLogsOKResponseLogsItem
   *
   */
  mapper() {
    return {
...
module.exports = ListSessionLogsOKResponseLogsItem;
