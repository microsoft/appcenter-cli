 ...
 *
 */
class GetOKResponseModelModelModel {
  /**
   * Create a GetOKResponseModelModelModel.
  ...
  /**
   * Defines the metadata of GetOKResponseModelModelModel
   *
   * @returns {object} metadata of GetOKResponseModelModelModel
   *
   */
  mapper() {
    return {
      ...
      type: {
        name: 'Composite',
        className: 'GetOKResponseModelModelModel',
        modelProperties: {
          symbolUploadId: {
            required: true,
          ...
          symbolsUploaded: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'GetOKResponseSymbolsUploadedItemElementType',
                  type: {
                    name: 'Composite',
...
module.exports = GetOKResponseModelModelModel;
