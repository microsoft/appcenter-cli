...
/**
 * Class representing a UpdateOKResponseModelModelModelModelModelModelModelModel.
 */
class UpdateOKResponseModelModelModelModelModelModelModelModel {
  /**
   * Create a UpdateOKResponseModelModelModelModelModelModelModelModel.
  ...
  /**
   * Defines the metadata of UpdateOKResponseModelModelModelModelModelModelModelModel
   *
   * @returns {object} metadata of UpdateOKResponseModelModelModelModelModelModelModelModel
   *
   */
  mapper() {
    return {
      ...
      type: {
        name: 'Composite',
        className: 'UpdateOKResponseModelModelModelModelModelModelModelModel',
        modelProperties: {
          trigger: {
            required: false,
          ...
          toolsets: {
            ...
            type: {
              name: 'Composite',
              className: 'UpdateOKResponseToolsets'
            }
          },
          artifactVersioning: {
            required: false,
...
module.exports = UpdateOKResponseModelModelModelModelModelModelModelModel;
