 ...
 *
 */
class ListSessionLogsOKResponseLogsItemDevice {
  /**
   * Create a ListSessionLogsOKResponseLogsItemDevice.
  ...
  /**
   * Defines the metadata of ListSessionLogsOKResponseLogsItemDevice
   *
   * @returns {object} metadata of ListSessionLogsOKResponseLogsItemDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ListSessionLogsOKResponse_logsItem_device',
      type: {
        name: 'Composite',
...
module.exports = ListSessionLogsOKResponseLogsItemDevice;
