 ...
 *
 */
class LogFlowCustomPropertyLogDevice {
  /**
   * Create a LogFlowCustomPropertyLogDevice.
  ...
  /**
   * Defines the metadata of LogFlowCustomPropertyLogDevice
   *
   * @returns {object} metadata of LogFlowCustomPropertyLogDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'LogFlowCustomPropertyLog_device',
      type: {
        name: 'Composite',
        className: 'LogFlowCustomPropertyLogDevice',
        modelProperties: {
          sdkName: {
            required: true,
...
module.exports = LogFlowCustomPropertyLogDevice;
