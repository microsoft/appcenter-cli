 ...
 *
 */
class CustomPropertyLogDiagnosticsDevice {
  /**
   * Create a CustomPropertyLogDiagnosticsDevice.
  ...
  /**
   * Defines the metadata of CustomPropertyLogDiagnosticsDevice
   *
   * @returns {object} metadata of CustomPropertyLogDiagnosticsDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'CustomPropertyLog_Diagnostics_device',
      type: {
        name: 'Composite',
        className: 'CustomPropertyLogDiagnosticsDevice',
        modelProperties: {
          sdkName: {
            required: true,
...
module.exports = CustomPropertyLogDiagnosticsDevice;
