...
/**
 * Class representing a AdministeredOrgsResponseOrganizations.
 */
class AdministeredOrgsResponseOrganizations {
  /**
   * Create a AdministeredOrgsResponseOrganizations.
  ...
  /**
   * Defines the metadata of AdministeredOrgsResponseOrganizations
   *
   * @returns {object} metadata of AdministeredOrgsResponseOrganizations
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'AdministeredOrgsResponse_organizations',
      type: {
        name: 'Composite',
...
module.exports = AdministeredOrgsResponseOrganizations;
