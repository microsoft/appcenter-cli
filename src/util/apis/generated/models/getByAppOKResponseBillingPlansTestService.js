 ...
 *
 */
class GetByAppOKResponseBillingPlansTestService {
  /**
   * Create a GetByAppOKResponseBillingPlansTestService.
  ...
  /**
   * Defines the metadata of GetByAppOKResponseBillingPlansTestService
   *
   * @returns {object} metadata of GetByAppOKResponseBillingPlansTestService
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetByAppOKResponse_billingPlans_testService',
      type: {
        name: 'Composite',
        className: 'GetByAppOKResponseBillingPlansTestService',
        modelProperties: {
          canSelectTrialPlan: {
            required: false,
...
module.exports = GetByAppOKResponseBillingPlansTestService;
