 ...
 *
 */
class GetForOrgOKResponseBillingPlansTestServiceCurrentBillingPeriod {
  /**
   * Create a GetForOrgOKResponseBillingPlansTestServiceCurrentBillingPeriod.
  ...
  /**
   * Defines the metadata of GetForOrgOKResponseBillingPlansTestServiceCurrentBillingPeriod
   *
   * @returns {object} metadata of GetForOrgOKResponseBillingPlansTestServiceCurrentBillingPeriod
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetForOrgOKResponse_billingPlans_testService_currentBillingPeriod',
      type: {
        name: 'Composite',
        className: 'GetForOrgOKResponseBillingPlansTestServiceCurrentBillingPeriod',
        modelProperties: {
          startTime: {
            required: false,
...
module.exports = GetForOrgOKResponseBillingPlansTestServiceCurrentBillingPeriod;
