...
/**
 * Class representing a ListAppsOKResponseItem.
 */
class ListAppsOKResponseItem {
  /**
   * Create a ListAppsOKResponseItem.
  ...
  /**
   * Defines the metadata of ListAppsOKResponseItem
   *
   * @returns {object} metadata of ListAppsOKResponseItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ListAppsOKResponseItem',
      type: {
        name: 'Composite',
...
module.exports = ListAppsOKResponseItem;
