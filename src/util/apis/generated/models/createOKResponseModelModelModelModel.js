...
/**
 * Class representing a CreateOKResponseModelModelModelModel.
 */
class CreateOKResponseModelModelModelModel {
  /**
   * Create a CreateOKResponseModelModelModelModel.
  ...
  /**
   * Defines the metadata of CreateOKResponseModelModelModelModel
   *
   * @returns {object} metadata of CreateOKResponseModelModelModelModel
   *
   */
  mapper() {
    return {
      ...
      type: {
        name: 'Composite',
        className: 'CreateOKResponseModelModelModelModel',
        modelProperties: {
          id: {
            required: true,
            serializedName: 'id',
...
module.exports = CreateOKResponseModelModelModelModel;
