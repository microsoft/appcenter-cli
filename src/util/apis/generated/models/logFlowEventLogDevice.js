 ...
 *
 */
class LogFlowEventLogDevice {
  /**
   * Create a LogFlowEventLogDevice.
  ...
  /**
   * Defines the metadata of LogFlowEventLogDevice
   *
   * @returns {object} metadata of LogFlowEventLogDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'LogFlowEventLog_device',
      type: {
        name: 'Composite',
        className: 'LogFlowEventLogDevice',
        modelProperties: {
          sdkName: {
            required: true,
...
module.exports = LogFlowEventLogDevice;
