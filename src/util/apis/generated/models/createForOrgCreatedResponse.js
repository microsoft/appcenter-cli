...
/**
 * Class representing a CreateForOrgCreatedResponse.
 */
class CreateForOrgCreatedResponse {
  /**
   * Create a CreateForOrgCreatedResponse.
  ...
  /**
   * Defines the metadata of CreateForOrgCreatedResponse
   *
   * @returns {object} metadata of CreateForOrgCreatedResponse
   *
   */
  mapper() {
    return {
      ...
      type: {
        name: 'Composite',
        className: 'CreateForOrgCreatedResponse',
        modelProperties: {
          id: {
            required: true,
            serializedName: 'id',
...
module.exports = CreateForOrgCreatedResponse;
