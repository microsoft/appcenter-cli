...
/**
 * Class representing a AppInvitationDetailResponseApp.
 */
class AppInvitationDetailResponseApp {
  /**
   * Create a AppInvitationDetailResponseApp.
  ...
  /**
   * Defines the metadata of AppInvitationDetailResponseApp
   *
   * @returns {object} metadata of AppInvitationDetailResponseApp
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'AppInvitationDetailResponse_app',
      type: {
        name: 'Composite',
        ...
        modelProperties: {
          ...
          owner: {
            ...
            type: {
              name: 'Composite',
              className: 'AppInvitationDetailResponseAppOwner'
            }
          },
          appSecret: {
            required: true,
...
module.exports = AppInvitationDetailResponseApp;
