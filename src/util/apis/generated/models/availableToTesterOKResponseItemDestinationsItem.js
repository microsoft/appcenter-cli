...
/**
 * Class representing a AvailableToTesterOKResponseItemDestinationsItem.
 */
class AvailableToTesterOKResponseItemDestinationsItem {
  /**
   * Create a AvailableToTesterOKResponseItemDestinationsItem.
  ...
  /**
   * Defines the metadata of AvailableToTesterOKResponseItemDestinationsItem
   *
   * @returns {object} metadata of AvailableToTesterOKResponseItemDestinationsItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'AvailableToTesterOKResponseItem_destinationsItem',
      type: {
        name: 'Composite',
...
module.exports = AvailableToTesterOKResponseItemDestinationsItem;
