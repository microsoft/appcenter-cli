...
/**
 * Class representing a ListForOrgOKResponseItemModel.
 */
class ListForOrgOKResponseItemModel {
  /**
   * Create a ListForOrgOKResponseItemModel.
  ...
  /**
   * Defines the metadata of ListForOrgOKResponseItemModel
   *
   * @returns {object} metadata of ListForOrgOKResponseItemModel
   *
   */
  mapper() {
    return {
...
module.exports = ListForOrgOKResponseItemModel;
