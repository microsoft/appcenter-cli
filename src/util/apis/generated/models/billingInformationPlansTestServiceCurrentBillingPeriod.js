 ...
 *
 */
class BillingInformationPlansTestServiceCurrentBillingPeriod {
  /**
   * Create a BillingInformationPlansTestServiceCurrentBillingPeriod.
  ...
  /**
   * Defines the metadata of BillingInformationPlansTestServiceCurrentBillingPeriod
   *
   * @returns {object} metadata of BillingInformationPlansTestServiceCurrentBillingPeriod
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'BillingInformationPlans_testService_currentBillingPeriod',
      type: {
        name: 'Composite',
...
module.exports = BillingInformationPlansTestServiceCurrentBillingPeriod;
