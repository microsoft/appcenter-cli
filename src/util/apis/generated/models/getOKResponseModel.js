...
/**
 * Class representing a GetOKResponseModel.
 */
class GetOKResponseModel {
  /**
   * Create a GetOKResponseModel.
  ...
  /**
   * Defines the metadata of GetOKResponseModel
   *
   * @returns {object} metadata of GetOKResponseModel
   *
   */
  mapper() {
    return {
...
module.exports = GetOKResponseModel;
