...
/**
 * Class representing a AvailableToTesterOKResponseItemDistributionStoresItem.
 */
class AvailableToTesterOKResponseItemDistributionStoresItem {
  /**
   * Create a AvailableToTesterOKResponseItemDistributionStoresItem.
  ...
  /**
   * Defines the metadata of AvailableToTesterOKResponseItemDistributionStoresItem
   *
   * @returns {object} metadata of AvailableToTesterOKResponseItemDistributionStoresItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'AvailableToTesterOKResponseItem_distribution_storesItem',
      type: {
        name: 'Composite',
...
module.exports = AvailableToTesterOKResponseItemDistributionStoresItem;
