 ...
 *
 */
class LogWithPropertiesDevice {
  /**
   * Create a LogWithPropertiesDevice.
  ...
  /**
   * Defines the metadata of LogWithPropertiesDevice
   *
   * @returns {object} metadata of LogWithPropertiesDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'LogWithProperties_device',
      type: {
        name: 'Composite',
        className: 'LogWithPropertiesDevice',
        modelProperties: {
          sdkName: {
            required: true,
...
module.exports = LogWithPropertiesDevice;
