 ...
 *
 */
class UpdateOKResponseReasonFrame {
  /**
   * Create a UpdateOKResponseReasonFrame.
  ...
  /**
   * Defines the metadata of UpdateOKResponseReasonFrame
   *
   * @returns {object} metadata of UpdateOKResponseReasonFrame
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'UpdateOKResponse_reason_frame',
      type: {
        name: 'Composite',
...
module.exports = UpdateOKResponseReasonFrame;
