...
/**
 * Class representing a GetOKResponseItemModel.
 */
class GetOKResponseItemModel {
  /**
   * Create a GetOKResponseItemModel.
  ...
  /**
   * Defines the metadata of GetOKResponseItemModel
   *
   * @returns {object} metadata of GetOKResponseItemModel
   *
   */
  mapper() {
    return {
        ...
        modelProperties: {
          ...
          diffPackageMap: {
            ...
            type: {
              ...
              value: {
                  required: false,
                  serializedName: 'GetOKResponseItemDiffPackageMapValueElementType',
                  type: {
                    name: 'Composite',
...
module.exports = GetOKResponseItemModel;
