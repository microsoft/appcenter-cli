...
/**
 * Class representing a UpdatePermissionsOKResponse.
 */
class UpdatePermissionsOKResponse {
  /**
   * Create a UpdatePermissionsOKResponse.
  ...
  /**
   * Defines the metadata of UpdatePermissionsOKResponse
   *
   * @returns {object} metadata of UpdatePermissionsOKResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'UpdatePermissionsOKResponse',
      type: {
        name: 'Composite',
        className: 'UpdatePermissionsOKResponse',
        modelProperties: {
          id: {
            required: true,
            serializedName: 'id',
          ...
          owner: {
            ...
            type: {
              name: 'Composite',
              className: 'UpdatePermissionsOKResponseOwner'
            }
          },
          appSecret: {
            required: true,
...
module.exports = UpdatePermissionsOKResponse;
