...
/**
 * Class representing a RollbackCreatedResponse.
 */
class RollbackCreatedResponse {
  /**
   * Create a RollbackCreatedResponse.
  ...
  /**
   * Defines the metadata of RollbackCreatedResponse
   *
   * @returns {object} metadata of RollbackCreatedResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'RollbackCreatedResponse',
      type: {
        name: 'Composite',
        className: 'RollbackCreatedResponse',
        modelProperties: {
          targetBinaryRange: {
            required: false,
          ...
          diffPackageMap: {
            ...
            type: {
              ...
              value: {
                  required: false,
                  serializedName: 'RollbackCreatedResponseDiffPackageMapValueElementType',
                  type: {
                    name: 'Composite',
...
module.exports = RollbackCreatedResponse;
