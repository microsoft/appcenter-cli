 ...
 *
 */
class StartServiceLogDevice {
  /**
   * Create a StartServiceLogDevice.
  ...
  /**
   * Defines the metadata of StartServiceLogDevice
   *
   * @returns {object} metadata of StartServiceLogDevice
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'StartServiceLog_device',
      type: {
        name: 'Composite',
        className: 'StartServiceLogDevice',
        modelProperties: {
          sdkName: {
            required: true,
...
module.exports = StartServiceLogDevice;
