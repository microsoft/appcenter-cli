 ...
 *
 */
class CreateForOrgOKResponseOwner {
  /**
   * Create a CreateForOrgOKResponseOwner.
  ...
  /**
   * Defines the metadata of CreateForOrgOKResponseOwner
   *
   * @returns {object} metadata of CreateForOrgOKResponseOwner
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'CreateForOrgOKResponse_owner',
      type: {
        name: 'Composite',
...
module.exports = CreateForOrgOKResponseOwner;
