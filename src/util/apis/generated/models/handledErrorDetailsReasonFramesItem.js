...
/**
 * Class representing a HandledErrorDetailsReasonFramesItem.
 */
class HandledErrorDetailsReasonFramesItem {
  /**
   * Create a HandledErrorDetailsReasonFramesItem.
  ...
  /**
   * Defines the metadata of HandledErrorDetailsReasonFramesItem
   *
   * @returns {object} metadata of HandledErrorDetailsReasonFramesItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'HandledErrorDetails_reasonFramesItem',
      type: {
        name: 'Composite',
...
module.exports = HandledErrorDetailsReasonFramesItem;
