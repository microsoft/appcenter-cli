 ...
 *
 */
class GetAllOKResponseAggregatedBillingsBillingPlans {
  /**
   * Create a GetAllOKResponseAggregatedBillingsBillingPlans.
  ...
  /**
   * Defines the metadata of GetAllOKResponseAggregatedBillingsBillingPlans
   *
   * @returns {object} metadata of GetAllOKResponseAggregatedBillingsBillingPlans
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetAllOKResponse_aggregatedBillings_billingPlans',
      type: {
        name: 'Composite',
        className: 'GetAllOKResponseAggregatedBillingsBillingPlans',
        modelProperties: {
          buildService: {
            required: false,
...
module.exports = GetAllOKResponseAggregatedBillingsBillingPlans;
