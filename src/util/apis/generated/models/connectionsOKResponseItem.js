 ...
 *
 */
class ConnectionsOKResponseItem {
  /**
   * Create a ConnectionsOKResponseItem.
  ...
  /**
   * Defines the metadata of ConnectionsOKResponseItem
   *
   * @returns {object} metadata of ConnectionsOKResponseItem
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ConnectionsOKResponseItem',
      type: {
        name: 'Composite',
...
module.exports = ConnectionsOKResponseItem;
