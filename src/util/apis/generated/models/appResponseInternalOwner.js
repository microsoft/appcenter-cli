 ...
 *
 */
class AppResponseInternalOwner {
  /**
   * Create a AppResponseInternalOwner.
  ...
  /**
   * Defines the metadata of AppResponseInternalOwner
   *
   * @returns {object} metadata of AppResponseInternalOwner
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'AppResponseInternal_owner',
      type: {
        name: 'Composite',
...
module.exports = AppResponseInternalOwner;
