...
declare module 'event-stream'
{
    ...
    export function pipeline(...streams: stream.Stream[]): stream.Duplex;

    export function through(write?: {(data: any): void}, end?: {(): void}, options?: { autoDestroy?: boolean }): stream.Duplex;
